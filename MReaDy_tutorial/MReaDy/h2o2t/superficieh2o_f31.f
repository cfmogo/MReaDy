      Function vh2o_f31(r1,r2,r3)
c    **************************************************************
C     TO COMPUTE THE H2O SURFACE - Sx in atomic units
C    **************************************************************
      IMPLICIT DOUBLE PRECISION(A-H,O-Z)
C    **************************************************************
      COMMON/DIATDI_f31/R0HH,RMHHS,RMHHT,R0OHP,R0OHS,RMOHP,RMOHS,VO1D
      COMMON/CTHRB12_f31/RO2,RO3,RO6,S1,S2,S3,Q1,Q2,Q3,Q12,Q13,Q22,Q32,
     1 TQ1,TQ2,TQ3,POL,DECAY1,DECAY2,DECAY3,DECAY,DV1DR1,
     2 DV1DR2,DV1DR3,DV2DR1,DV2DR2,DV2DR3,F1,F2
C    **************************************************************
      F1=vhhs_f31(r1)+vohs_f31(r2)+vohs_f31(r3)+THREBR1_f31(r1,r2,r3)+
     1  rl1_f31(r1,r2,r3)+VO1D
      F2=vhht_f31(r1)+vohp_f31(r2)+vohp_f31(r3)+THREBR2_f31(r1,r2,r3)+
     1  rl2_f31(r1,r2,r3)
      F12=THREB12_f31(r1,r2,r3)
      vh2o_f31=((F1+F2)-SQRT((F1-F2)**2+4.0D0*F12**2))/2.0D0

      RETURN
      END

      Function VH2O3c1_f31(r1,r2,r3)
c    **************************************************************
C     TO COMPUTE THE H2O SURFACE - Sx in atomic units
C    **************************************************************
      IMPLICIT DOUBLE PRECISION(A-H,O-Z)
C    **************************************************************
     ...
     2 DV1DR2,DV1DR3,DV2DR1,DV2DR2,DV2DR3,F1,F2
c    ***************************************************************
      VH2O3c1_f31=THREBR1_f31(r1,r2,r3)+rl1_f31(r1,r2,r3)
      RETURN
      END

      Function VH2O3c2_f31(r1,r2,r3)
c    **************************************************************
C     TO COMPUTE THE H2O SURFACE - Sx in atomic units
C    **************************************************************
      IMPLICIT DOUBLE PRECISION(A-H,O-Z)
C    **************************************************************
     ...
     2 DV1DR2,DV1DR3,DV2DR1,DV2DR2,DV2DR3,F1,F2
c    ***************************************************************
      VH2O3c2_f31=THREBR2_f31(r1,r2,r3)+rl2_f31(r1,r2,r3)
      RETURN
      END

      Function VH2O3c12_f31(r1,r2,r3)
c    **************************************************************
C     TO COMPUTE THE H2O SURFACE - Sx in atomic units
C    **************************************************************
      IMPLICIT DOUBLE PRECISION(A-H,O-Z)
...
c     os valores de F1 e F2 são necessárs para o cálculo do termo V12
      VH2O3c12_f31=THREB12_f31(r1,r2,r3)
      ...
      SUBROUTINE DERvh2o_f31(r1,r2,r3,g1,g2,g3)
c    **************************************************************
...
c    ***************************************************************
     ...
     1  rl2_f31(r1,r2,r3)
      ...
      CALL dthrebr1_f31(r1,r2,r3,DTDR1,DTDR2,DTDR3)
      CALL drl1_f31(r1,r2,r3,DER1,DER2,DER3)
      GF1(1)=DTDR1+DER1+Dvhhs_f31(r1)
      GF1(2)=DTDR2+DER2+Dvohs_f31(r2)
      GF1(3)=DTDR3+DER3+Dvohs_f31(r3)
      DV1DR1=GF1(1)
      DV1DR2=GF1(2)
      DV1DR3=GF1(3)
      CALL dthrebr2_f31(r1,r2,r3,DT2DR1,DT2DR2,DT2DR3)
      CALL drl2_f31(r1,r2,r3,DER1,DER2,DER3)
      GF2(1)=DT2DR1+DER1+Dvhht_f31(r1)
      GF2(2)=DT2DR2+DER2+Dvohp_f31(r2)
      GF2(3)=DT2DR3+DER3+Dvohp_f31(r3)
      DV2DR1=GF2(1)
      DV2DR2=GF2(2)
      DV2DR3=GF2(3)
      CALL dthreb12_f31(r1,r2,r3,DT12R1,DT12R2,DT12R3)
      ...
      SUBROUTINE DERVH2O3c_f31(r1,r2,r3,g1,g2,g3)
c     **************************************************************
C      TO COMPUTE THE DERIVATIVE H2O SURFACE - Sx in atomic units
C     **************************************************************
      IMPLICIT DOUBLE PRECISION(A-H,O-Z)
...
C     **************************************************************
     ...
     2 DV1DR2,DV1DR3,DV2DR1,DV2DR2,DV2DR3,F1,F2
c     ***************************************************************
      CALL DERvh2o_f31(r1,r2,r3,dvh2o1,dvh2o2,dvh2o3)
      g1=dvh2o1-dvhhs_f31(r1)
      g2=dvh2o2-dvohp_f31(r2)
      g3=dvh2o3-dvohp_f31(r3)

c     vh2o3c=vh2o-vhhs_f31(r1)-vohp_f31(r2)-vohp_f31(r3)

      RETURN
      END

      SUBROUTINE dthrebr1_f31(R1,R2,R3,DTDR1,DTDR2,DTDR3)
c    **************************************************************
...
C    **************************************************************
      ...
      COMMON/coeff_f31/C(148)
      COMMON/refgeo_f31/R10,R20,R30
      COMMON/CTHRB1_f31/RO2,RO3,RO6,S1,S2,S3,Q1,Q2,Q3,Q12,Q13,Q14,Q15,
     1 Q16,Q17,Q18,Q22,Q23,Q32,Q33,TQ1,TQ12,TQ13,TQ14,TQ2,TQ3,TQ32,
     2 POLQ,DECAY1,DECAY2,DECAY3
c    **************************************************************
      prov=THREBR1_f31(r1,r2,r3)
     ...
     9 DTQ1Q3*TQ2+DTQ2Q3*TQ13)
      ...
      SUBROUTINE dthrebr2_f31(R1,R2,R3,DT2DR1,DT2DR2,DT2DR3)
c    **************************************************************
C     TO COMPUTE THE DERIVATIVES OF THE THREE BODY TERM IN
c     COORDINATES R1,R2,R3
C    **************************************************************
      ...
      COMMON/refgeo2_f31/R102,R202,R302
      COMMON/CTHRB2_f31/RO2,RO3,RO6,S1,S2,S3,Q1,Q2,Q3,Q12,Q13,Q14,Q15,
     1 Q16,Q17,Q18,Q22,Q23,Q32,Q33,TQ1,TQ12,TQ13,TQ14,TQ2,TQ3,TQ32,
     2 POLQ,DECAY1,DECAY2,DECAY3,prova
c    **************************************************************

      prova=THREBR2_f31(r1,r2,r3)
     ...
     3      DTQ3Q3*TQ2)
      ...
      SUBROUTINE dthreb12_f31(R1,R2,R3,DT12R1,DT12R2,DT12R3)
c    **************************************************************
...
C    **************************************************************
      ...
      COMMON/REFGEO12_f31/R1012,R2012,R3012
      COMMON/coeff_f31/C(148)
      COMMON/CTHRB12_f31/RO2,RO3,RO6,S1,S2,S3,Q1,Q2,Q3,Q12,Q13,Q22,Q32,
     1 TQ1,TQ2,TQ3,POL,DECAY1,DECAY2,DECAY3,DECAY,DV1DR1,
...
c      provb=THREB12_f31(r1,r2,r3)

      v1=vhhs_f31(r1)+vohs_f31(r2)+vohs_f31(r3)+THREBR1_f31(r1,r2,r3)+
     1  rl1_f31(r1,r2,r3)+VO1D
      v2=vhht_f31(r1)+vohp_f31(r2)+vohp_f31(r3)+THREBR2_f31(r1,r2,r3)+
     1  rl2_f31(r1,r2,r3)
...
C
      ...
      GAMA1=100.0D0
      THREB12_f31=sina*pol*decay
c********************************************************

      call dthrebr1_f31(r1,r2,r3,dr1,dr2,dr3) !superficieh2o.f
      dr1tb1=dr1
      dr2tb1=dr2
      dr3tb1=dr3

      call drl1_f31(r1,r2,r3,dr1,dr2,dr3) !superficieh2o.f
      dr1rl1=dr1
      dr2rl1=dr2
      dr3rl1=dr3


c      v1=vhhs_f31(r1)+vohs_f31(r2)+vohs_f31(r3)+THREBR1_f31(r1,r2,r3)+
c     1  rl1_f31(r1,r2,r3)+VO1D


c     derivadas de v1 em ordem aos rs
      dv1dr1=dvhhs_f31(r1) + dr1tb1 + dr1rl1
      dv1dr2=dvohs_f31(r2) + dr2tb1 + dr2rl1
      dv1dr3=dvohs_f31(r3) + dr3tb1 + dr3rl1

c     v2 +++++++

      call dthrebr2_f31(r1,r2,r3,dr1,dr2,dr3) !superficieh2o.f
      dr1tb2=dr1
      dr2tb2=dr2
      dr3tb2=dr3

      call drl2_f31(r1,r2,r3,dr1,dr2,dr3) !superficieh2o.f
      dr1rl2=dr1
      dr2rl2=dr2
      dr3rl2=dr3


c      v2=vhht_f31(r1)+vohp_f31(r2)+vohp_f31(r3)+THREBR2_f31(r1,r2,r3)+
c     1  rl2_f31(r1,r2,r3)

c     derivadas de v2 em ordem aos rs

      dv2dr1=dvhht_f31(r1) + dr1tb2 + dr1rl2
      dv2dr2=dvohp_f31(r2) + dr2tb2 + dr2rl2
      dv2dr3=dvohp_f31(r3) + dr3tb2 + dr3rl2
...
C    **************************************************************
      IMPLICIT DOUBLE PRECISION(A-H,O-Z)
c    **************************************************************
      vohp_f31=EHFOHP_f31(R)+DISOHP_f31(R)
      RETURN
      END

      FUNCTION EHFOHP_f31(R)
c    **************************************************************
...
c    **************************************************************
      ...
      FUNCTION DISOHP_f31(R)
c    **************************************************************
C     TO COMPUTE THE DISPERSION FOR  O...H
C    **************************************************************
      IMPLICIT DOUBLE PRECISION(A-H,O-Z)
      COMMON/dispc1_f31/CHH(16),COHP(10),COHS(10)
      COMMON/DIATDI_f31/R0HH,RMHHS,RMHHT,R0OHP,R0OHS,RMOHP,RMOHS,VO1D
c    **************************************************************
      DISOHP_f31=DISPOH_f31(R,COHP(6),COHP(8),COHP(10),R0OHP,RMOHP)
      RETURN
      END

      FUNCTION Dvohp_f31(R)
c    **************************************************************
...
c     Dispersao
      DERDISP=DDISPOH_f31(R,COHP(6),COHP(8),COHP(10),R0OHP,RMOHP)
c     Total
      Dvohp_f31=DEHF+DEX+DERDISP
      RETURN
      END
...
C    **************************************************************
      IMPLICIT DOUBLE PRECISION(A-H,O-Z)
c    **************************************************************
      vohs_f31=EHFOHS_f31(R)+DISOHS_f31(R)
      RETURN
      END

c     novo vohs novos coeficientes resultantes dos pontos de Fal61:167
c     e do De de HUB79:0

      FUNCTION EHFOHS_f31(R)
c    **************************************************************
...
C    **************************************************************
      ...
      COMMON/DIATDI_f31/R0HH,RMHHS,RMHHT,R0OHP,R0OHS,RMOHP,RMOHS,VO1D
c    **************************************************************
      DISOHS_f31=DISPOH_f31(R,COHS(6),COHS(8),COHS(10),R0OHS,RMOHS)
      RETURN
      END

      FUNCTION Dvohs_f31(R)
c    **************************************************************
...
c     Termo sem exchange assimp.
     ...
     2    *EXP(-GAMEX*R)
      DEX=EX/D6*DD6+DEXND*D6
c     Dispersao
      DERDISP=DDISPOH_f31(R,COHS(6),COHS(8),COHS(10),R0OHS,RMOHS)
c     Total
      Dvohs_f31=DEHF+DEX+DERDISP
      RETURN
      END
...
C    **************************************************************
      IMPLICIT DOUBLE PRECISION(A-H,O-Z)
c    **************************************************************
      vhhs_f31=EHFHHS_f31(R)+DISHHS_f31(R)
      RETURN
      END

      FUNCTION EHFHHS_f31(R)
c    **************************************************************
...
C    **************************************************************
      ...
      COMMON/AN_f31/A(20)
      COMMON/BN_f31/B(20)
      COMMON/CEHFHS_f31/X,X2,X3,RHO,RR,GAMA,POL,D6
c    **************************************************************
...
c    **************************************************************
      ...
      EHFHHS_f31=-D/R*POL*EXP(-Gama*X)
      RHO=(RMHHS+2.5D0*R0HH)/2.0d0
      RR=R/RHO
      D6=(1.0D0-EXP(-A(6)*RR-B(6)*RR**2))**6
      EXCHHS=-AGEX*R**ALPHEX*EXP(-GAMEX*R)*D6
      EHFHHS_f31=EHFHHS_f31+EXCHHS
      RETURN
      END

      FUNCTION DISHHS_f31(R)
c    **************************************************************
...
c    **************************************************************
      ...
      R6=R2*R2*R2
      R8=R6*R2
      ADISP=-CHH(6)*DAMPHH_f31(6,R)/R6-CHH(8)*DAMPHH_f31(8,R)/R8
      DO N=10,16
        ADISP=ADISP-CHH(N)*DAMPHH_f31(N,R)/(R8*R**(N-8.0d0))
      ENDDO
      DISHHS_f31=ADISP
      RETURN
      END

      FUNCTION DAMPHH_f31(N,R)
c    ***************************************************************
...
c    ***************************************************************
      ...
      DAMPHH_f31=(1.0D0-EXP(-A(N)*RR-B(N)*RR*RR))**N
      RETURN
      END

      FUNCTION Dvhhs_f31(R)
C     *************************************************************
C     TO COMPUTE THE DER. OF THE HFACE FOR  singlet H...H
C     *************************************************************
      IMPLICIT DOUBLE PRECISION(A-H,O-Z)
C     *************************************************************
      Dvhhs_f31=DEHFHHS_f31(R)+DDISHHS_f31(R)
      RETURN
      END

      FUNCTION DEHFHHS_f31(R)
C     *************************************************************
C     TO COMPUTE THE EHF FOR  singlet H...H
C     *************************************************************
      IMPLICIT DOUBLE PRECISION(A-H,O-Z)
...
c     **************************************************************
      ...
      DEHFHHS_f31=DPOLC*EXP(-GAMA*X)-D/R*POL*DEXP
      RHH=RHO
      RR2=RR*RR
     ...
     1    B(6)*RR2)
      ...
      DEHFHHS_f31=DEHFHHS_f31+DEXCHHS
      RETURN
      END

      FUNCTION DDISHHS_f31(R)
c    ************************************************************
      IMPLICIT DOUBLE PRECISION(A-H,O-Z)
      COMMON/dispc1_f31/CHH(16),COHP(10),COHS(10)
      COMMON/DIATDI_f31/R0HH,RMHHS,RMHHT,R0OHP,R0OHS,RMOHP,RMOHS,VO1D
...
c    **************************************************************
      ...
      DDISPLOCAL=6.0D0*CHH(6)/R6*T6**5*(T6/R+(1.0D0-T6)*
     1     (-A(6)-2.0D0
     1     *B(6)*RR)*DRR)+
...
c    **************************************************************
      vhht_f31=EHFHHT_f31(R)+DISHHT_f31(R)
      RETURN
      END

      FUNCTION EHFHHT_f31(R)
c    **************************************************************
...
c     coef retirados de var82:857 pag 862
     ...
     2       -2.0122436d-01/
      ...
      COMMON/BN_f31/B(20)
      COMMON/DIATDI_f31/R0HH,RMHHS,RMHHT,R0OHP,R0OHS,RMOHP,RMOHS,VO1D
      COMMON/CEHFHT_f31/R1,R2,R3,RHO,RR,EX,D6,TEXP,POL,EHF
c    **************************************************************
      R1=R-RMHHT
      R2=R1*R1
      R3=R2*R1
...
c    **************************************************************
      R6=R**6
      R8=R6*R*R
      ADISP=-CHH(6)*DAMPHHT_f31(6,R)/R6-CHH(8)*DAMPHHT_f31(8,R)/R8
      DO N=10,16
           ADISP=ADISP-CHH(N)*DAMPHHT_f31(N,R)/(R8*R**(N-8.0D0))
      ENDDO
      DISHHT_f31=ADISP
      RETURN
      END

      FUNCTION DAMPHHT_f31(N,R)
c    ***************************************************************
c     CALCULATES VARANDAS-BRANDAO DAMPING FUNCTIONS
c    ***************************************************************
      IMPLICIT DOUBLE PRECISION(A-H,O-Z)
...
c    ***************************************************************
      ...
      DAMPHHT_f31=(1.0D0-EXP(-A(N)*RR-B(N)*RR*RR))**N
      RETURN
      END

      FUNCTION Dvhht_f31(R)
c    **************************************************************
C     TO COMPUTE THE DER. OF THE HFACE FOR  triplet H...H
C    **************************************************************
      IMPLICIT DOUBLE PRECISION(A-H,O-Z)
c    **************************************************************
      Dvhht_f31=DEHFHHT_f31(R)+DDISHHT_f31(R)
      RETURN
      END

      FUNCTION DEHFHHT_f31(R)
c    **************************************************************
C     TO COMPUTE THE EHF FOR  triplet H...H
C    **************************************************************
      IMPLICIT DOUBLE PRECISION(A-H,O-Z)
...
c    **************************************************************
     ...
     1       FEXC
      ...
      DEHFHHT_f31=D/R**2*POL*Texp+E(1)*D/R*Texp+2.0d0*E(5)*r1*D/r*Texp+
     1       3.0d0*E(6)*r2*D/r*Texp-D/R*POL*(-E(2)-2.0D0*
     1        E(3)*R1-3.0d0*E(4)*R2)*Texp
      DEHFHHT_f31=DEHFHHT_f31+DEXCHHT
      RETURN
      END

      FUNCTION DDISHHT_f31(R)
c    **************************************************************
      IMPLICIT DOUBLE PRECISION(A-H,O-Z)
      COMMON/dispc1_f31/CHH(16),COHP(10),COHS(10)
      COMMON/DIATDI_f31/R0HH,RMHHS,RMHHT,R0OHP,R0OHS,RMOHP,RMOHS,VO1D
...
c    **************************************************************
     ...
     716.0D0*CHH(16)/R16*T16**15*(T16/R+(1.0D0-T16)*(-A(16)-2.0D0*
     8      B(16)*RR)*DRR)
      DDISHHT_f31=DDISPLOCAL
      RETURN
      END

      FUNCTION THREBR1_f31(R1,R2,R3)
c    **************************************************************
c
C     TO COMPUTE THE THREE BODY TERM IN COORDINATES R1,R2,R3
c
...
c    **************************************************************
     ...
     6 *TQ32*TQ2+C(95)*TQ13*TQ2
      ...
      THREBR1_f31=POLQ*DECAY1*DECAY2*DECAY3
      RETURN
      END

      FUNCTION THREBR2_f31(R1,R2,R3)
c    **************************************************************
c
C     TO COMPUTE THE THREE BODY TERM IN COORDINATES R1,R2,R3
c
...
c    *************************************************************
     ...
     8 +D(33)*Q3*TQ1**2+D(34)*TQ2*TQ3
      ...
      THREBR2_f31=POLQ*DECAY1*DECAY2*DECAY3
      RETURN
      END

      FUNCTION THREB12_f31(R1,R2,R3)
c    **************************************************************
C     TO COMPUTE THE THREE BODY TERM IN COORDINATES R1,R2,R3
C    **************************************************************
      IMPLICIT DOUBLE PRECISION(A-H,O-Z)
...
C      PRINT*,GAMA1,v1,v2,r1,r2,r3,D(14),D(15)
      ...
      SUBROUTINE GEOMRL_f31(R1,R2,R3)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
      COMMON/const_f31/PI
      COMMON/dispc1_f31/CHH(16),COHP(10),COHS(10)
      COMMON/DIATDI_f31/R0HH,RMHHS,RMHHT,R0OHP,R0OHS,RMOHP,RMOHS,VO1D
      COMMON/cved_f31/COSB,COSC,RG1,RG2,RG3,COST1,COST2,COST3,FAB,
     1  FAC,FBC,
     1  FABC,FCAB,FBAC,CONST,RG14,RG15,RG16,RG17,RG18,RG19,RG110,
     ...
     1  DFABR1,DFACR1,DFBCR1,DFABR2,DFACR2,DFBCR2,DFABR3,DFACR3,DFBCR3
      COMMON/cved31_f31/C6OHHS11,C8OHHS11,C10OHHS11,C6HOHS12,C8HOHS12,
     ...
     1    C8AB,C10AB
      COMMON/CVED32_f31/C6OHHT11,C8OHHT11,C10OHHT11,C6HOHP12,C8HOHP12,
...
C     **********
C     CONSTANTES ADICIONAIS USADAS NA VEOHHS_f31, VEOHHT_f31, VINDHOHS E VINDHOHP
      cost12=cost1*cost1
      cost13=cost12*cost1
      ...
      DAMPOHHS5=DAMPOHHS_f31(RG1,5,R1)/RG15
      DAMPOHHT5=DAMPOHHT_f31(Rg1,5,r1)/rg15
C     *******************
...
c calculado a partir das dist. de eq.(POL94:7651) RMOHS=1.80965D0
      ...
      C6OHHT11=C6OHHT_f31(r1,cost1)
      C8OHHT11=C8OHHT_f31(r1,cost1)
      C10OHHT11=C10OHHT_f31(r1,cost1)

      C6HOHP12=C6HOHP_f31(r2,cost2)
      C8HOHP12=C8HOHP_f31(r2,cost2)
      C10HOHP12=C10HOHP_f31(r2,cost2)

      C6HOHP13=C6HOHP_f31(r3,cost3)
      C8HOHP13=C8HOHP_f31(r3,cost3)
      C10HOHP13=C10HOHP_f31(r3,cost3)

      DAMPOHHT16=DAMPOHHT_f31(RG1,6,r1)
      DAMPOHHT18=DAMPOHHT_f31(RG1,8,r1)
      DAMPOHHT110=DAMPOHHT_f31(RG1,10,r1)

      DAMPHOHP26=DAMPHOHP_f31(RG2,6,r2)
      DAMPHOHP28=DAMPHOHP_f31(RG2,8,r2)
      DAMPHOHP210=DAMPHOHP_f31(RG2,10,r2)

      DAMPHOHP36=DAMPHOHP_f31(RG3,6,r3)
      DAMPHOHP38=DAMPHOHP_f31(RG3,8,r3)
      DAMPHOHP310=DAMPHOHP_f31(RG3,10,r3)

      C6OHHS11=C6OHHS_f31(r1,cost1)
      C8OHHS11=C8OHHS_f31(r1,cost1)
      C10OHHS11=C10OHHS_f31(r1,cost1)

      C6HOHS12=C6HOHS_f31(r2,cost2)
      C8HOHS12=C8HOHS_f31(r2,cost2)
      C10HOHS12=C10HOHS_f31(r2,cost2)

      C6HOHS13=C6HOHS_f31(r3,cost3)
      C8HOHS13=C8HOHS_f31(r3,cost3)
      C10HOHS13=C10HOHS_f31(r3,cost3)
      ...
      DAMPOHHS16=DAMPOHHS_f31(RG1,6,r1)
      DAMPOHHS18=DAMPOHHS_f31(RG1,8,r1)
      DAMPOHHS110=DAMPOHHS_f31(RG1,10,r1)

      DAMPHOHS26=DAMPHOHS_f31(RG2,6,r2)
      DAMPHOHS28=DAMPHOHS_f31(RG2,8,r2)
      DAMPHOHS210=DAMPHOHS_f31(RG2,10,r2)

      DAMPHOHS36=DAMPHOHS_f31(RG3,6,r3)
      DAMPHOHS38=DAMPHOHS_f31(RG3,8,r3)
      DAMPHOHS310=DAMPHOHS_f31(RG3,10,r3)
      ...
      FUNCTION VED31_f31(R1,R2,R3)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
      COMMON/cved_f31/COSB,COSC,RG1,RG2,RG3,
     1  COST1,COST2,COST3,FAB,FAC,FBC,
     1  FABC,FCAB,FBAC,CONST,RG14,RG15,RG16,RG17,RG18,RG19,RG110,
     1  RG112,RG116,RG120,RG25,RG26,RG27,RG28,RG29,RG210,RG212,
     1  RG216,RG220,RG35,RG36,RG37,RG38,RG39,RG310,RG312,RG316,
     1  RG320,DRG1R1,DRG2R1,DRG3R1,DRG1R2,DRG2R2,DRG3R2,DRG1R3,
...
c     ******************************************************************
     ...
     8      C10HOHS13*FBAC/rg310*DAMPHOHS310
      ...
      VED2=(FBC-1.0D0)*DISHHS_f31(R1)+(FAB-1.0D0)*DISOHS_f31(R2)+
     1                            (FAC-1.0D0)*DISOHS_f31(R3)
      ...
      FUNCTION DVED31R1_f31(R1,R2,R3)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
     ...
     1    C8AB,C10AB
      ...
      COMMON/DIATDI_f31/R0HH,RMHHS,RMHHT,R0OHP,R0OHS,RMOHP,RMOHS,VO1D
c     ******************************************************************
      DVED31R1_f31=-((DC6OHHSR1_f31(r1,cost1,DCOST1R1)*FABC+DFABCR1*
     1      C6OHHS11)*
     1      DAMPOHHS16/rg16+(DDAMPOHHSR1_f31(RG1,6,R1,DRG1R1)*
     1      RG16-6.0D0*
     1      DRG1R1*RG15*DAMPOHHS16)/RG112*C6OHHS11*FABC)-
     1      ((DC8OHHSR1_f31(r1,cost1,DCOST1R1)*FABC+DFABCR1*C8OHHS11)*
     1      DAMPOHHS18/rg18+(DDAMPOHHSR1_f31(RG1,8,r1,DRG1R1)*
     1      RG18-8.0D0*
     1      DRG1R1*RG17*DAMPOHHS18)/RG116*C8OHHS11*FABC)-
     1      ((DC10OHHSR1_f31(r1,cost1,DCOST1R1)*FABC+DFABCR1*C10OHHS11)*
     1      DAMPOHHS110/rg110+(DDAMPOHHSR1_f31(RG1,10,R1,DRG1R1)*RG110-
     1      10.0D0*DRG1R1*RG19*DAMPOHHS110)/RG120*C10OHHS11*FABC)-
     1      ((DC6HOHSR1_f31(r2,cost2,DCOST2R1)*FCAB+DFCABR1*C6HOHS12)*
     1      DAMPHOHS26/rg26+(DDAMPHOHSR1_f31(RG2,6,R2,DRG2R1)*
     1      RG26-6.0D0*
     1      DRG2R1*RG25*DAMPHOHS26)/RG212*C6HOHS12*FCAB)-
     1      ((DC8HOHSR1_f31(r2,cost2,DCOST2R1)*FCAB+DFCABR1*C8HOHS12)*
     1      DAMPHOHS28/rg28+(DDAMPHOHSR1_f31(RG2,8,R2,DRG2R1)*
     1      RG28-8.0D0*
     1      DRG2R1*RG27*DAMPHOHS28)/RG216*C8HOHS12*FCAB)-
     1      ((DC10HOHSR1_f31(r2,cost2,DCOST2R1)*FCAB+DFCABR1*C10HOHS12)*
     1      DAMPHOHS210/rg210+(DDAMPHOHSR1_f31(RG2,10,R2,DRG2R1)*RG210-
     1      10.0D0*DRG2R1*RG29*DAMPHOHS210)/RG220*C10HOHS12*FCAB)-
     1      ((DC6HOHSR1_f31(r3,cost3,DCOST3R1)*FBAC+DFBACR1*C6HOHS13)*
     1      DAMPHOHS36/rg36+(DDAMPHOHSR1_f31(RG3,6,R3,DRG3R1)*RG36-
     1      6.0D0*DRG3R1*RG35*DAMPHOHS36)/RG312*C6HOHS13*FBAC)-
     1      ((DC8HOHSR1_f31(r3,cost3,DCOST3R1)*FBAC+DFBACR1*C8HOHS13)*
     1      DAMPHOHS38/rg38+(DDAMPHOHSR1_f31(RG3,8,R3,DRG3R1)*RG38-
     1      8.0D0*DRG3R1*RG37*DAMPHOHS38)/RG316*C8HOHS13*FBAC)-
     1      ((DC10HOHSR1_f31(r3,cost3,DCOST3R1)*FBAC+DFBACR1*C10HOHS13)*
     1      DAMPHOHS310/rg310+(DDAMPHOHSR1_f31(RG3,10,R3,DRG3R1)*RG310-
     1    10.0D0*DRG3R1*RG39*DAMPHOHS310)/RG320*C10HOHS13*FBAC)

CC      VED2=(FBC-1.0D0)*DISHHS_f31(R1)+(FAB-1.0D0)*DISOHS_f31(R2)+
CC     1                            (FAC-1.0D0)*DISOHS_f31(R3)

      DVED21R1=DFBCR1*DISHHS_f31(R1)+(FBC-1.0D0)*DDISHHS_f31(R1)+
     1        DFABR1*DISOHS_f31(R2)+
     2        DFACR1*DISOHS_f31(R3)


      DVED31R1_f31=DVED31R1_f31+DVED21R1
      ...
      FUNCTION dved31r2_f31(R1,R2,R3)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
      COMMON/cved_f31/COSB,COSC,RG1,RG2,RG3,COST1,
     1  COST2,COST3,FAB,FAC,FBC,
     ...
     1    C8AB,C10AB
      ...
      COMMON/DIATDI_f31/R0HH,RMHHS,RMHHT,R0OHP,R0OHS,RMOHP,RMOHS,VO1D
C     ******************************************************************
      dved31r2_f31=-((DC6OHHSR2_f31(r1,cost1,DCOST1R2)*FABC+DFABCR2*
     1      C6OHHS11)*
     1      DAMPOHHS16/rg16+(DDAMPOHHSR2_f31(RG1,6,R1,DRG1R2)*
     1      RG16-6.0D0*
     1      DRG1R2*RG15*DAMPOHHS16)/RG112*C6OHHS11*FABC)-
     1      ((DC8OHHSR2_f31(r1,cost1,DCOST1R2)*FABC+DFABCR2*C8OHHS11)*
     1      DAMPOHHS18/rg18+(DDAMPOHHSR2_f31(RG1,8,R1,DRG1R2)*
     1      RG18-8.0D0*
     1      DRG1R2*RG17*DAMPOHHS18)/RG116*C8OHHS11*FABC)-
     1      ((DC10OHHSR2_f31(r1,cost1,DCOST1R2)*FABC+DFABCR2*C10OHHS11)*
     1      DAMPOHHS110/rg110+(DDAMPOHHSR2_f31(RG1,10,R1,DRG1R2)*RG110-
     1      10.0D0*DRG1R2*RG19*DAMPOHHS110)/RG120*C10OHHS11*FABC)-
     1      ((DC6HOHSRAA_f31(r2,cost2,DCOST2R2)*FCAB+DFCABR2*C6HOHS12)*
     1      DAMPHOHS26/rg26+(DDAMPHOHSRAA_f31(RG2,6,R2,DRG2R2)*
     1      RG26-6.0D0*
     1      DRG2R2*RG25*DAMPHOHS26)/RG212*C6HOHS12*FCAB)-
     1      ((DC8HOHSRAA_f31(r2,cost2,DCOST2R2)*FCAB+DFCABR2*C8HOHS12)*
     1      DAMPHOHS28/rg28+(DDAMPHOHSRAA_f31(RG2,8,R2,DRG2R2)*
     1      RG28-8.0D0*
     1      DRG2R2*RG27*DAMPHOHS28)/RG216*C8HOHS12*FCAB)-
     1      ((DC10HOHSRAA_f31(r2,cost2,DCOST2R2)*FCAB+DFCABR2*
     1      C10HOHS12)*
     1      DAMPHOHS210/rg210+(DDAMPHOHSRAA_f31(RG2,10,R2,DRG2R2)*
     1      RG210-
     1      10.0D0*DRG2R2*RG29*DAMPHOHS210)/RG220*C10HOHS12*FCAB)-
     1      ((DC6HOHSRAB_f31(r3,cost3,DCOST3R2)*FBAC+DFBACR2*C6HOHS13)*
     1      DAMPHOHS36/rg36+(DDAMPHOHSRAB_f31(RG3,6,R3,DRG3R2)*
     1      RG36-6.0D0*
     1      DRG3R2*RG35*DAMPHOHS36)/RG312*C6HOHS13*FBAC)-
     1      ((DC8HOHSRAB_f31(r3,cost3,DCOST3R2)*FBAC+DFBACR2*C8HOHS13)*
     1      DAMPHOHS38/rg38+(DDAMPHOHSRAB_f31(RG3,8,R3,DRG3R2)*
     1      RG38-8.0D0*
     1      DRG3R2*RG37*DAMPHOHS38)/RG316*C8HOHS13*FBAC)-
     1      ((DC10HOHSRAB_f31(r3,cost3,DCOST3R2)*FBAC+DFBACR2*
     1      C10HOHS13)*
     1      DAMPHOHS310/rg310+(DDAMPHOHSRAB_f31(RG3,10,R3,DRG3R2)*RG310-
     1      10.0D0*DRG3R2*RG39*DAMPHOHS310)/RG320*C10HOHS13*FBAC)

CC      VED2=(FBC-1.0D0)*DISHHS_f31(R1)+(FAB-1.0D0)*DISOHS_f31(R2)+
CC     1                            (FAC-1.0D0)*DISOHS_f31(R3)

      DVED21R2=DFBCR2*DISHHS_f31(R1)+
     1   DFABR2*DISOHS_f31(R2)+(FAB-1.0D0)*
     1   DDISPOH_f31(R2,COHS(6),COHS(8),
     2   COHS(10),R0OHS,RMOHS)+
     2   DFACR2*DISOHS_f31(R3)

      dved31r2_f31=dved31r2_f31+DVED21R2
      RETURN
      END

      FUNCTION DVED31R3_f31(R1,R2,R3)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
      COMMON/cved_f31/COSB,COSC,RG1,RG2,
     1  RG3,COST1,COST2,COST3,FAB,FAC,FBC,
     1  FABC,FCAB,FBAC,CONST,RG14,RG15,RG16,RG17,RG18,RG19,RG110,
     1  RG112,RG116,RG120,RG25,RG26,RG27,RG28,RG29,RG210,RG212,
     1  RG216,RG220,RG35,RG36,RG37,RG38,RG39,RG310,RG312,RG316,
     1  RG320,DRG1R1,DRG2R1,DRG3R1,DRG1R2,DRG2R2,DRG3R2,DRG1R3,
     ...
     1    C8AB,C10AB
      ...
      COMMON/DIATDI_f31/R0HH,RMHHS,RMHHT,R0OHP,R0OHS,RMOHP,RMOHS,VO1D
C     ******************************************************************
      DVED31R3_f31=-((DC6OHHSR3_f31(r1,cost1,DCOST1R3)*FABC+DFABCR3*
     1      C6OHHS11)*
     1      DAMPOHHS16/rg16+(DDAMPOHHSR3_f31(RG1,6,R1,DRG1R3)*
     1      RG16-6.0D0*
     1      DRG1R3*RG15*DAMPOHHS16)/RG112*C6OHHS11*FABC)-
     1      ((DC8OHHSR3_f31(r1,cost1,DCOST1R3)*FABC+DFABCR3*C8OHHS11)*
     1      DAMPOHHS18/rg18+(DDAMPOHHSR3_f31(RG1,8,R1,DRG1R3)*
     1      RG18-8.0D0*
     1      DRG1R3*RG17*DAMPOHHS18)/RG116*C8OHHS11*FABC)-
     1      ((DC10OHHSR3_f31(r1,cost1,DCOST1R3)*FABC+DFABCR3*
     1      C10OHHS11)*
     1      DAMPOHHS110/rg110+(DDAMPOHHSR3_f31(RG1,10,R1,DRG1R3)*RG110-
     1      10.0D0*DRG1R3*RG19*DAMPOHHS110)/RG120*C10OHHS11*FABC)-
     1      ((DC6HOHSRAB_f31(r2,cost2,DCOST2R3)*FCAB+DFCABR3*C6HOHS12)*
     1      DAMPHOHS26/rg26+(DDAMPHOHSRAB_f31(RG2,6,R2,DRG2R3)*
     1      RG26-6.0D0*
     1      DRG2R3*RG25*DAMPHOHS26)/RG212*C6HOHS12*FCAB)-
     1      ((DC8HOHSRAB_f31(r2,cost2,DCOST2R3)*FCAB+DFCABR3*C8HOHS12)*
     1      DAMPHOHS28/rg28+(DDAMPHOHSRAB_f31(RG2,8,R2,DRG2R3)*
     1      RG28-8.0D0*
     1      DRG2R3*RG27*DAMPHOHS28)/RG216*C8HOHS12*FCAB)-
     1      ((DC10HOHSRAB_f31(r2,cost2,DCOST2R3)*FCAB+DFCABR3*
     1      C10HOHS12)*
     1      DAMPHOHS210/rg210+(DDAMPHOHSRAB_f31(RG2,10,R2,DRG2R3)*
     1      RG210-
     1      10.0D0*DRG2R3*RG29*DAMPHOHS210)/RG220*C10HOHS12*FCAB)-
     1      ((DC6HOHSRAA_f31(r3,cost3,DCOST3R3)*FBAC+DFBACR3*C6HOHS13)*
     1      DAMPHOHS36/rg36+(DDAMPHOHSRAA_f31(RG3,6,R3,DRG3R3)*
     1      RG36-6.0D0*
     1      DRG3R3*RG35*DAMPHOHS36)/RG312*C6HOHS13*FBAC)-
     1      ((DC8HOHSRAA_f31(r3,cost3,DCOST3R3)*FBAC+DFBACR3*C8HOHS13)*
     1      DAMPHOHS38/rg38+(DDAMPHOHSRAA_f31(RG3,8,R3,DRG3R3)*
     1      RG38-8.0D0*
     1      DRG3R3*RG37*DAMPHOHS38)/RG316*C8HOHS13*FBAC)-
     1      ((DC10HOHSRAA_f31(r3,cost3,DCOST3R3)*FBAC+DFBACR3*
     1      C10HOHS13)*
     1      DAMPHOHS310/rg310+(DDAMPHOHSRAA_f31(RG3,10,R3,DRG3R3)*RG310-
     1      10.0D0*DRG3R3*RG39*DAMPHOHS310)/RG320*C10HOHS13*FBAC)

CC      VED2=(FBC-1.0D0)*DISHHS_f31(R1)+(FAB-1.0D0)*DISOHS_f31(R2)+
CC     1                            (FAC-1.0D0)*DISOHS_f31(R3)

      DVED21R3=DFBCR3*DISHHS_f31(R1)+
     1  DFABR3*DISOHS_f31(R2)+
     2  DFACR3*DISOHS_f31(R3)+(FAC-1.0D0)*
     1  DDISPOH_f31(R3,COHS(6),COHS(8),
     2  COHS(10),R0OHS,RMOHS)

      DVED31R3_f31=DVED31R3_f31+DVED21R3
      RETURN
      END

      FUNCTION DAMPHOHS_f31(R,N,X)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
c     ******************************************************************
      COMMON/AN_f31/A(20)
...
c     ******************************************************************
      ...
      RO=0.5D0*(RMHOHS+2.5D0*R0HOHSC_f31(X))
      DAMPHOHS_f31=(1.0D0-EXP(-A(N)*R/RO-B(N)*R**2/RO**2))**N
      RETURN
      END

      FUNCTION DDAMPHOHSR1_f31(R,N,X,D)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
C     ******************************************************************
      COMMON/AN_f31/A(20)
...
c     ******************************************************************
      ...
      RO2=RO*RO
      DROR1=0.0D0
      DDAMPHOHSR1_f31=N*(1.0D0-EXP(-A(N)*
     1 R/RO-B(N)*R**2/RO2))**(N-1.0d0)
     1 *(A(N)*(D*RO-DROR1*R)/RO2+2.0D0*B(N)*(R/RO)*(D*RO-DROR1*R)
     1          /RO2)*EXP(-A(N)*R/RO-B(N)*R**2/RO2)
      RETURN
      END

      FUNCTION DDAMPHOHSRAA_f31(R,N,X,D)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
C     ******************************************************************
      COMMON/AN_f31/A(20)
...
c     ******************************************************************
      ...
      RO=0.5D0*(RMHOHS+2.5D0*R0HOHSC_f31(X))
      RO2=RO*RO
      DROR23=0.5D0*2.5D0*DR0HOHSCR23_f31(X)
      DDAMPHOHSRAA_f31=N*(1.0D0-EXP(-A(N)*R/RO-B(N)*
     1 R**2/RO2))**(N-1.0d0)
     ...
     1          /RO2)*EXP(-A(N)*R/RO-B(N)*R**2/RO2)
      ...
      FUNCTION DDAMPHOHSRAB_f31(R,N,X,D)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
C     ******************************************************************
      COMMON/AN_f31/A(20)
...
c     ******************************************************************
      ...
      RO2=RO*RO
      DROR23=0.0D0
      DDAMPHOHSRAB_f31=N*(1.0D0-EXP(-A(N)*
     1 R/RO-B(N)*R**2/RO2))**(N-1.0d0)
     1 *(A(N)*(D*RO-DROR23*R)/RO2+2.0D0*B(N)*(R/RO)*(D*RO-DROR23*R)
     1          /RO2)*EXP(-A(N)*R/RO-B(N)*R**2/RO2)
      RETURN
...
c     ******************************************************************
      RMOHHS=1.1077763d0
      RO=0.5D0*(RMOHHS+2.5D0*R0OHHSC_f31(X))
      DAMPOHHS_f31=(1.0D0-EXP(-A(N)*R/RO-B(N)*R**2/RO**2))**N
      RETURN
      END

      FUNCTION DDAMPOHHSR1_f31(R,N,X,D)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
C     ******************************************************************
      COMMON/AN_f31/A(20)
...
c     ******************************************************************
      ...
      RO=0.5D0*(RMOHHS+2.5D0*R0OHHSC_f31(X))
      RO2=RO*RO
      DROR1=0.5D0*2.5D0*DR0OHHSCR1_f31(X)
      DDAMPOHHSR1_f31=N*(1.0D0-EXP(-A(N)*R/RO-B(N)*R**2/RO2))**(N-1)
     1 *(A(N)*(D*RO-DROR1*R)/RO2+2.0D0*B(N)*(R/RO)*(D*RO-DROR1*R)
     1          /RO2)*EXP(-A(N)*R/RO-B(N)*R**2/RO2)
      RETURN
      END

      FUNCTION DDAMPOHHSR2_f31(R,N,X,D)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
C     ******************************************************************
      COMMON/AN_f31/A(20)
...
c     ******************************************************************
      ...
      RO2=RO*RO
      DROR2=0.0D0
      DDAMPOHHSR2_f31=N*(1.0D0-EXP(-A(N)*R/RO-B(N)*R**2/RO2))**(N-1)
     1 *(A(N)*(D*RO-DROR2*R)/RO2+2.0D0*B(N)*(R/RO)*(D*RO-DROR2*R)
     1          /RO2)*EXP(-A(N)*R/RO-B(N)*R**2/RO2)
      RETURN
      END

      FUNCTION DDAMPOHHSR3_f31(R,N,X,D)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
C     ******************************************************************
      COMMON/AN_f31/A(20)
...
c     ******************************************************************
      ...
      RO2=RO*RO
      DROR3=0.0D0
      DDAMPOHHSR3_f31=N*(1.0D0-EXP(-A(N)*R/RO-B(N)*R**2/RO2))**(N-1)
     1 *(A(N)*(D*RO-DROR3*R)/RO2+2.0D0*B(N)*(R/RO)*(D*RO-DROR3*R)
     1          /RO2)*EXP(-A(N)*R/RO-B(N)*R**2/RO2)
      RETURN
      END

      FUNCTION C6OHHS_f31(R,COST)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
      common/c6ohhsae_f31/a6s,b6s
c     ******************************************************************
      A6s=C6OHHSPA_f31(R)
      B6s=C6OHHSPE_f31(R)
      PL=0.5D0*(3.0D0*COST**2-1.0D0)
      C6OHHS_f31=(1.0D0/3.0D0)*(2.0D0*B6s+A6s)+(2.0D0/3.0D0)*
     1 (A6s-B6s)*PL
      RETURN
      END

      FUNCTION DC6OHHSR1_f31(R,COST,D)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
      common/c6ohhsae_f31/a6s,b6s
c     ******************************************************************
      DC6PE=DC6OHHSPER1_f31(R)
      DC6PA=DC6OHHSPAR1_f31(R)
      DC6OHHSR1_f31=2.0D0/3.0D0*DC6PE+1.0D0/3.0D0*DC6PA
     ...
     1         COST**2-1.0D0)+6.0D0*D*COST*1.0D0/3.0D0*(A6s-B6s)
      ...
      FUNCTION DC6OHHSR2_f31(R,COST,D)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
      common/c6ohhsae_f31/a6s,b6s
      dummy=r
c     ******************************************************************
      DC6OHHSR2_f31=2.0D0*D*COST*(A6s-B6s)
      RETURN
      END

      FUNCTION DC6OHHSR3_f31(R,COST,D)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
      common/c6ohhsae_f31/a6s,b6s
      dummy=r
c     ******************************************************************
      DC6OHHSR3_f31=2.0D0*D*COST*(A6s-B6s)
      RETURN
      END

      FUNCTION C8OHHS_f31(R,COST)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
      common/c8ohhsae_f31/a8s,b8s
c     ******************************************************************
      A8s=C8OHHSPA_f31(R)
      B8s=C8OHHSPE_f31(R)
      PL=0.5D0*(3.0D0*COST**2-1.0D0)
      C8OHHS_f31=(1.0D0/3.0D0)*(2.0D0*B8s+A8s)+(2.0D0/3.0D0)*
     1 (A8s-B8s)*PL
      RETURN
      END

      FUNCTION DC8OHHSR1_f31(R,COST,D)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
      common/c8ohhsae_f31/a8s,b8s
c     ******************************************************************
      DC8PE=DC8OHHSPER1_f31(R)
      DC8PA=DC8OHHSPAR1_f31(R)
      DC8OHHSR1_f31=2.0D0/3.0D0*DC8PE+1.0D0/3.0D0*DC8PA
     ...
     1         COST**2-1.0D0)+6.0D0*D*COST*(1.0D0/3.0D0)*(A8s-B8s)
      ...
      FUNCTION DC8OHHSR2_f31(R,COST,D)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
      common/c8ohhsae_f31/a8s,b8s
      dummy=r
c     ******************************************************************
      DC8OHHSR2_f31=2.0D0*D*COST*(A8s-B8s)
      RETURN
      END

      FUNCTION DC8OHHSR3_f31(R,COST,D)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
      common/c8ohhsae_f31/a8s,b8s
      dummy=r
c     ******************************************************************
      DC8OHHSR3_f31=2.0D0*D*COST*(A8s-B8s)
      RETURN
      END

      FUNCTION C10OHHS_f31(R,COST)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
...
c     ******************************************************************
      ...
      B1s=C10OHHSPE_f31(R)
      PL=0.5D0*(3.0D0*COST**2-1.0D0)
      C10OHHS_f31=(1.0D0/3.0D0)*(2.0D0*B1s+A1s)+(2.0D0/3.0D0)*
     1 (A1s-B1s)*PL
      RETURN
      END

      FUNCTION DC10OHHSR1_f31(R,COST,D)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
      common/c1ohhsae_f31/a1s,b1s
c     ******************************************************************
      DC10PE=DC10OHHSPER1_f31(R)
      DC10PA=DC10OHHSPAR1_f31(R)
      DC10OHHSR1_f31=(2.0D0/3.0D0)*DC10PE+(1.0D0/3.0D0)*
     1  DC10PA+(1.0D0/3.0D0)*(DC10PA-DC10PE)
     1   *(3.0D0*COST**2-1.0D0)+6.0D0*D*COST*(1.0D0/3.0D0)*(A1s-B1s)
      RETURN
      END

      FUNCTION DC10OHHSR2_f31(R,COST,D)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
      common/c1ohhsae_f31/a1s,b1s
      dummy=r
c     ******************************************************************
      DC10OHHSR2_f31=2.0D0*D*COST*(A1s-B1s)
      RETURN
      END

      FUNCTION DC10OHHSR3_f31(R,COST,D)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
      common/c1ohhsae_f31/a1s,b1s
      dummy=r
c     ******************************************************************
      DC10OHHSR3_f31=2.0D0*D*COST*(A1s-B1s)
      RETURN
      END

      FUNCTION C6HOHS_f31(R,COST)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
c     ******************************************************************
      A1=C6HOHSPA_f31(R)
      ...
      C6HOHS_f31=(1.0D0/3.0D0)*(2.0D0*B1+A1)+(2.0D0/3.0D0)*(A1-B1)*PL1
      RETURN
      END

       FUNCTION DC6HOHSR1_f31(R,COST,D)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
c     ******************************************************************
      A1=C6HOHSPA_f31(R)
      B1=C6HOHSPE_f31(R)
      DC6HOHSR1_f31=2.0D0*D*COST*(A1-B1)
      RETURN
      END

      FUNCTION DC6HOHSRAA_f31(R,COST,D)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
c     ******************************************************************
      A1=C6HOHSPA_f31(R)
      B1=C6HOHSPE_f31(R)
      DC6PEA=DC6HOHSPERAA_f31(R)
      DC6PAA=DC6HOHSPARAA_f31(R)
      DC6HOHSRAA_f31=(2.0D0/3.0D0)*DC6PEA+(1.0D0/3.0D0)*
     1   DC6PAA+(1.0D0/3.0D0)*(DC6PAA-DC6PEA
     1   )*(3.0D0*COST**2-1.0D0)+6.0D0*D*COST*(1.0D0/3.0D0)*(A1-B1)
      RETURN
      END

      FUNCTION DC6HOHSRAB_f31(R,COST,D)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
c     ******************************************************************
      A1=C6HOHSPA_f31(R)
      B1=C6HOHSPE_f31(R)
      DC6HOHSRAB_f31=2.0D0*D*COST*(A1-B1)
      RETURN
      END

      FUNCTION C8HOHS_f31(R,COST)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
c     ******************************************************************
      A1=C8HOHSPA_f31(R)
      B1=C8HOHSPE_f31(R)
      PL1=0.5D0*(3.0D0*COST**2-1.0D0)
      C8HOHS_f31=(1.0D0/3.0D0)*(2.0D0*B1+A1)+(2.0D0/3.0D0)*(A1-B1)*PL1
      RETURN
      END

      FUNCTION DC8HOHSR1_f31(R,COST,D)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
c     ******************************************************************
      A1=C8HOHSPA_f31(R)
      B1=C8HOHSPE_f31(R)
      DC8HOHSR1_f31=2.0D0*D*COST*(A1-B1)
      RETURN
      END

      FUNCTION DC8HOHSRAA_f31(R,COST,D)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
c     ******************************************************************
      A1=C8HOHSPA_f31(R)
      B1=C8HOHSPE_f31(R)
      DC8PEA=DC8HOHSPERAA_f31(R)
      DC8PAA=DC8HOHSPARAA_f31(R)
      DC8HOHSRAA_f31=(2.0D0/3.0D0)*DC8PEA+(1.0D0/3.0D0)*
     1   DC8PAA+(1.0D0/3.0D0)*(DC8PAA-DC8PEA)
     1   *(3.0D0*COST**2-1.0D0)+6.0D0*D*COST*(1.0D0/3.0D0)*(A1-B1)
      RETURN
      END

      FUNCTION DC8HOHSRAB_f31(R,COST,D)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
c     ******************************************************************
      A1=C8HOHSPA_f31(R)
      B1=C8HOHSPE_f31(R)
      DC8HOHSRAB_f31=2.0D0*D*COST*(A1-B1)
      RETURN
      END

      FUNCTION C10HOHS_f31(R,COST)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
c     ******************************************************************
      A1=C10HOHSPA_f31(R)
      B1=C10HOHSPE_f31(R)
      PL1=0.5D0*(3.0D0*COST**2-1.0D0)
      C10HOHS_f31=(1.0D0/3.0D0)*(2.0D0*B1+A1)+(2.0D0/3.0D0)*(A1-B1)*PL1
      RETURN
      END

      FUNCTION DC10HOHSR1_f31(R,COST,D)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
c     ******************************************************************
      A1=C10HOHSPA_f31(R)
      B1=C10HOHSPE_f31(R)
      DC10HOHSR1_f31=2.0D0*D*COST*(A1-B1)
      RETURN
      END

      FUNCTION DC10HOHSRAA_f31(R,COST,D)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
c     ******************************************************************
      A1=C10HOHSPA_f31(R)
      B1=C10HOHSPE_f31(R)
      DC10PEA=DC10HOHSPERAA_f31(R)
      DC10PAA=DC10HOHSPARAA_f31(R)
      DC10HOHSRAA_f31=(2.0D0/3.0D0)*DC10PEA+(1.0D0/3.0D0)*
     1   DC10PAA+(1.0D0/3.0D0)*(DC10PAA-DC10PEA
     1   )*(3.0D0*COST**2-1.0D0)+6.0D0*D*COST*(1.0D0/3.0D0)*(A1-B1)
      RETURN
      END

      FUNCTION DC10HOHSRAB_f31(R,COST,D)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
c     ******************************************************************
      A1=C10HOHSPA_f31(R)
      B1=C10HOHSPE_f31(R)
      DC10HOHSRAB_f31=2.0D0*D*COST*(A1-B1)
      RETURN
      END

      FUNCTION C6OHHSPA_f31(R)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
...
c     ******************************************************************
      ...
      DALP=DALPHHSPAR1_f31(r)
      e=0.5d0/SQRT(ALP/RNH)*(dalp*rnh-DRNHHSR1_f31(r)*alp)/rnh**2
      d=SQRT(ALP/RNH)+SQRT(5.62136d0/2.79d0)
      DC6HSPa1=(const1*dalp*d-const1*alp*e)/d**2
      DC6OHHSPAR1_f31=DC6HSPa1
      RETURN
      END

      FUNCTION C8OHHSPA_f31(R)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
      COMMON/C6PA_f31/C6HSPA,R0O,ALP,RNH
      dummy=r
c     ******************************************************************
      C8OHHSPA_f31=1.0d0*C6HSPA*R0O**(1.57243d0)
      RETURN
      END

      FUNCTION DC8OHHSPAR1_f31(R)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
      COMMON/C6PA_f31/C6HSPA,R0O,ALP,RNH
      COMMON/DC6PA1_f31/DC6HSPa1
...
c     ******************************************************************
      DR0HSCR1=DR0OHHSCR1_f31(R)
      DC8OHHSPAR1_f31=DC6HSPA1*R0O**(1.57243D0)+1.57243D0*
     1      R0O**(0.57243D0)*DR0HSCR1*C6HSPA
      RETURN
      END

      FUNCTION C10OHHSPA_f31(R)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
      COMMON/C6PA_f31/C6HSPA,R0O,ALP,RNH
      dummy=r
c     ******************************************************************
      C10OHHSPA_f31=1.13178d0*C6HSPA*R0O**(1.57243d0*2.0d0)
      RETURN
      END

      FUNCTION DC10OHHSPAR1_f31(R)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
      COMMON/C6PA_f31/C6HSPA,R0O,ALP,RNH
      COMMON/DC6PA1_f31/DC6HSPa1
...
c     ******************************************************************
      ...
      DC6OHHSPER1_f31=DC6HSPE1
      RETURN
      END

      FUNCTION C8OHHSPE_f31(R)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
      COMMON/C6PE_f31/C6HSPE,R0O,RNH,alp,DALP
      dummy=r
...
c     substitui 1.54 por 1.57243
      C8OHHSPE_f31=1.0d0*C6HSPE*R0O**1.57243d0
      RETURN
      END

      FUNCTION DC8OHHSPER1_f31(R)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
      COMMON/C6PE_f31/C6HSPE,R0O,RNH,alp,DALP
      COMMON/DC6PE_f31/DC6HSPE1
...
c     ******************************************************************
c     substitui 1.54 por 1.57243
      DR0HSCE1=DR0OHHSCR1_f31(R)
      DC8OHHSPER1_f31=DC6HSPE1*R0O**(1.57243D0)+1.57243D0*
     1      R0O**(1.57243D0-1.0D0)*DR0HSCE1*C6HSPE

      RETURN
      END

      FUNCTION C10OHHSPE_f31(R)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
      COMMON/C6PE_f31/C6HSPE,R0O,RNH,alp,DALP
      dummy=r
c     ******************************************************************
c     substitui 1.31 por 1.13178 ; 1.54 por 1.57243
      C10OHHSPE_f31=1.13178d0*C6HSPE*R0O**(1.57243d0*2.0d0)
      RETURN
      END

      FUNCTION DC10OHHSPER1_f31(R)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
      COMMON/C6PE_f31/C6HSPE,R0O,RNH,alp,DALP
      COMMON/DC6PE_f31/DC6HSPE1
...
c     ******************************************************************
c     substitui 1.31 por 1.13178 ; 1.54 por 1.57243
      DC10OHHSPER1_f31=1.13178D0*DC6HSPE1*R0O**(1.57243D0*
     1    2.0D0)+(1.57243D0*2.0D0)*R0O**(1.57243D0*2.0D0-1.0D0)*
     1     DR0HSCE1*1.13178D0*C6HSPE
      RETURN
      END

      FUNCTION C6HOHSPA_f31(R)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
c     ******************************************************************
      ALP=ALPOHSPA_f31(R)
      C6HOHSPA_f31=1.5d0*4.500d0*ALP/(SQRT(ALP/RNOHS_f31(R))+2.25d0)
      RETURN
      END

      FUNCTION DC6HOHSPARAA_f31(R)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
c     ******************************************************************
      ...
      ALP=ALPOHSPA_f31(R)
      RNO=RNOHS_f31(R)
      dalp=DALPOHSPAR23_f31(r)
      d=SQRT(ALP/RNO)+2.25D0
      e=0.5d0/SQRT(ALP/RNO)*(dalp*rno-DRNOHSR23_f31(r)*alp)/rno**2
      DC6HOHSPARAA_f31=(const1*dalp*d-e*const1*alp)/d**2
      RETURN
      END

      FUNCTION C8HOHSPA_f31(R)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
c     ******************************************************************
      C8HOHSPA_f31=1.0d0*C6HOHSPA_f31(R)*R0HOHSC_f31(R)**(1.57243d0)
      RETURN
      END

      FUNCTION DC8HOHSPARAA_f31(R)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
c     ******************************************************************
      R0H=R0HOHSC_f31(R)
      DC8HOHSPARAA_f31=DC6HOHSPARAA_f31(R)*R0H**1.57243D0+1.57243D0*
     1      R0H**(1.57243D0-1.0D0)*DR0HOHSCR23_f31(R)*C6HOHSPA_f31(R)
      RETURN
      END

      FUNCTION C10HOHSPA_f31(R)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
c     ******************************************************************
c     substitui 1.31 por 1.13178 ; 1.54 por 1.57243
      C10HOHSPA_f31=1.13178d0*C6HOHSPA_f31(r)*R0HOHSC10_f31(r)**(2.0d0*
     1  1.57243d0)
      RETURN
      END

      FUNCTION DC10HOHSPARAA_f31(R)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
c     ******************************************************************
      R0H=R0HOHSC10_f31(R)
      DC10HOHSPARAA_f31=1.13178D0*DC6HOHSPARAA_f31(R)*R0H**(2.0D0*
     1  1.57243D0)+2.0D0*1.57243D0*R0H**(2.0D0*1.57243D0-
     1    1.0D0)*DR0HOHSC10R23_f31(R)*1.13178D0*C6HOHSPA_f31(R)
      RETURN
      END

      FUNCTION C6HOHSPE_f31(R)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
c     ******************************************************************
      ALP=ALPOHSPE_f31(r)
      C6HOHSPE_f31=1.5d0*4.500d0*ALP/(SQRT(ALP/RNOHS_f31(R))+2.25d0)
      RETURN
      END

      FUNCTION DC6HOHSPERAA_f31(R)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
c     ******************************************************************
      const1=1.5D0*4.500D0
      RNO=RNOHS_f31(R)
      ALP=ALPOHSPE_f31(R)
      dalp=DALPOHSPER23_f31(r)
      d=SQRT(ALP/RNO)+2.25D0
      e=0.5d0/SQRT(ALP/RNO)*(dalp*rno-DRNOHSR23_f31(r)*alp)/rno**2
      DC6HOHSPERAA_f31=(const1*dalp*d-e*const1*alp)/d**2
      RETURN
      END

      FUNCTION C8HOHSPE_f31(R)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
c     ******************************************************************
c     substitui 1.54 por 1.57243
      C8HOHSPE_f31=1.0d0*C6HOHSPE_f31(r)*R0HOHSC_f31(r)**(1.57243d0)
      RETURN
      END

      FUNCTION DC8HOHSPERAA_f31(R)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
c     ******************************************************************
c     substitui 1.54 por 1.57243
      R0H=R0HOHSC_f31(R)
      DC8HOHSPERAA_f31=DC6HOHSPERAA_f31(R)*R0H**1.57243D0+1.57243D0*
     1      R0H**(1.57243D0-1.0D0)*DR0HOHSCR23_f31(R)*C6HOHSPE_f31(R)
      RETURN
      END

      FUNCTION C10HOHSPE_f31(R)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
c     ******************************************************************
c     substitui 1.31 por 1.13178 ; 1.54 por 1.57243
      C10HOHSPE_f31=1.13178d0*C6HOHSPE_f31(R)*R0HOHSC10_f31(R)**(2.0d0*
     1  1.57243d0)
      RETURN
      END

      FUNCTION DC10HOHSPERAA_f31(R)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
c     ******************************************************************
C     substitui 1.31 por 1.13178 ; 1.54 por 1.57243
      R0H=R0HOHSC10_f31(R)
      DC10HOHSPERAA_f31=1.13178D0*DC6HOHSPERAA_f31(R)*R0H**(2.0D0*
     1  1.57243D0)+2.0D0*1.57243D0*R0H**(2.0D0*1.57243D0-
     1    1.0D0)*DR0HOHSC10R23_f31(R)*1.13178D0*C6HOHSPE_f31(R)
      RETURN
      END

      FUNCTION RNOHS_f31(R)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
c     ******************************************************************
      Ainf=4.2594d0
      ...
      RNOHS_f31=ainf+a*exp(-c*(R-re))
      RETURN
      END

      FUNCTION DRNOHSR23_f31(R)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
c     ******************************************************************
      Ainf=4.2594d0
      ...
      a=-0.2963609d0
      c=0.584820271D0/1.04D0
      DRNOHSR23_f31=-A*C*exp(-c*(R-re))
      RETURN
      END

      FUNCTION RNHHS_f31(R)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
c     ******************************************************************
      Ainf=1.78d0
      ...
      a=-0.1478d0
      c=0.60634691d0
      RNHHS_f31=ainf+a*exp(-c*(R-re))
      RETURN
      END

      FUNCTION DRNHHSR1_f31(R)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
c     ******************************************************************
      Ainf=1.78d0
      ...
      a=-0.1478d0
      c=0.60634691d0
      DRNHHSR1_f31=-a*C*exp(-c*(R-re))
      RETURN
      END

      FUNCTION ALPHHSPA_f31(R)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
...
c     ******************************************************************
      ...
      rr3=rr2*r
      rr5=rr2*rr3
      ALPHHSPA_f31=Ainf1+(azero+C1*r+C2*rr2+c3*rr3)*
     1   EXP(-C4*r-C5*rr2)+(1-EXP(-C6*rr5))*C7/rr3
      RETURN
      END

      FUNCTION DALPHHSPAR1_f31(R)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
      DATA AINF1,C1,C2,C3,C4,C5,C6,C7/9.0D0,6.3134223d0,-2.8677438d0,
     1 7.7770980d-1,-7.6966611d-1,2.8116781d-1,4.1567195d-3,1.5074557d2/
c     ******************************************************************
      ...
      rr4=rr3*r
      rr5=rr4*r
      DALPHHSPAR1_f31=(C1+2.0D0*C2*R+3.0D0*C3*RR2)*EXP(-C4*r-C5*RR2)-
...
c     ******************************************************************
      ...
      rr3=rr2*r
      rr5=rr2*rr3
      ALPHHSPE_f31=Ainf1+(azero+C1*r+C2*RR2+c3*RR3)*
     1   EXP(-C4*r-C5*RR2)+(1-EXP(-C6*RR5))*C7/RR3
      RETURN
      END

      FUNCTION DALPHHSPER1_f31(R)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
      DATA AINF1,C1,C2,C3,C4,C5,C6,C7/9.0D0,4.8750306d0,-1.8684334d0,3.8
     1 222971d-1,-5.6354499d-1,2.8106756d-1,1.7861826d-3,-2.8274363d1/
c     ******************************************************************
      ...
      rr4=rr3*r
      rr5=rr4*r
      DALPHHSPER1_f31=(C1+2.0D0*C2*R+3.0D0*C3*RR2)*EXP(-C4*r-C5*RR2)-
     1          (C4+2.0D0*C5*R)*(azero+C1*r+C2*RR2+c3*RR3)*EXP(-C4*r
     1          -C5*RR2)-3.0D0*C7/RR4+3.0D0*C7/RR4*EXP(-C6*RR5)+
     1          5.0D0*C6*C7*R*EXP(-C6*RR5)
      RETURN
...
c     ******************************************************************
      ...
      rr2=r*r
      rr3=rr2*r
      ALPOHSPA_f31=Ainf1+(Azero+C1*r+C2*RR2+C3*RR3)*EXP(
     1 -C4*r-C5*RR2-C6*RR3)+(1-EXP(-C7*r**8))*C8/r**6
      RETURN
      END

      FUNCTION DALPOHSPAR23_f31(R)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
      DATA AINF1,C1,C2,C3,C4,C5,C6,C7,c8/8.7752955d0,7.7784665d0,-3.77
     1   08106d0,6.3231864d-1,-1.1225788d0,-7.2086523d-1,2.7382895d-1,
...
c     ******************************************************************
      ...
      rr7=rr2*RR2*RR3
      rr8=rr2*RR3*RR3
      DALPOHSPAR23_f31=(C1+2.0D0*C2*R+3.0D0*C3*RR2)*EXP(-C4*r-C5*RR2-C6
...
c     ******************************************************************
      ...
      ALPOHSPE_f31=Ainf1-Azero*EXP(-C1*r-C2*r**2-C3*
     1       r**3)+(1-EXP(-C4*r**5))*C5/r**3
      RETURN
      END

      FUNCTION DALPOHSPER23_f31(R)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
      DATA AINF1,C1,C2,C3,C4,C5/9.6378446d0,-1.5996623d-3,3.2213045d-1,
     1   1.4377753d-2,2.3615487d-3,-4.6276713d1/
c     ******************************************************************
      ...
      RR4=RR2*RR2
      RR5=RR4*R
      DALPOHSPER23_f31=Azero*(C1+2.0D0*C2*r+3.0D0*C3*RR2)*
     1         EXP(-C1*r-C2*RR2
...
c     ******************************************************************
      ...
      ALPHHSM=(1.0d0/3.0d0)*ALPHHSPA_f31(r)+(2.0d0/3.0d0)*
     1  ALPHHSPE_f31(r)
      R0OHHSC_f31=2.0d0*((alphhsm**(1.0d0/3.0d0))+sqrt(2.003423d0))*
     1  FCORR
      RETURN
      END

      FUNCTION DR0OHHSCR1_f31(R)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
c     ******************************************************************
      finf=6.334299622d0/6.9916231d0
      ...
      ALPHHSM=(1.0d0/3.0d0)*ALPHHSPA_f31(r)+(2.0d0/3.0d0)*
     1  ALPHHSPE_f31(r)
      DALPHHSMR1=(1.0d0/3.0d0)*DALPHHSPAR1_f31(r)+(2.0d0/3.0d0)*
     1          DALPHHSPER1_f31(r)
      DR0OHHSCR1_f31=2.0D0*DFCORR*((alphhsm**(1.0d0/3.0d0))+
     1 sqrt(2.003423d0))+(1.0d0/3.0d0)*alphhsm**(-2.0d0/3.0d0)*
     1 DALPHHSMR1*2.0D0*FCORR
      RETURN
      END

      FUNCTION R0HOHSC_f31(R)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
c     ******************************************************************
      ...
      c=0.584820271D0/1.04D0
      FCORR=finf+d*exp(-c*r)
      ALPOHSM=(1.0d0/3.0d0)*ALPOHSPA_f31(R)+(2.0d0/3.0d0)*
     1 ALPOHSPE_f31(R)
      R0HOHSC_f31=2.0d0*((ALPOHSM**(1.0d0/3.0d0))+(6.9282d0/4.0d0))*
     1  FCORR
      RETURN
      END

      FUNCTION DR0HOHSCR23_f31(R)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
c     ******************************************************************
      finf=7.86489501d0/7.6781675d0
      ...
      ALPOHSM=(1.0d0/3.0d0)*ALPOHSPA_f31(R)+(2.0d0/3.0d0)*
     1 ALPOHSPE_f31(R)
      DALPHAM=1.0d0/3.0d0*DALPOHSPAR23_f31(R)+2.0d0/3.0d0*
     1  DALPOHSPER23_f31(R)
      DR0HOHSCR23_f31=2.0d0/3.0D0*alpOHSM**(-2.0d0/3.0d0)*DALPHAM*fcorr-
     1    2.0D0*c*d*exp(-c*r)*(alpOHSm**(1.0d0/3.0d0)+6.9282d0/4.0d0)
      RETURN
      END

      FUNCTION R0HOHSC10_f31(R)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
c     ******************************************************************
      ...
      ALPOHSM=(1.0d0/3.0d0)*ALPOHSPA_f31(R)+(2.0d0/3.0d0)*
     1 ALPOHSPE_f31(R)
      R0HOHSC10_f31=2.0d0*((ALPOHSM**(1.0d0/3.0d0))+(6.9282d0/4.0d0))*
     1   FCORR
      RETURN
      END

      FUNCTION DR0HOHSC10R23_f31(R)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
c     ******************************************************************
      finf=7.235196035d0/7.6781675d0
     ...
     1 ALPOHSPE_f31(R)
      DALPHAM=1.0d0/3.0d0*DALPOHSPAR23_f31(R)+2.0d0/3.0d0*
     1  DALPOHSPER23_f31(R)
      DR0HOHSC10R23_f31=2.0d0/(3.0D0*alpOHSM**(2.0d0/3.0d0))*
     1 DALPHAM*fcorr
     1  -2.0D0*c*d*(alpOHSM**(1.0d0/3.0d0)+(6.9282d0/4.0d0))*exp(-c*r)
      RETURN
      END

      FUNCTION FDOHS_f31(R)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
...
c     ******************************************************************
      ...
      RR3=RR2*R
      RR5=RR2*RR3
      FDOHS_f31=(C1*R+C2*RR2+C3*RR3)*EXP(-C4*R-C5*RR2-C6*RR3)+(1-EXP(-C7
     1       *RR5))*C8/RR3
      return
      end

      FUNCTION DFDOHSR23_f31(R)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
      DATA C1,C2,C3,C4,C5,C6,C7,C8/-5.3537295E-01,6.4491094E-01,8.53312
     1     26E-03,1.2881749E+00,-7.4776246E-01,1.8391757E-01,1.3506306
...
c     DIPOLO PARA O OH(2SI)
      ...
      RR4=RR3*R
      RR5=RR2*RR3
      DFDOHSR23_f31=(C1+2.0D0*C2*R+3.0D0*C3*RR2)*EXP(-C4*R-C5*
     1        RR2-C6*RR3)
     ...
     1        -C7*RR5)+5.0D0*C7*C8*R*EXP(-C7*RR5)
      ...
      FUNCTION VINDHOHS_f31(r1,r2,r3)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
      COMMON/AN_f31/A(20)
      COMMON/BN_f31/B(20)
     ...
     1    C8AB,C10AB
c     ******************************************************************
      VINDHOHS_f31=-FDOHS_f31(R2)**2*4.5D0*(3.0D0*COST2**2+1.0D0)*
     1          DAMPHOHS26/(2.0D0*rG26)
     1         -FDOHS_f31(R3)**2*4.5D0*(3.0D0*COST3**2+1.0D0)*
     1          DAMPHOHS36/(2.0D0*rG36)

      return
      end

      FUNCTION DVINDHOHSR1_f31(r1,r2,r3)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
      COMMON/AN_f31/A(20)
      COMMON/BN_f31/B(20)
     ...
     1    DAMPHOHS36,DAMPHOHS38,DAMPHOHS310,C6AC,C8AC,C10AC,C6AB,
     1    C8AB,C10AB
      COMMON/DVINDR_f31/TA,TB,XB,XB1,FDOHSR2,FDOHSR3,TA1,TA2,XA,XA1
c     ******************************************************************
      ...
      FDOHSR2=FDOHS_f31(R2)
      FDOHSR3=FDOHS_f31(R3)
      TA1=-4.5D0*FDOHSR2**2
      TA2=-4.5D0*FDOHSR3**2
      xa=TA1*TA
      xa1=TA2*TB
      DVINDHOHSR1_f31=xb*(-4.5d0*2.0d0*FDOHSR2*DFDOHSR1*Ta+dTar1*TA1)
     1 +xa*(DDAMPHOHSR1_f31(Rg2,6,r2,DRG2R1)*2.0D0*RG26
     1 -12.0D0*RG25*DRG2R1*DAMPHOHS26)/(4.0D0*RG212)
     1         +xb1*(-4.5d0*2.0d0*FDOHSR3*DFDOHSR1*TB+dTBr1*TA2)
     1 +Xa1*(DDAMPHOHSR1_f31(Rg3,6,r3,DRG3R1)*2.0D0*RG36
     1 -12.0D0*RG35*DRG3R1*DAMPHOHS36)/(4.0D0*RG312)
      return
      end

      FUNCTION DVINDHOHSR2_f31(r1,r2,r3)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
      COMMON/AN_f31/A(20)
      COMMON/BN_f31/B(20)
...
c     ******************************************************************
      ...
      DFDOHSR23R3=0.0D0
      DVINDHOHSR2_f31=xb*(-4.5d0*2.0d0*FDOHSR2*DFDOHSR23_f31(R2)*
     1  Ta+dTar2
     1 *TA1)+xa*(DDAMPHOHSRAA_f31(Rg2,6,r2,DRG2R2)*2.0D0*RG26
     1 -12.0D0*RG25*DRG2R2*DAMPHOHS26)/(4.0D0*RG212)
     1      +xb1*(-4.5d0*2.0d0*FDOHSR3*DFDOHSR23R3*TB+dTBr2*TA2)
     1 +Xa1*(DDAMPHOHSRAB_f31(Rg3,6,r3,DRG3R2)*2.0D0*RG36
     1 -12.0D0*RG35*DRG3R2*DAMPHOHS36)/(4.0D0*RG312)
      return
      end

      FUNCTION DVINDHOHSR3_f31(r1,r2,r3)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
      COMMON/AN_f31/A(20)
      COMMON/BN_f31/B(20)
...
c     ******************************************************************
      ...
      DFDOHSR23R2=0.0D0
      DVINDHOHSR3_f31=xb*(-4.5d0*2.0d0*FDOHSR2*DFDOHSR23R2*Ta+dTar3
     1 *TA1)+xa*(DDAMPHOHSRAB_f31(Rg2,6,r2,DRG2R3)*2.0D0*RG26
     1 -12.0D0*RG25*DRG2R3*DAMPHOHS26)/(4.0D0*RG212)
     1    +xb1*(-4.5d0*2.0d0*FDOHSR3*DFDOHSR23_f31(R3)*TB+dTBr3*TA2)
     1 +Xa1*(DDAMPHOHSRAA_f31(Rg3,6,r3,DRG3R3)*2.0D0*RG36
     1 -12.0D0*RG35*DRG3R3*DAMPHOHS36)/(4.0D0*RG312)
      return
      end

      FUNCTION FQHHS_f31(R)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
...
c     ******************************************************************
      ...
      RR3=RR2*R
      RR5=RR3*RR2
      FQHHS_f31=(C1*R+C2*RR2+C3*RR3)*EXP(-C4*R
     1      -C5*RR2-C6*RR3)+(1-EXP(-C7*RR5))*C8/RR3
      return
      end

      FUNCTION DFQHHSR1_f31(R)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
      DATA C1,C2,C3,C4,C5,C6,C7,C8/9.2292863d-02,-1.0187873d-02,1.03075
     1     21d-02,-1.0635640d0,2.8476217d-01,1.1961650d-08,1.3473360
...
c     ******************************************************************
      ...
      RR4=RR3*R
      RR5=RR3*RR2
      DFQHHSR1_f31=(C1+2.0D0*C2*R+3.0D0*C3*RR2)*EXP(-C4*R-C5*RR2-C6*RR3)
     1        -(C4+2.0D0*C5*R+3.0D0*C6*RR2)*(C1*R+C2*RR2+C3*RR3)*EXP
     1        (-C4*R-C5*RR2-C6*RR3)-3.0D0*C8/RR4+3.0D0*C8/RR4*EXP(
     1        -C7*RR5)+5.0D0*C7*C8*R*EXP(-C7*RR5)
      return
...
c     o valor do quadrupolo do O(1D)=1.233793Buckingham=0.917288208au
      ...
      VEOHHS_f31=0.75d0*FQHHS_f31(R1)*0.917288208D0*at*DAMPOHHS5
      return
      end

      FUNCTION DVEOHHSR1_f31(r1,r2,r3)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
      COMMON/AN_f31/A(20)
      COMMON/BN_f31/B(20)
     ...
     1  cos2t1,cos4t1,cos6t1,dcos2t,dcos4t,dcos6t,DAMPOHHS5,DAMPOHHT5,
     1  DFABR1,DFACR1,DFBCR1,DFABR2,DFACR2,DFBCR2,DFABR3,DFACR3,DFBCR3
      COMMON/DVEOHS_f31/AT,DAT,FQHHSR1
c     ******************************************************************
      at=b0+b2*cos2t1+b4*cos4t1+b6*cos6t1
      DAT=B2*dcos2t+b4*dcos4t+b6*dcos6t
      DATR1=DAT*dcost1r1
      CONSTV=0.75d0*0.917288208d0
      FQHHSR1=FQHHS_f31(R1)
      DVEOHHSR1_f31=(DFQHHSR1_f31(R1)*AT+DATR1*FQHHSR1)*CONSTV*
     1     DAMPOHHS5+
     1     (DDAMPOHHSR1_f31(Rg1,5,r1,drg1r1)*rg15-5.0D0*DRG1R1*
     1     RG14*DAMPOHHS5*RG15)/(rg110)*at*CONSTV*FQHHSR1
      return
      end

      FUNCTION DVEOHHSR2_f31(r1,r2,r3)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
      COMMON/AN_f31/A(20)
      COMMON/BN_f31/B(20)
...
c     o valor do quadrupolo do O(1D)=1.233793Buckingham=0.917288208au
      DATR2=DAT*dcost1r2
      CONSTV=0.75d0*0.917288208d0
      DVEOHHSR2_f31=(DATR2*FQHHSR1)*CONSTV*DAMPOHHS5+
     1        (DDAMPOHHSR2_f31(Rg1,5,r1,DRG1R2)*rg15-5.0D0*DRG1R2*
     1        RG14*DAMPOHHS5*Rg15)/(rg110)*at*CONSTV*FQHHSR1
      return
      end

      FUNCTION DVEOHHSR3_f31(r1,r2,r3)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
      COMMON/AN_f31/A(20)
      COMMON/BN_f31/B(20)
...
c     o valor do quadrupolo do O(1D)=1.233793Buckingham=0.917288208au
      DATR3=DAT*dcost1r3
      CONSTV=0.75d0*0.917288208d0
      DVEOHHSR3_f31=(DATR3*FQHHSR1)*CONSTV*DAMPOHHS5+
     1    (DDAMPOHHSR3_f31(Rg1,5,r1,DRG1R3)*rg15-5.0D0*DRG1R3*
     1    RG14*DAMPOHHS5*RG15)/(rg110)*at*CONSTV*FQHHSR1
      return
      end

      FUNCTION rl1_f31(r1E,r2E,r3E)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
c     ******************************************************************
      R1=R1E+1.0D-8
      R2=R2E+1.0D-8
      R3=R3E+1.0D-8
      CALL GEOMRL_f31(R1,R2,R3)
c    ***************************************************************

      rl1_f31=VED31_f31(r1,r2,r3)+VEOHHS_f31(r1,r2,r3)+
     1  VINDHOHS_f31(r1,r2,r3)
      return
      end

      SUBROUTINE drl1_f31(R1E,R2E,R3E,DER1,DER2,DER3)
c     ******************************************************************
...
c     ******************************************************************
      ...
      R3=R3E+1.0D-8
      CALL GEOMRL_f31(R1,R2,R3)
      DER1=DVED31R1_f31(r1,r2,r3)+DVEOHHSR1_f31(r1,r2,r3)+
     1 DVINDHOHSR1_f31(r1,r2,r3)



      DER2=dved31r2_f31(r1,r2,r3)+DVEOHHSR2_f31(r1,r2,r3)+
     1 DVINDHOHSR2_f31(r1,r2,r3)

      DER3=DVED31R3_f31(r1,r2,r3)+DVEOHHSR3_f31(r1,r2,r3)+
     1 DVINDHOHSR3_f31(r1,r2,r3)
      RETURN
      END

      FUNCTION VED32_f31(R1,R2,R3)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
      COMMON/DIATDI_f31/R0HH,RMHHS,RMHHT,R0OHP,R0OHS,RMOHP,RMOHS,VO1D
      COMMON/cved_f31/COSB,COSC,RG1,RG2,
...
c     ******************************************************************
     ...
     8      C10HOHP13*FBAC/rg310*DAMPHOHP310
      ...
      VED2=(FBC-1.0D0)*DISHHT_f31(R1)+(FAB-1.0D0)*DISOHP_f31(R2)+
     1                            (FAC-1.0D0)*DISOHP_f31(R3)
...
C      PRINT*,'C6OHHT_f31,C8OHHT_f31,C10OHHT',C6OHHT11,C8OHHT11,C10OHHT11
C      PRINT*,'C6HOHP1,C8HOHP_f31,C10HOHP',C6HOHP12,C8HOHP12,C10HOHP12
C      PRINT*,'C6HOHP2,C8HOHP_f31,C10HOHP',C6HOHP13,C8HOHP13,C10HOHP13
C      PRINT*,'VED32',VED32
C      PRINT*,'VED3,VED2',VED3,VED2
      RETURN
      END

      FUNCTION DVED32R1_f31(R1,R2,R3)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
      COMMON/cved_f31/COSB,COSC,RG1,RG2,RG3,COST1,
     1  COST2,COST3,FAB,FAC,FBC,
     ...
     1    C8AB2,C10AB2
      ...
      COMMON/DIATDI_f31/R0HH,RMHHS,RMHHT,R0OHP,R0OHS,RMOHP,RMOHS,VO1D
c     ******************************************************************
      DVED32R1_f31=-((DC6OHHTR1_f31(r1,cost1,DCOST1R1)*FABC+
     1      DFABCR1*C6OHHT11)*
     1      DAMPOHHT16/rg16+(DDAMPOHHTR1_f31(RG1,6,R1,DRG1R1)*
     1      RG16-6.0D0*
     1      DRG1R1*RG15*DAMPOHHT16)/RG112*C6OHHT11*FABC)-
     1      ((DC8OHHTR1_f31(r1,cost1,DCOST1R1)*FABC+DFABCR1*C8OHHT11)*
     1      DAMPOHHT18/rg18+
     1      (DDAMPOHHTR1_f31(RG1,8,r1,DRG1R1)*RG18-8.0D0*
     1      DRG1R1*RG17*DAMPOHHT18)/RG116*C8OHHT11*FABC)-
     1      ((DC10OHHTR1_f31(r1,cost1,DCOST1R1)*FABC+DFABCR1*C10OHHT11)*
     1      DAMPOHHT110/rg110+(DDAMPOHHTR1_f31(RG1,10,R1,DRG1R1)*RG110-
     1      10.0D0*DRG1R1*RG19*DAMPOHHT110)/RG120*C10OHHT11*FABC)-
     1      ((dc6hohpr1_f31(r2,cost2,DCOST2R1)*FCAB+DFCABR1*C6HOHP12)*
     1      DAMPHOHP26/rg26+(DDAMPHOHPR1_f31(RG2,6,R2,DRG2R1)
     1      *RG26-6.0D0*
     1      DRG2R1*RG25*DAMPHOHP26)/RG212*C6HOHP12*FCAB)-
     1      ((DC8HOHPR1_f31(r2,cost2,DCOST2R1)*FCAB+DFCABR1*C8HOHP12)*
     1      DAMPHOHP28/rg28+(DDAMPHOHPR1_f31(RG2,8,R2,DRG2R1)*
     1      RG28-8.0D0*
     1      DRG2R1*RG27*DAMPHOHP28)/RG216*C8HOHP12*FCAB)-
     1      ((DC10HOHPR1_f31(r2,cost2,DCOST2R1)*FCAB+DFCABR1*C10HOHP12)*
     1      DAMPHOHP210/rg210+(DDAMPHOHPR1_f31(RG2,10,R2,DRG2R1)*RG210-
     1      10.0D0*DRG2R1*RG29*DAMPHOHP210)/RG220*C10HOHP12*FCAB)-
     1      ((dc6hohpr1_f31(r3,cost3,DCOST3R1)*FBAC+DFBACR1*C6HOHP13)*
     1      DAMPHOHP36/rg36+(DDAMPHOHPR1_f31(RG3,6,R3,DRG3R1)*RG36-
     1      6.0D0*DRG3R1*RG35*DAMPHOHP36)/RG312*C6HOHP13*FBAC)-
     1      ((DC8HOHPR1_f31(r3,cost3,DCOST3R1)*FBAC+DFBACR1*C8HOHP13)*
     1      DAMPHOHP38/rg38+(DDAMPHOHPR1_f31(RG3,8,R3,DRG3R1)*RG38-
     1      8.0D0*DRG3R1*RG37*DAMPHOHP38)/RG316*C8HOHP13*FBAC)-
     1      ((DC10HOHPR1_f31(r3,cost3,DCOST3R1)*FBAC+DFBACR1*C10HOHP13)*
     1      DAMPHOHP310/rg310+(DDAMPHOHPR1_f31(RG3,10,R3,DRG3R1)*
     1      RG310-
...
CC      VED2=(FBC-1.0D0)*DISHHT_f31(R1)+(FAB-1.0D0)*DISOHP_f31(R2)+
CC     1                            (FAC-1.0D0)*DISOHP_f31(R3)

      DVED22R1=DFBCR1*DISHHT_f31(R1)+(FBC-1.0D0)*DDISHHT_f31(R1)+
     1        DFABR1*DISOHP_f31(R2)+
     2        DFACR1*DISOHP_f31(R3)

      DVED32R1_f31=DVED32R1_f31+DVED22R1
      ...
      FUNCTION dved32r2_f31(R1,R2,R3)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
      COMMON/cved_f31/COSB,COSC,RG1,RG2,RG3,
     1  COST1,COST2,COST3,FAB,FAC,FBC,
     ...
     1    C8AB2,C10AB2
      ...
      COMMON/DIATDI_f31/R0HH,RMHHS,RMHHT,R0OHP,R0OHS,RMOHP,RMOHS,VO1D
c     ******************************************************************
      dved32r2_f31=-((DC6OHHTR2_f31(r1,cost1,DCOST1R2)*
     1 FABC+DFABCR2*C6OHHT11)*
     1      DAMPOHHT16/rg16+(DDAMPOHHTR2_f31(RG1,6,R1,DRG1R2)*
     1      RG16-6.0D0*
     1      DRG1R2*RG15*DAMPOHHT16)/RG112*C6OHHT11*FABC)-
     1      ((DC8OHHTR2_f31(r1,cost1,DCOST1R2)*FABC+DFABCR2*C8OHHT11)*
     1      DAMPOHHT18/rg18+(DDAMPOHHTR2_f31(RG1,8,R1,DRG1R2)*
     1      RG18-8.0D0*
     1      DRG1R2*RG17*DAMPOHHT18)/RG116*C8OHHT11*FABC)-
     1      ((DC10OHHTR2_f31(r1,cost1,DCOST1R2)*FABC+DFABCR2*C10OHHT11)*
     1      DAMPOHHT110/rg1**10+(DDAMPOHHTR2_f31(RG1,10,R1,DRG1R2)*
     1      RG110-
     1      10.0D0*DRG1R2*RG19*DAMPOHHT110)/RG120*C10OHHT11*FABC)-
     1      ((DC6HOHPRAA_f31(r2,cost2,DCOST2R2)*FCAB+DFCABR2*C6HOHP12)*
     1      DAMPHOHP26/rg26+(DDAMPHOHPRAA_f31(RG2,6,R2,DRG2R2)
     1      *RG26-6.0D0*
     1      DRG2R2*RG25*DAMPHOHP26)/RG212*C6HOHP12*FCAB)-
     1      ((DC8HOHPRAA_f31(r2,cost2,DCOST2R2)*FCAB+DFCABR2*C8HOHP12)*
     1      DAMPHOHP28/rg28+(DDAMPHOHPRAA_f31(RG2,8,R2,DRG2R2)*
     1      RG28-8.0D0*
     1      DRG2R2*RG27*DAMPHOHP28)/RG216*C8HOHP12*FCAB)-
     1      ((DC10HOHPRAA_f31(r2,cost2,DCOST2R2)*FCAB+DFCABR2*
     1      C10HOHP12)*
     1      DAMPHOHP210/rg210+(DDAMPHOHPRAA_f31(RG2,10,R2,DRG2R2)*RG210-
     1      10.0D0*DRG2R2*RG29*DAMPHOHP210)/RG220*C10HOHP12*FCAB)-
     1      ((DC6HOHPRAB_f31(r3,cost3,DCOST3R2)*FBAC+DFBACR2*C6HOHP13)*
     1      DAMPHOHP36/rg36+(DDAMPHOHPRAB_f31(RG3,6,R3,DRG3R2)
     1      *RG36-6.0D0*
     1      DRG3R2*RG35*DAMPHOHP36)/RG312*C6HOHP13*FBAC)-
     1      ((DC8HOHPRAB_f31(r3,cost3,DCOST3R2)*FBAC+DFBACR2*C8HOHP13)*
     1      DAMPHOHP38/rg38+(DDAMPHOHPRAB_f31(RG3,8,R3,DRG3R2)
     1      *RG38-8.0D0*
     1      DRG3R2*RG37*DAMPHOHP38)/RG316*C8HOHP13*FBAC)-
     1      ((DC10HOHPRAB_f31(r3,cost3,DCOST3R2)*FBAC+DFBACR2*
     1      C10HOHP13)*
     1      DAMPHOHP310/rg310+(DDAMPHOHPRAB_f31(RG3,10,R3,DRG3R2)*RG310-
     1      10.0D0*DRG3R2*RG39*DAMPHOHP310)/RG320*C10HOHP13*FBAC)

CC      VED2=(FBC-1.0D0)*DISHHT_f31(R1)+(FAB-1.0D0)*DISOHP_f31(R2)+
CC     1                            (FAC-1.0D0)*DISOHP_f31(R3)

      DVED22R2=DFBCR2*DISHHT_f31(R1)+
     1        DFABR2*DISOHP_f31(R2)+(FAB-1.0D0)*
     1        DDISPOH_f31(R2,COHP(6),COHP(8),
     2        COHP(10),R0OHP,RMOHP)+
     2        DFACR2*DISOHP_f31(R3)

      dved32r2_f31=dved32r2_f31+DVED22R2

      RETURN
      END

      FUNCTION dved32r3_f31(R1,R2,R3)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
      COMMON/cved_f31/COSB,COSC,RG1,RG2,RG3,
     1  COST1,COST2,COST3,FAB,FAC,FBC,
     ...
     1    C8AB2,C10AB2
      ...
      COMMON/DIATDI_f31/R0HH,RMHHS,RMHHT,R0OHP,R0OHS,RMOHP,RMOHS,VO1D
c     ******************************************************************
      dved32r3_f31=-((DC6OHHTR3_f31(r1,cost1,DCOST1R3)*FABC+
     1     DFABCR3*C6OHHT11)*
     1      DAMPOHHT16/rg16+(DDAMPOHHTR3_f31(RG1,6,R1,DRG1R3)*
     1      RG16-6.0D0*
     1      DRG1R3*RG15*DAMPOHHT16)/RG112*C6OHHT11*FABC)-
     1      ((DC8OHHTR3_f31(r1,cost1,DCOST1R3)*FABC+DFABCR3*C8OHHT11)*
     1      DAMPOHHT18/rg18+(DDAMPOHHTR3_f31(RG1,8,R1,DRG1R3)*
     1      RG18-8.0D0*
     1      DRG1R3*RG17*DAMPOHHT18)/RG116*C8OHHT11*FABC)-
     1      ((DC10OHHTR3_f31(r1,cost1,DCOST1R3)*FABC+DFABCR3*C10OHHT11)*
     1      DAMPOHHT110/rg110+(DDAMPOHHTR3_f31(RG1,10,R1,DRG1R3)*RG110-
     1      10.0D0*DRG1R3*RG19*DAMPOHHT110)/RG120*C10OHHT11*FABC)-
     1      ((DC6HOHPRAB_f31(r2,cost2,DCOST2R3)*FCAB+DFCABR3*C6HOHP12)*
     1      DAMPHOHP26/rg26+(DDAMPHOHPRAB_f31(RG2,6,R2,DRG2R3)*
     1      RG26-6.0D0*
     1      DRG2R3*RG25*DAMPHOHP26)/RG212*C6HOHP12*FCAB)-
     1      ((DC8HOHPRAB_f31(r2,cost2,DCOST2R3)*FCAB+DFCABR3*C8HOHP12)*
     1      DAMPHOHP28/rg28+(DDAMPHOHPRAB_f31(RG2,8,R2,DRG2R3)*
     1      RG28-8.0D0*
     1      DRG2R3*RG27*DAMPHOHP28)/RG216*C8HOHP12*FCAB)-
     1      ((DC10HOHPRAB_f31(r2,cost2,DCOST2R3)*FCAB+DFCABR3*
     1      C10HOHP12)*
     1      DAMPHOHP210/rg210+(DDAMPHOHPRAB_f31(RG2,10,R2,DRG2R3)*RG210-
     1      10.0D0*DRG2R3*RG29*DAMPHOHP210)/RG220*C10HOHP12*FCAB)-
     1      ((DC6HOHPRAA_f31(r3,cost3,DCOST3R3)*FBAC+DFBACR3*C6HOHP13)*
     1      DAMPHOHP36/rg36+(DDAMPHOHPRAA_f31(RG3,6,R3,DRG3R3)*
     1      RG36-6.0D0*
     1      DRG3R3*RG35*DAMPHOHP36)/RG312*C6HOHP13*FBAC)-
     1      ((DC8HOHPRAA_f31(r3,cost3,DCOST3R3)*FBAC+DFBACR3*C8HOHP13)*
     1      DAMPHOHP38/rg38+(DDAMPHOHPRAA_f31(RG3,8,R3,DRG3R3)*
     1      RG38-8.0D0*
     1      DRG3R3*RG37*DAMPHOHP38)/RG316*C8HOHP13*FBAC)-
     1      ((DC10HOHPRAA_f31(r3,cost3,DCOST3R3)*FBAC+DFBACR3*
     1      C10HOHP13)*
     1      DAMPHOHP310/rg310+(DDAMPHOHPRAA_f31(RG3,10,R3,DRG3R3)*RG310-
...
CC     1                            (FAC-1.0D0)*DISOHP_f31(R3)
      ...
      DVED22R3=DFBCR3*DISHHT_f31(R1)+
     1        DFABR3*DISOHP_f31(R2)+
     2        DFACR3*DISOHP_f31(R3)+(FAC-1.0D0)*
     2        DDISPOH_f31(R3,COHP(6),COHP(8),
     2        COHP(10),R0OHP,RMOHP)

      dved32r3_f31=dved32r3_f31+DVED22R3
      RETURN
      END


      FUNCTION DAMPHOHP_f31(R,N,X)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
C     ******************************************************************
      COMMON/AN_f31/A(20)
...
c     calculado a partir das dist. de eq.(POL94:7651)
      ...
      RO=0.5D0*(RMHOHP+2.5D0*R0HOHPC_f31(x))
      DAMPHOHP_f31=(1.0D0-EXP(-A(N)*R/RO-B(N)*R**2/RO**2))**N
      RETURN
      END

      FUNCTION DDAMPHOHPR1_f31(R,N,X,D)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
C     ******************************************************************
      COMMON/AN_f31/A(20)
...
c     ******************************************************************
      ...
      RO2=RO*RO
      DROR1=0.0D0
      DDAMPHOHPR1_f31=N*(1.0D0-EXP(-A(N)*R/RO-B(N)*R**2/RO2))**(N-1.0d0)
     1 *(A(N)*(D*RO-DROR1*R)/RO2+2.0D0*B(N)*(R/RO)*(D*RO-DROR1*R)
     1          /RO2)*EXP(-A(N)*R/RO-B(N)*R**2/RO2)
      RETURN
      END

      FUNCTION DDAMPHOHPRAA_f31(R,N,X,D)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
C     ******************************************************************
      COMMON/AN_f31/A(20)
...
c     ******************************************************************
      ...
      RO=0.5D0*(RMHOHP+2.5D0*R0HOHPC_f31(x))
      RO2=RO*RO
      DROR23=0.5D0*2.5D0*DR0HOHPCR23_f31(x)
      DDAMPHOHPRAA_f31=N*(1.0D0-EXP(-A(N)*R/RO-B(N)*
     1 R**2/RO2))**(N-1.0d0)
     1 *(A(N)*(D*RO-DROR23*R)/RO2+2.0D0*B(N)*(R/RO)*(D*RO-DROR23*R)
     1          /RO2)*EXP(-A(N)*R/RO-B(N)*R**2/RO2)
      RETURN
      ...
      FUNCTION DDAMPHOHPRAB_f31(R,N,X,D)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
C     ******************************************************************
      COMMON/AN_f31/A(20)
...
c     ******************************************************************
      ...
      RO2=RO*RO
      DROR23=0.0D0
      DDAMPHOHPRAB_f31=N*(1.0D0-EXP(-A(N)*R/RO-B(N)*
     1  R**2/RO2))**(N-1.0d0)
     1 *(A(N)*(D*RO-DROR23*R)/RO2+2.0D0*B(N)*(R/RO)*(D*RO-DROR23*R)
     1          /RO2)*EXP(-A(N)*R/RO-B(N)*R**2/RO2)
      RETURN
...
c     ******************************************************************
      RMOHHT=1.1077763d0
      RO=0.5D0*(RMOHHT+2.5D0*R0OHHTC_f31(X))
      DAMPOHHT_f31=(1.0D0-EXP(-A(N)*R/RO-B(N)*R**2/RO**2))**N
      RETURN
      END

      FUNCTION DDAMPOHHTR1_f31(R,N,X,D)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
C     ******************************************************************
      COMMON/AN_f31/A(20)
...
c     ******************************************************************
      ...
      RO=0.5D0*(RMOHHT+2.5D0*R0OHHTC_f31(X))
      RO2=RO*RO
      DROR1=0.5D0*2.5D0*DR0OHHTCR1_f31(X)
      DDAMPOHHTR1_f31=N*(1.0D0-EXP(-A(N)*R/RO-B(N)*R**2/RO2))**(N-1.0d0)
     1 *(A(N)*(D*RO-DROR1*R)/RO2+2.0D0*B(N)*(R/RO)*(D*RO-DROR1*R)
     1          /RO2)*EXP(-A(N)*R/RO-B(N)*R**2/RO2)
      RETURN
      END

      FUNCTION DDAMPOHHTR2_f31(R,N,X,D)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
C     ******************************************************************
      COMMON/AN_f31/A(20)
...
c     ******************************************************************
      ...
      RO2=RO*RO
      DROR2=0.0D0
      DDAMPOHHTR2_f31=N*(1.0D0-EXP(-A(N)*R/RO-B(N)*R**2/RO2))**(N-1.0d0)
     1 *(A(N)*(D*RO-DROR2*R)/RO2+2.0D0*B(N)*(R/RO)*(D*RO-DROR2*R)
     1          /RO2)*EXP(-A(N)*R/RO-B(N)*R**2/RO2)
      RETURN
      END

      FUNCTION DDAMPOHHTR3_f31(R,N,X,D)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
C     ******************************************************************
      COMMON/AN_f31/A(20)
...
c     ******************************************************************
      ...
      RO2=RO*RO
      DROR3=0.0D0
      DDAMPOHHTR3_f31=N*(1.0D0-EXP(-A(N)*R/RO-B(N)*R**2/RO2))**(N-1.0d0)
     1 *(A(N)*(D*RO-DROR3*R)/RO2+2.0D0*B(N)*(R/RO)*(D*RO-DROR3*R)
     1          /RO2)*EXP(-A(N)*R/RO-B(N)*R**2/RO2)
      RETURN
      END

      FUNCTION C6OHHT_f31(R,COST)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
      common/c6ohhtae_f31/a6t,b6t
c     ******************************************************************
      A6t=C6OHHTPA_f31(R)
      B6t=C6OHHTPE_f31(R)
      PL=0.5D0*(3.0D0*COST**2-1.0D0)
      C6OHHT_f31=(1.0D0/3.0D0)*(2.0D0*B6t+A6t)+(2.0D0/3.0D0)*
     1 (A6t-B6t)*PL
      RETURN
      END

      FUNCTION DC6OHHTR1_f31(R,COST,D)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
      common/c6ohhtae_f31/a6t,b6t
c     ******************************************************************
      DC6PE=DC6OHHTPER1_f31(R)
      DC6PA=DC6OHHTPAR1_f31(R)
      DC6OHHTR1_f31=2.0D0/3.0D0*DC6PE+1.0D0/3.0D0*DC6PA
     1        +1.0D0/3.0D0*(DC6PA-DC6PE)*(3.0D0*
     1         COST**2-1.0D0)+6.0D0*D*COST*1.0D0/3.0D0*(A6t-B6t)
      ...
      FUNCTION DC6OHHTR2_f31(R,COST,D)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
      common/c6ohhtae_f31/a6t,b6t
c     ******************************************************************
      DC6OHHTR2_f31=6.0D0*D*COST*1.0D0/3.0D0*(A6t-B6t)
      RETURN
      END

      FUNCTION DC6OHHTR3_f31(R,COST,D)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
      common/c6ohhtae_f31/a6t,b6t
c     ******************************************************************
      DC6OHHTR3_f31=6.0D0*D*COST*1.0D0/3.0D0*(A6t-B6t)
      RETURN
      END

      FUNCTION C8OHHT_f31(R,COST)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
      common/c8ohhtae_f31/a8t,b8t
c     ******************************************************************
      A8t=C8OHHTPA_f31(R)
      B8t=C8OHHTPE_f31(R)
      PL=0.5D0*(3.0D0*COST**2-1.0D0)
      C8OHHT_f31=(1.0D0/3.0D0)*(2.0D0*B8t+A8t)+
     1 (2.0D0/3.0D0)*(A8t-B8t)*PL
      RETURN
      END

      FUNCTION DC8OHHTR1_f31(R,COST,D)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
      common/c8ohhtae_f31/a8t,b8t
c     ******************************************************************
      DC8PE=DC8OHHTPER1_f31(R)
      DC8PA=DC8OHHTPAR1_f31(R)
      DC8OHHTR1_f31=2.0D0/3.0D0*DC8PE+1.0D0/3.0D0*DC8PA
     1        +1.0D0/3.0D0*(DC8PA-DC8PE)*(3.0D0*
     1         COST**2-1.0D0)+6.0D0*D*COST*(1.0D0/3.0D0)*(A8t-B8t)
      ...
      FUNCTION DC8OHHTR2_f31(R,COST,D)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
      common/c8ohhtae_f31/a8t,b8t
c     ******************************************************************
      DC8OHHTR2_f31=6.0D0*D*COST*(1.0D0/3.0D0)*(A8t-B8t)
      RETURN
      END

      FUNCTION DC8OHHTR3_f31(R,COST,D)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
      common/c8ohhtae_f31/a8t,b8t
c     ******************************************************************
      DC8OHHTR3_f31=6.0D0*D*COST*(1.0D0/3.0D0)*(A8t-B8t)
      RETURN
      END

      FUNCTION C10OHHT_f31(R,COST)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
      common/c1ohhtae_f31/a1t,b1t
c     ******************************************************************
      A1t=C10OHHTPA_f31(R)
      B1t=C10OHHTPE_f31(R)
      PL=0.5D0*(3.0D0*COST**2-1.0D0)
      C10OHHT_f31=(1.0D0/3.0D0)*(2.0D0*B1t+A1t)+(2.0D0/3.0D0)*
     1   (A1t-B1t)*PL
      RETURN
      END

      FUNCTION DC10OHHTR1_f31(R,COST,D)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
      common/c1ohhtae_f31/a1t,b1t
c     ******************************************************************
      DC10PE=DC10OHHTPER1_f31(R)
      DC10PA=DC10OHHTPAR1_f31(R)
      DC10OHHTR1_f31=(2.0D0/3.0D0)*DC10PE+(1.0D0/3.0D0)*
     1  DC10PA+(1.0D0/3.0D0)*(DC10PA-DC10PE)
     1   *(3.0D0*COST**2-1.0D0)+6.0D0*D*COST*(1.0D0/3.0D0)*(A1t-B1t)
      RETURN
      END

      FUNCTION DC10OHHTR2_f31(R,COST,D)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
      common/c1ohhtae_f31/a1t,b1t
c     ******************************************************************
      DC10OHHTR2_f31=2.0D0*D*COST*(A1t-B1t)
      RETURN
      END

      FUNCTION DC10OHHTR3_f31(R,COST,D)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
      common/c1ohhtae_f31/a1t,b1t
c     ******************************************************************
      DC10OHHTR3_f31=2.0D0*D*COST*(A1t-B1t)
      RETURN
      END

      FUNCTION C6HOHP_f31(R,COST)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
c     ******************************************************************
      Ap=C6HOHPPA_f31(R)
      Bp=C6HOHPPE_f31(R)
      PL1=0.5D0*(3.0D0*COST**2-1.0D0)
      C6HOHP_f31=(1.0D0/3.0D0)*(2.0D0*Bp+Ap)+(2.0D0/3.0D0)*(Ap-Bp)*PL1
      RETURN
      END

      FUNCTION dc6hohpr1_f31(R,COST,D)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
c     ******************************************************************
      Ap=C6HOHPPA_f31(R)
      Bp=C6HOHPPE_f31(R)
      dc6hohpr1_f31=2.0D0*D*COST*(Ap-Bp)
      RETURN
      END

      FUNCTION DC6HOHPRAA_f31(R,COST,D)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
c     ******************************************************************
      Ap=C6HOHPPA_f31(R)
      Bp=C6HOHPPE_f31(R)
      DC6PEA=DC6HOHPPERAA_f31(R)
      DC6PAA=DC6HOHPPARAA_f31(R)
      DC6HOHPRAA_f31=(2.0D0/3.0D0)*DC6PEA+(1.0D0/3.0D0)*
     1   DC6PAA+(1.0D0/3.0D0)*(DC6PAA-DC6PEA
     1   )*(3.0D0*COST**2-1.0D0)+6.0D0*D*COST*(1.0D0/3.0D0)*(Ap-Bp)
      RETURN
      END

      FUNCTION DC6HOHPRAB_f31(R,COST,D)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
c     ******************************************************************
      Ap=C6HOHPPA_f31(R)
      Bp=C6HOHPPE_f31(R)
      DC6HOHPRAB_f31=2.0D0*D*COST*(Ap-Bp)
      RETURN
      END

      FUNCTION C8HOHP_f31(R,COST)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
c     ******************************************************************
      Ap8=C8HOHPPA_f31(R)
      Bp8=C8HOHPPE_f31(R)
      PL1=0.5D0*(3.0D0*COST**2-1.0D0)
      C8HOHP_f31=(1.0D0/3.0D0)*(2.0D0*Bp8+Ap8)+(2.0D0/3.0D0)*
     1  (Ap8-Bp8)*PL1
      RETURN
      END

      FUNCTION DC8HOHPR1_f31(R,COST,D)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
c     ******************************************************************
      Ap8=C8HOHPPA_f31(R)
      Bp8=C8HOHPPE_f31(R)
      DC8HOHPR1_f31=2.0D0*D*COST*(Ap8-Bp8)
      RETURN
      END

      FUNCTION DC8HOHPRAA_f31(R,COST,D)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
c     ******************************************************************
      Ap8=C8HOHPPA_f31(R)
      Bp8=C8HOHPPE_f31(R)
      DC8PEA=DC8HOHPPERAA_f31(R)
      DC8PAA=DC8HOHPPARAA_f31(R)
      DC8HOHPRAA_f31=(2.0D0/3.0D0)*DC8PEA+(1.0D0/3.0D0)*
     1   DC8PAA+(1.0D0/3.0D0)*(DC8PAA-DC8PEA)
     1   *(3.0D0*COST**2-1.0D0)+6.0D0*D*COST*(1.0D0/3.0D0)*(Ap8-Bp8)
      ...
      FUNCTION DC8HOHPRAB_f31(R,COST,D)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
c     ******************************************************************
      Ap8=C8HOHPPA_f31(R)
      Bp8=C8HOHPPE_f31(R)
      DC8HOHPRAB_f31=2.0D0*D*COST*(Ap8-Bp8)
      RETURN
      END

      FUNCTION C10HOHP_f31(R,COST)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
c     ******************************************************************
      Ap10=C10HOHPPA_f31(R)
      Bp10=C10HOHPPE_f31(R)
      PL1=0.5D0*(3.0D0*COST**2-1.0D0)
      C10HOHP_f31=(1.0D0/3.0D0)*(2.0D0*Bp10+Ap10)+(2.0D0/3.0D0)*
     1 (Ap10-Bp10)
     1         *PL1
      RETURN
      END

      FUNCTION DC10HOHPR1_f31(R,COST,D)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
c     ******************************************************************
      A1=C10HOHPPA_f31(R)
      B1=C10HOHPPE_f31(R)
      DC10HOHPR1_f31=2.0D0*D*COST*(A1-B1)
      RETURN
      END

      FUNCTION DC10HOHPRAA_f31(R,COST,D)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
c     ******************************************************************
      A1=C10HOHPPA_f31(R)
      B1=C10HOHPPE_f31(R)
      DC10PEA=DC10HOHPPERAA_f31(R)
      DC10PAA=DC10HOHPPARaa_f31(R)
      DC10HOHPRAA_f31=(2.0D0/3.0D0)*DC10PEA+(1.0D0/3.0D0)*
     1   DC10PAA+(1.0D0/3.0D0)*(DC10PAA-DC10PEA
     ...
     1   (A1-B1)
      ...
      FUNCTION DC10HOHPRAB_f31(R,COST,D)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
c     ******************************************************************
      A1=C10HOHPPA_f31(R)
      B1=C10HOHPPE_f31(R)
      DC10HOHPRAB_f31=2.0D0*D*COST*(A1-B1)
      RETURN
      END

      FUNCTION C6OHHTPA_f31(R)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
      COMMON/C6HTA_f31/C6HTPA,ALP,RN,R0HTC
c     ******************************************************************
      ALP=ALPHHTPA_f31(R)
      RN=RNHHT_f31(R)
      R0HTC=R0OHHTC_f31(R)
     ...
     1         SQRT(5.393D0/2.79D0))
      ...
      FUNCTION DC6OHHTPAR1_f31(R)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
      COMMON/C6HTA_f31/C6HTPA,ALP,RN,R0HTC
      COMMON/DC6TA_f31/DC6HTA,DR0HT1
c     ******************************************************************
      DR0HT1=DR0OHHTCR1_f31(R)
      const1=1.5D0*5.393D0
      dalp=DALPHHTPAR1_f31(r)
      e=0.5d0/SQRT(ALP/RN)*(dalp*rn-DRNHHTR1_f31(r)*alp)/rn**2
      d=SQRT(ALP/RN)+SQRT(5.393D0/2.79D0)
      DC6HTA=(const1*dalp*d-const1*alp*e)/d**2
      DC6OHHTPAR1_f31=DC6HTa

      RETURN
      END

      FUNCTION C8OHHTPA_f31(R)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
      COMMON/C6HTA_f31/C6HTPA,ALP,RN,R0HTC
c     ******************************************************************
c     substitui 1.54 por 1.57243
      C8OHHTPA_f31=1.0D0*C6HTPA*R0HTC**(1.57243D0)
      RETURN
      END

      FUNCTION DC8OHHTPAR1_f31(R)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
      COMMON/C6HTA_f31/C6HTPA,ALP,RN,R0HTC
      COMMON/DC6TA_f31/DC6HTA,DR0HT1
c     ******************************************************************
      DC8OHHTPAR1_f31=DC6HTA*R0HTC**(1.57243D0)+1.57243D0*
     1      R0HTC**(0.57243D0)*DR0HT1*C6HTPA

      RETURN
      END

       FUNCTION C10OHHTPA_f31(R)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
      COMMON/C6HTA_f31/C6HTPA,ALP,RN,R0HTC
c     ******************************************************************
      C10OHHTPA_f31=1.13178D0*C6HTPA*R0HTC**(1.57243D0*2.0D0)
      RETURN
      END

      FUNCTION DC10OHHTPAR1_f31(R)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
      COMMON/C6HTA_f31/C6HTPA,ALP,RN,R0HTC
      COMMON/DC6TA_f31/DC6HTA,DR0HT1
c     ******************************************************************
      DC10OHHTPAR1_f31=1.13178D0*DC6HTA*R0HTC**(1.57243D0*
     1     2.0D0)+(1.57243D0*2.0D0)*R0HTC**(1.57243D0*2.0D0-1.0D0)
     1     *DR0HT1*1.13178D0*C6HTPA
      RETURN
      END

      FUNCTION C6OHHTPE_f31(R)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
      COMMON/C6TPE_f31/C6HTPE,ALP,RN,R0HTC
c     ******************************************************************
      ALP=ALPHHTPE_f31(R)
      RN=RNHHT_f31(R)
      R0HTC=R0OHHTC_f31(R)
     ...
     1         SQRT(5.393D0/2.79D0))
      ...
      FUNCTION DC6OHHTPER1_f31(R)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
      COMMON/C6TPE_f31/C6HTPE,ALP,RN,R0HTC
      COMMON/DC6TPE_f31/DC6HTE1,DR0HTC1
c     ******************************************************************
      const1=1.5D0*5.393D0
      dalp=DALPHHTPER1_f31(r)
      DR0HTC1=DR0OHHTCR1_f31(R)
      e=0.5d0/SQRT(ALP/RN)*(dalp*rn-DRNHHTR1_f31(r)*alp)/rn**2
      d=SQRT(ALP/RN)+SQRT(5.393D0/2.79D0)
      DC6HTE1=(const1*dalp*d-const1*alp*e)/d**2
      DC6OHHTPER1_f31=DC6HTE1


      RETURN
      END

      FUNCTION C8OHHTPE_f31(R)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
      COMMON/C6TPE_f31/C6HTPE,ALP,RN,R0HTC
c     ******************************************************************
      C8OHHTPE_f31=1.0D0*C6HTPE*R0HTC**(1.57243D0)
      RETURN
      END

      FUNCTION DC8OHHTPER1_f31(R)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
      COMMON/C6TPE_f31/C6HTPE,ALP,RN,R0HTC
      COMMON/DC6TPE_f31/DC6HTE1,DR0HTC1
c     ******************************************************************
      DC8OHHTPER1_f31=DC6HTE1*R0HTC**(1.57243D0)+1.57243D0*
     1      R0HTC**(1.57243D0-1.0D0)*DR0HTC1*C6HTPE
      RETURN
      END

      FUNCTION C10OHHTPE_f31(R)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
      COMMON/C6TPE_f31/C6HTPE,ALP,RN,R0HTC
c     ******************************************************************
      C10OHHTPE_f31=1.13178D0*C6HTPE*R0HTC**(1.57243D0*2.0D0)
      RETURN
      END

      FUNCTION DC10OHHTPER1_f31(R)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
      COMMON/C6TPE_f31/C6HTPE,ALP,RN,R0HTC
      COMMON/DC6TPE_f31/DC6HTE1,DR0HTC1
c     ******************************************************************
      DC10OHHTPER1_f31=1.13178D0*DC6HTE1*R0HTC**(1.57243D0*
     1     2.0D0)+(1.57243D0*2.0D0)*R0HTC**(1.57243D0*2.0D0-1.0D0)*
     1     DR0HTC1*1.13178D0*C6HTPE
      RETURN
      END

      FUNCTION C6HOHPPA_f31(R)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
c     ******************************************************************
      ALP=ALPOHPPA_f31(R)
      C6HOHPPA_f31=1.5D0*4.500D0*ALP/(SQRT(ALP/RNOHP_f31(R))+2.25D0)
      RETURN
      END

      FUNCTION DC6HOHPPARAA_f31(R)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
c     ******************************************************************
      const1=1.5D0*4.500D0
      ALP=ALPOHPPA_f31(R)
      RN=RNOHP_f31(R)
      dalp=DALPOHPPAR23_f31(r)
      d=SQRT(ALP/RN)+2.25D0
      e=0.5d0/SQRT(ALP/RN)*(dalp*rn-DRNOHPR23_f31(r)*alp)/rn**2
      DC6HOHPPARAA_f31=(const1*dalp*d-e*const1*alp)/d**2
      RETURN
      END

      FUNCTION C8HOHPPA_f31(R)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
c     ******************************************************************
      C8HOHPPA_f31=1.0D0*C6HOHPPA_f31(R)*R0HOHPC_f31(R)**(1.57243D0)
      RETURN
      END

      FUNCTION DC8HOHPPARAA_f31(R)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
c     ******************************************************************
      R0H=R0HOHPC_f31(R)
      DC8HOHPPARAA_f31=DC6HOHPPARAA_f31(R)*R0H**1.57243D0+1.57243D0*
     1      R0H**(1.57243D0-1.0D0)*DR0HOHPCR23_f31(R)*C6HOHPPA_f31(R)
      RETURN
      END

      FUNCTION C10HOHPPA_f31(R)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
c     ******************************************************************
      C10HOHPPA_f31=1.13178D0*C6HOHPPA_f31(R)*R0HOHPC10_f31(R)**(2.0D0*
     1   1.57243D0)
      RETURN
      END

      FUNCTION DC10HOHPPARaa_f31(R)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
c     ******************************************************************
      R0H=R0HOHPC10_f31(R)
      DC10HOHPPARaa_f31=1.13178D0*DC6HOHPPARAA_f31(R)*R0H**(2.0D0*
     1  1.57243D0)+2.0D0*1.57243D0*R0H**(2.0D0*1.57243D0-
     1    1.0D0)*DR0HOHPC10R23_f31(R)*1.13178D0*C6HOHPPA_f31(R)
      RETURN
      END

      FUNCTION C6HOHPPE_f31(R)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
c     ******************************************************************
      ALP=ALPOHPPE_f31(R)
      C6HOHPPE_f31=1.5D0*4.500D0*ALP/(SQRT(ALP/RNOHP_f31(R))
     1           +2.25D0)
      RETURN
      END

      FUNCTION DC6HOHPPERAA_f31(R)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
c     ******************************************************************
      const1=1.5D0*4.500D0
      ALP=ALPOHPPE_f31(R)
      RNO=RNOHP_f31(R)
      dalp=DALPOHPPER23_f31(r)
      d=SQRT(ALP/RNO)+2.25D0
      e=0.5d0/SQRT(ALP/RNO)*(dalp*rno-DRNOHPR23_f31(r)*alp)/rno**2
      DC6HOHPPERAA_f31=(const1*dalp*d-e*const1*alp)/d**2
      RETURN
      END

      FUNCTION C8HOHPPE_f31(R)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
c     ******************************************************************
      C8HOHPPE_f31=1.0D0*C6HOHPPE_f31(R)*R0HOHPC_f31(R)**(1.57243D0)
      RETURN
      END

      FUNCTION DC8HOHPPERAA_f31(R)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
c     ******************************************************************
      R0H=R0HOHPC_f31(R)
      DC8HOHPPERAA_f31=DC6HOHPPERAA_f31(R)*R0H**1.57243D0+1.57243D0*
     1      R0H**(1.57243D0-1.0D0)*DR0HOHPCR23_f31(R)*C6HOHPPE_f31(R)
      RETURN
      END


      FUNCTION C10HOHPPE_f31(R)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
c     ******************************************************************
      C10HOHPPE_f31=1.13178d0*C6HOHPPE_f31(R)*
     1  R0HOHPC10_f31(R)**(1.57243D0*2.0D0)
      RETURN
      END

      FUNCTION DC10HOHPPERAA_f31(R)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
c     ******************************************************************
      R0H=R0HOHPC10_f31(R)
      DC10HOHPPERAA_f31=1.13178D0*DC6HOHPPERAA_f31(R)*R0H**(2.0D0*
     1  1.57243D0)+2.0D0*1.57243D0*R0H**(2.0D0*1.57243D0-
     1    1.0D0)*DR0HOHPC10R23_f31(R)*1.13178D0*C6HOHPPE_f31(R)
      RETURN
      END

      FUNCTION RNOHP_f31(R)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
c     ******************************************************************
      Ainf=3.52d0
      ...
      b=0.584820271D0
      c=0.584820271D0/1.04D0
      RNOHP_f31=ainf+(a+b*(R-re))*exp(-c*(R-re))
      RETURN
      END

      FUNCTION DRNOHPR23_f31(R)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
c     ******************************************************************
      Ainf=3.52d0
      ...
      b=0.584820271D0
      c=0.584820271D0/1.04D0
      DRNOHPR23_f31=b*exp(-c*(R-re))-c*(a+b*(R-re))*exp(-c*(R-re))
      RETURN
      END

      FUNCTION RNHHT_f31(R)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
c     ******************************************************************
      c=0.60634691d0
      ...
      re=1.449d0
      a=-0.1478d0
      RNHHT_f31=ainf+a*exp(-c*(R-re))
      RETURN
      END

      FUNCTION DRNHHTR1_f31(R)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
c     ******************************************************************
      c=0.60634691d0
      ...
      re=1.449d0
      a=-0.1478d0
      DRNHHTR1_f31=-a*C*exp(-c*(R-re))
      RETURN
      END

      FUNCTION ALPHHTPA_f31(R)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
...
c     ******************************************************************
      ALPHHTPA_f31=Ainf1+(C1+C2*r)*EXP(-C3*r-C4*r**2
     1    -C5*r**3)+(1-EXP(-C6*r**5))*C7/r**3
     2     +(1-EXP(-C8*r**8))*C9/r**6
      RETURN
      END

      FUNCTION DALPHHTPAR1_f31(R)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
      DATA AINF1,C1,C2,C3,C4,C5,C6,C7,C8,C9/9.0D0,9.2091036d0,
     1     3.7378246d3,4.93109d0,-7.2538212d0,4.267343d0,3.8970194d-2,
...
c     ******************************************************************
      ...
      RR7=RR6*R
      RR8=RR7*R
      DALPHHTPAR1_f31=C2*EXP(-C3*r-C4*RR2-C5*RR3)+(C1+C2*R)*
     1     (-C3-2.0D0*C4
...
c     ******************************************************************
      ALPHHTPE_f31=Ainf1+(C1+C2*r)*EXP(-C3*r-C4*r**2
     1    -C5*r**3)+(1-EXP(-C6*r**5))*C7/r**3
      RETURN
      END

      FUNCTION DALPHHTPER1_f31(R)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
      DATA AINF1,C1,C2,C3,C4,C5,C6,C7/9.0D0,9.2090967d0,7.7638102d1,
     1 1.6964103d0,4.3441020d-9,2.7534699d-1,4.7725385d-3,-5.8164722d1/
c     ******************************************************************
      ...
      RR4=RR3*R
      RR5=RR4*R
      DALPHHTPER1_f31=C2*EXP(-C3*r-C4*RR2-C5*RR3)+(C1+C2*r)*(-C3-2.0D0
     1     *C4
...
c     ******************************************************************
      ...
      rr3=rr2*r
      rr5=rr2*rr3
      ALPOHPPA_f31=Ainf1+(Azero+C1*r+C2*rr2+C3*rr3)*
     1  EXP(-C4*r-C5*rr2-C6*rr3)+(1-EXP(-C7*rr5))*C8/rr3
      RETURN
      END

      FUNCTION DALPOHPPAR23_f31(R)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
      DATA AINF1,C1,C2,C3,C4,C5,C6,C7,C8/9.3381D0,5.2957323d0,-1.36948
     1  90d0,1.1344069d-1,-7.3074372d-1,-2.8938141d-1,7.298064d-2,4.27
...
c     ******************************************************************
      ...
      rr4=rr3*r
      rr5=rr4*r
      DALPOHPPAR23_f31=(C1+2.0D0*C2*R+3.0D0*C3*RR2)*
...
c     ******************************************************************
      Azero=ainf1-3.5396940d0
      ALPOHPPE_f31=Ainf1-Azero*EXP(-C1*r-C2*r**2-C3*r**3)+
     1  (1-EXP(-C4*r**5))
     1                           *C5/r**3
      RETURN
      END

      FUNCTION DALPOHPPER23_f31(R)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
      DATA AINF1,C1,C2,C3,C4,C5/9.6061296d0,4.8648692d-1,-1.3199234d-1,
     1  4.2427009d-2,2.1725130d-4,-2.5535932d1/
c     ******************************************************************
      ...
      rr4=rr3*r
      rr5=rr4*r
      DALPOHPPER23_f31=Azero*(C1+2.0D0*C2*r+3.0D0*C3*RR2)*
     1         EXP(-C1*r-C2*RR2
     1         -C3*RR3)-3.0D0*c5/RR4+3.0D0*C5/RR4*EXP(-C4*RR5)
     1         +5.0D0*C4*C5*R*EXP(-C4*RR5)
      RETURN
...
c     ******************************************************************
      ...
      c=0.60634691d0
      fcorr=finf+d*exp(-c*r)
      R0OHHTC_f31=2.0d0*((ALPHHTPE_f31(R)**(1.0d0/3.0d0))+
     1        sqrt(2.003423d0))
     1        *fcorr
      RETURN
      END

      FUNCTION DR0OHHTCR1_f31(R)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
c     ******************************************************************
      finf=6.334299622d0/6.9898852d0
      ...
      fcorr=finf+d*exp(-c*r)
      ALP=ALPHHTPE_f31(R)
      DR0OHHTCR1_f31=2.0D0/3.0D0*DALPHHTPER1_f31(R)*ALP**(-2.0d0/3.0d0)*
     1       FCORR-2.0D0*D*C*exp(-c*r)*(ALP**(1.0d0/3.0d0)+
     1       sqrt(2.003423d0))
      RETURN
      END

      FUNCTION R0HOHPC_f31(R)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
c     ******************************************************************
      alpham=(1.0d0/3.0d0)*ALPOHPPA_f31(R)+(2.0d0/3.0d0)*ALPOHPPE_f31(R)
      finf=6.390259718d0/7.7028477d0
      fzero=5.950512078d0/6.4733336d0
      d=fzero-finf
      c=0.584820271D0/1.04D0
      fcorr=finf+d*exp(-c*r)
      R0HOHPC_f31=2.0d0*((alpham**(1.0d0/3.0d0))+(6.9282d0/4.0d0))*fcorr
      RETURN
      END

      FUNCTION DR0HOHPCR23_f31(R)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
c     ******************************************************************
      alpham=1.0d0/3.0d0*ALPOHPPA_f31(R)+2.0d0/3.0d0*ALPOHPPE_f31(R)
      DALPHAM=1.0d0/3.0d0*DALPOHPPAR23_f31(R)+2.0d0/3.0d0*
     2 DALPOHPPER23_f31(R)
      finf=6.390259718d0/7.7028477d0
      fzero=5.950512078d0/6.4733336d0
      d=fzero-finf
      c=0.584820271D0/1.04D0
      fcorr=finf+d*exp(-c*r)
      DR0HOHPCR23_f31=2.0d0/3.0D0*alpham**(-2.0d0/3.0d0)*DALPHAM*fcorr-
     1    2.0D0*c*d*exp(-c*r)*(alpham**(1.0d0/3.0d0)+6.9282d0/4.0d0)
      RETURN
      END

      FUNCTION R0HOHPC10_f31(R)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
c     ******************************************************************
      ALPHAM=(1.0D0/3.0D0)*ALPOHPPA_f31(R)+(2.0D0/3.0D0)*ALPOHPPE_f31(R)
      ...
      c=0.584820271D0/1.04D0
      FCORR=finf+d*exp(-c*r)
      R0HOHPC10_f31=2.0d0*((ALPHAM**(1.0D0/3.0D0))+
     1  (6.9282D0/4.0D0))*FCORR
      RETURN
      END

      FUNCTION DR0HOHPC10R23_f31(R)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
c     ******************************************************************
      ALPHAM=(1.0D0/3.0D0)*ALPOHPPA_f31(R)+(2.0D0/3.0D0)*ALPOHPPE_f31(R)
      DALPHAM=1.0d0/3.0d0*DALPOHPPAR23_f31(R)+2.0d0/3.0d0*
     1 DALPOHPPER23_f31(R)
      finf=6.574599892d0/7.7028477d0
      fzero=5.950512078d0/6.4733336d0
      d=fzero-finf
      c=0.584820271D0/1.04D0
      FCORR=finf+d*exp(-c*r)
      DR0HOHPC10R23_f31=2.0d0/(3.0D0*alpham**(2.0d0/3.0d0))*
     1    DALPHAM*fcorr
     1    -2.0D0*c*d*(alpham**(1.0d0/3.0d0)+(6.9282d0/4.0d0))*exp(-c*r)
      RETURN
      END

      FUNCTION FDOHP_f31(R)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
...
c     ******************************************************************
      ...
      rr3=rr2*r
      rr5=rr3*rr2
      FDOHP_f31=(an+C1*R+C2*RR2+C3*RR3)*EXP(-c4*R-C5*RR2)+(1-EXP(-C6*
     2   RR5))*C7/RR3
      return
      end

      FUNCTION DFDOHPR23_f31(R)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
      DATA C1,C2,C3,C4,C5,C6,C7/1.1014506E+00,-9.2434425E-01,3.471174
     1     2E-01,-3.6259720E-01,3.6732452E-01,6.8313966E-03,2.392610
...
c     ******************************************************************
      ...
      rr4=rr3*r
      rr5=rr4*r
      DFDOHPR23_f31=(C1+2.0D0*C2*R+3.0D0*C3*RR2)*EXP(-C4*R-C5*RR2)-(C4+
     ...
     1         C7/RR4*EXP(-C6*RR5)
      ...
      FUNCTION VINDHOHP_f31(r1,r2,r3)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
      COMMON/AN_f31/A(20)
      COMMON/BN_f31/B(20)
     ...
     1    C8AB2,C10AB2
c     ******************************************************************
      VINDHOHP_f31=-FDOHP_f31(R2)**2*4.5D0*(3.0D0*COST2**2+1.0D0)*
     1          DAMPHOHP26/(2.0D0*rG26)
     1         -FDOHP_f31(R3)**2*4.5D0*(3.0D0*COST3**2+1.0D0)*
     1          DAMPHOHP36/(2.0D0*rG36)
      return
      end

      FUNCTION DVINDHOHPR1_f31(r1,r2,r3)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
      COMMON/AN_f31/A(20)
      COMMON/BN_f31/B(20)
...
c     ******************************************************************
      ...
      FDOHPR2=FDOHP_f31(R2)
      FDOHPR3=FDOHP_f31(R3)
      TA1=-4.5D0*FDOHPR2**2
      TA2=-4.5D0*FDOHPR3**2
      xa=TA1*TA
      xa1=TA2*TB
      DVINDHOHPR1_f31=xb*(-4.5d0*2.0d0*FDOHPR2*DFDOHPR1*Ta+dTar1*TA1)
     1 +xa*(DDAMPHOHPR1_f31(Rg2,6,r2,DRG2R1)*2.0D0*RG26
     1 -12.0D0*RG25*DRG2R1*DAMPHOHP26)/(4.0D0*RG212)
     1         +xb1*(-4.5d0*2.0d0*FDOHPR3*DFDOHPR1*TB+dTBr1*TA2)
     1 +Xa1*(DDAMPHOHPR1_f31(Rg3,6,r3,DRG3R1)*2.0D0*RG36
     1 -12.0D0*RG35*DRG3R1*DAMPHOHP36)/(4.0D0*RG312)
      return
      end

      FUNCTION DVINDHOHPR2_f31(r1,r2,r3)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
      COMMON/AN_f31/A(20)
      COMMON/BN_f31/B(20)
...
c     ******************************************************************
      ...
      xa1=TA2*TB
      DFDOHPR23R3=0.0D0
      DVINDHOHPR2_f31=xb*(-4.5d0*2.0d0*FDOHPR2*DFDOHPR23_f31(R2)*
     1 Ta+dTar2
     1 *TA1)+xa*(DDAMPHOHPRAA_f31(Rg2,6,r2,DRG2R2)*2.0D0*RG26
     1 -12.0D0*RG25*DRG2R2*DAMPHOHP26)/(4.0D0*RG212)
     1      +xb1*(-4.5d0*2.0d0*FDOHPR3*DFDOHPR23R3*TB+dTBr2*TA2)
     1 +Xa1*(DDAMPHOHPRAB_f31(Rg3,6,r3,DRG3R2)*2.0D0*RG36
     1 -12.0D0*RG35*DRG3R2*DAMPHOHP36)/(4.0D0*RG312)
      return
      end

      FUNCTION DVINDHOHPR3_f31(r1,r2,r3)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
      COMMON/AN_f31/A(20)
      COMMON/BN_f31/B(20)
...
c     ******************************************************************
      ...
      xa1=TA2*TB
      DFDOHPR23R2=0.0D0
      DVINDHOHPR3_f31=xb*(-4.5d0*2.0d0*FDOHPR2*DFDOHPR23R2*Ta+dTar3
     1 *TA1)+xa*(DDAMPHOHPRAB_f31(Rg2,6,r2,DRG2R3)*2.0D0*RG26
     1 -12.0D0*RG25*DRG2R3*DAMPHOHP26)/(4.0D0*RG212)
     1    +xb1*(-4.5d0*2.0d0*FDOHPR3*DFDOHPR23_f31(R3)*TB+dTBr3*TA2)
     1 +Xa1*(DDAMPHOHPRAA_f31(Rg3,6,r3,DRG3R3)*2.0D0*RG36
     1 -12.0D0*RG35*DRG3R3*DAMPHOHP36)/(4.0D0*RG312)
      return
      end

      FUNCTION FQHHT_f31(R)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
      DATA C1,C2,C3,C4/1.9930192E-02,6.0772551E-01,1.2408772E-02,-2.553
     1                 2637E+01/
c     ******************************************************************
      FQHHT_f31=-12.0d0*EXP(-C1*r-C2*r**2)+(1-EXP(-C3*r**5))*C4/r**3
      return
      end

      FUNCTION DFQHHTR1_f31(R)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
      DATA C1,C2,C3,C4/1.9930192E-02,6.0772551E-01,1.2408772E-02,-2.553
     1                 2637E+01/
c     ******************************************************************
      ...
      RR4=RR2*RR2
      RR5=RR3*RR2
      DFQHHTR1_f31=12.0D0*(C1+2.0D0*C2*R)*EXP(-C1*r-C2*RR2)-3.0D0*C4/RR4
     1       +3.0D0*C4/RR4*EXP(-C3*RR5)+5.0D0*C4*C3*R*EXP(-C3*RR5)
      return
      end

      FUNCTION VEOHHT_f31(r1,r2,r3)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
      COMMON/AN_f31/A(20)
      COMMON/BN_f31/B(20)
...
c     ******************************************************************
      at=b0+b2*cos2t1+b4*cos4t1+b6*cos6t1
      VEOHHT_f31=0.75d0*FQHHT_f31(R1)*(-0.992148212d0)*at*DAMPOHHT5
      return
      end

      FUNCTION DVEOHHTR1_f31(r1,r2,r3)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
      COMMON/AN_f31/A(20)
      COMMON/BN_f31/B(20)
...
c     ******************************************************************
      ...
      FQHHTR1=FQHHT_f31(R1)
      DVEOHHTR1_f31=(DFQHHTR1_f31(R1)*AT+DATR1*FQHHTR1)*
     1     CONST2*DAMPOHHT5+
     1     (DDAMPOHHTR1_f31(Rg1,5,r1,drg1r1)*rg15-5.0D0*DRG1R1*
     1     RG14*DAMPOHHT5*RG15)/(rg110)*at*CONST2*FQHHTR1
      return
      end

      FUNCTION DVEOHHTR2_f31(r1,r2,r3)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
      COMMON/AN_f31/A(20)
      COMMON/BN_f31/B(20)
...
c     ******************************************************************
      ...
      DFQHHTR2=0.0D0
      FQHHTR1=FQHHT_f31(R1)
      DVEOHHTR2_f31=(DFQHHTR2*AT+DATR2*FQHHTR1)*CONST2*DAMPOHHT5+
     1       (DDAMPOHHTR2_f31(Rg1,5,r1,DRG1R2)*rg15-5.0D0*DRG1R2*
     1        RG14*DAMPOHHT5*Rg15)/(rg110)*at*CONST2*FQHHTR1
      return
      end

      FUNCTION DVEOHHTR3_f31(r1,r2,r3)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
      COMMON/AN_f31/A(20)
      COMMON/BN_f31/B(20)
      DATA b0,b2,b4,b6/-3.68666806d0,-0.0391352778d0,-0.277479722d0,
     1                 0.0402558333d0/
      COMMON/cved_f31/COSB,COSC,RG1,
     1  RG2,RG3,COST1,COST2,COST3,FAB,
     1  FAC,FBC,
     1  FABC,FCAB,FBAC,CONST,RG14,RG15,RG16,RG17,RG18,RG19,RG110,
     1  RG112,RG116,RG120,RG25,RG26,RG27,RG28,RG29,RG210,RG212,
     1  RG216,RG220,RG35,RG36,RG37,RG38,RG39,RG310,RG312,RG316,
...
c     ******************************************************************
      ...
      DFQHHTR3=0.0D0
      FQHHTR1=FQHHT_f31(R1)
      DVEOHHTR3_f31=(DFQHHTR3*AT+DATR3*FQHHTR1)*CONST2*DAMPOHHT5+
     1    (DDAMPOHHTR3_f31(Rg1,5,r1,DRG1R3)*rg15-5.0D0*DRG1R3*
     1    RG14*DAMPOHHT5*RG15)/(rg110)*at*CONST2*FQHHTR1
      return
      end

      FUNCTION rl2_f31(r1E,r2E,r3E)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
c     ******************************************************************
      R1=R1E+1.0D-8
...
c    ***************************************************************
      ...
      rl2_f31=VED32_f31(r1,r2,r3)+VEOHHT_f31(r1,r2,r3)+
     1 VINDHOHP_f31(r1,r2,r3)
      return
      end

      SUBROUTINE drl2_f31(R1E,R2E,R3E,DER1,DER2,DER3)
c     ******************************************************************
c     TO COMPUTE THE DERIVATIVES OF THE LONG RANGE TERM
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
...
c    ***************************************************************
      ...
      DER1=DVED32R1_f31(r1,r2,r3)+DVEOHHTR1_f31(r1,r2,r3)+
     1  DVINDHOHPR1_f31(r1,r2,r3)


      DER2=dved32r2_f31(r1,r2,r3)+DVEOHHTR2_f31(r1,r2,r3)+
     1  DVINDHOHPR2_f31(r1,r2,r3)

      DER3=dved32r3_f31(r1,r2,r3)+DVEOHHTR3_f31(r1,r2,r3)+
     1  DVINDHOHPR3_f31(r1,r2,r3)
      RETURN
      END

      SUBROUTINE CODISP_f31(R0,C6,C8,C10)
c    **************************************************************
...
c    **************************************************************
      ...
      FUNCTION GOH1_f31(R,N)
c    **************************************************************
c     TO COMPUTE THE VARIATION OF POLARIZATION OF OH - SURFACE1
c    **************************************************************
      IMPLICIT DOUBLE PRECISION(A-H,O-Z)
      COMMON/RKVAL1_f31/RK0HH1(10),RK1HH1(10),RK0OH1(10),RK1OH1(10)
      COMMON/EXPVAL_f31/EXPHHS,EXPHHT,EXPOHP,EXPOHS
      COMMON/DIATDI_f31/R0HH,RMHHS,RMHHT,R0OHP,R0OHS,RMOHP,RMOHS,VO1D
c    **************************************************************
      GOH1_f31=1.0D0+RK0OH1(N)*(1.0D0+RK1OH1(N)*(R-RMOHS))*
     1     EXP(-EXPOHS*(R-RMOHS))
      RETURN
      END

      FUNCTION DGOH1_f31(R,N)
c    **************************************************************
c     TO COMPUTE THE DER VARIATION OF POLARIZATION OF OH - SURFACE 1
c    **************************************************************
      IMPLICIT DOUBLE PRECISION(A-H,O-Z)
      COMMON/RKVAL1_f31/RK0HH1(10),RK1HH1(10),RK0OH1(10),RK1OH1(10)
      COMMON/EXPVAL_f31/EXPHHS,EXPHHT,EXPOHP,EXPOHS
...
c    **************************************************************
      RK1OH1N=RK1OH1(N)
      DGOH1_f31=RK0OH1(N)*(RK1OH1N-EXPOHS*(1.0D0+RK1OH1N*(R-RMOHS)))*
     1     EXP(-EXPOHS*(R-RMOHS))
      RETURN
      END

      FUNCTION GHH1_f31(R,N)
c    **************************************************************
c     TO COMPUTE THE VARIATION OF POLARIZATION OF HH - SURFACE1
c    **************************************************************
      IMPLICIT DOUBLE PRECISION(A-H,O-Z)
      COMMON/RKVAL1_f31/RK0HH1(10),RK1HH1(10),RK0OH1(10),RK1OH1(10)
      COMMON/EXPVAL_f31/EXPHHS,EXPHHT,EXPOHP,EXPOHS
      COMMON/DIATDI_f31/R0HH,RMHHS,RMHHT,R0OHP,R0OHS,RMOHP,RMOHS,VO1D
c    **************************************************************
      GHH1_f31=1.0D0+RK0HH1(N)*(1.0D0+RK1HH1(N)*(R-RMHHS))*
     1     EXP(-EXPHHS*(R-RMHHS))
      RETURN
      END

      FUNCTION DGHH1_f31(R,N)
c    **************************************************************
c     TO COMPUTE THE DER VARIATION OF POLARIZATION OF HH - SURFACE 1
c    **************************************************************
      IMPLICIT DOUBLE PRECISION(A-H,O-Z)
      COMMON/RKVAL1_f31/RK0HH1(10),RK1HH1(10),RK0OH1(10),RK1OH1(10)
      COMMON/EXPVAL_f31/EXPHHS,EXPHHT,EXPOHP,EXPOHS
...
c    **************************************************************
      RK1HH1N=RK1HH1(N)
      DGHH1_f31=RK0HH1(N)*(RK1HH1N-EXPHHS*(1.0D0+RK1HH1N*(R-RMHHS)))
     1    *EXP(-EXPHHS*(R-RMHHS))
      RETURN
      END

      FUNCTION DISPOH_f31(R,C6,C8,C10,R0,RM)
c    **************************************************************
      IMPLICIT DOUBLE PRECISION(A-H,O-Z)
      COMMON/AN_f31/A(20)
      COMMON/BN_f31/B(20)
c    **************************************************************
      ...
      DISPOH_f31=-C6/R6*D6-C8/R8*D8-C10/R10*D10
      RETURN
      END

      FUNCTION DDISPOH_f31(R,C6,C8,C10,R0,RM)
c    **************************************************************
      IMPLICIT DOUBLE PRECISION(A-H,O-Z)
      COMMON/AN_f31/A(20)
      COMMON/BN_f31/B(20)
c    **************************************************************
      ...
      T8=1.0D0-EXP(-A(8)*RR-B(8)*RR2)
      T10=1.0D0-EXP(-A(10)*RR-B(10)*RR2)
      DDISPOH_f31=6.0D0*C6/R6*T6**5*(T6/R+(1.0D0-T6)*(-A(6)-
     1  2.0D0*B(6)*RR)*DRR)+
