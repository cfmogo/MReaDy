...
C     ******************************************************************
      FUNCTION VHO23c_f31(R1J,R2J,R3J)
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
      COMMON/THRBOD_f31/POLQ,DECAY1,DECAY2,DECAY3,R1,R2,R3
      ...
      gammar=3.0d0
      corr2=VOH_f31(r2)-vohp_f31(r2)
      corr3=VOH_f31(r3)-vohp_f31(r3)
      damp1=0.5d0*(1.0d0-tanh(gammar*(r1-5.0d0)))
      damp2=0.5d0*(1.0d0-tanh(gammar*(r2-5.0d0)))
      damp3=0.5d0*(1.0d0-tanh(gammar*(r3-5.0d0)))

      V=THREBQ_f31(Q1,Q2,Q3)+
     1  EXDIS_f31(R1,R2,R3)+ELECT_f31(R1,R2,R3)+VSPECT_f31(R1,R2,R3)
     2  +corr2*damp1*damp3+corr3*damp1*damp2


c      V=THREBQ_f31(Q1,Q2,Q3)
     
      VHO23c_f31=V
      END


      FUNCTION VSPECT_f31(r1,r2,r3)
...
C
C     ****************************************************************
      FUNCTION THREBQ_f31(Q1,Q2,Q3) 
      IMPLICIT DOUBLE PRECISION(A-H,O-Z)
      COMMON/coeffho2_f31/C(52)
      COMMON/THRBOD_f31/POLQ,DECAY1,DECAY2,DECAY3,R1,R2,R3
      COMMON/refgeoho2_f31/R10,R20,R30
     ...
     BC(48)*Q1*Q3*TQ2*TQ3+C(49)*Q32*TQ1*TQ2+C(50)*TQ12*TQ3
      ...
      THREBQ_f31=POLQ*DECAY1*DECAY2*DECAY3
...
C     ****************************************************************
      ...
      VOH_f31=EHFOH_f31(R)+DISOH_f31(R)
...
C
C     ****************************************************************
      FUNCTION EHFOH_f31(R)
      IMPLICIT DOUBLE PRECISION(A-H,O-Z)
      DIMENSION ASV(4)
      COMMON/DIATDIHO2_f31/R0OO,RMOO,R0OH,RMOH
      SAVE /DIATDIHO2_f31/,D,ASV
     ...
     1           2.5453276D0/
      ...
      R2=X*X
      R3=R2*X
      EHFOH_f31=-D*(1.0D0+ASV(1)*X+ASV(2)*R2+ASV(3)*R3)*DEXP(-ASV(4)*X)
...
C
C     ****************************************************************
      FUNCTION DISOH_f31(R)
      IMPLICIT DOUBLE PRECISION(A-H,O-Z)
      COMMON/DISPC_f31/COO(10),COH(10)
      COMMON/DIATDIHO2_f31/R0OO,RMOO,R0OH,RMOH
      SAVE /DISPC_f31/,/DIATDIHO2_f31/
      
      DISOH_f31=DISP_f31(R,COH(6),COH(8),COH(10),R0OH,RMOH)
...
C     ****************************************************************
      ...
      VOO_f31=EHFOO_f31(R)+DISOO_f31(R)
...
C     ****************************************************************
     ...
     1           3.3522498D0/
      ...
      R2=X*X
      R3=R2*X
      EHFOO_f31=-D*(1.0D0+ASV(1)*X+ASV(2)*R2+ASV(3)*R3)*DEXP(-ASV(4)*X)
...
C
C     ****************************************************************
      FUNCTION DISOO_f31(R)
      IMPLICIT DOUBLE PRECISION(A-H,O-Z)
      COMMON/DISPC_f31/COO(10),COH(10)
      COMMON/DIATDIHO2_f31/R0OO,RMOO,R0OH,RMOH
      SAVE /DISPC_f31/,/DIATDIHO2_f31/
      
      DISOO_f31=DISP_f31(R,COO(6),COO(8),COO(10),R0OO,RMOO)
...
C     ****************************************************************
      FUNCTION EXDIS_f31(R1,R2,R3)
      IMPLICIT DOUBLE PRECISION(A-H,O-Z)
      COMMON/DISPC_f31/COO(10),COH(10)
      COMMON/RKVAL_f31/RK0OO(10),RK1OO(10),RK0OH(10),RK1OH(10)
      COMMON/DISCO_f31/CEFOO(10),CEFOH2(10),
     1 CEFOH3(10),CEDOO(10),CEDOH2(10)
      COMMON/DISCO2_f31/CEDOH3(10)
      COMMON/DIATDIHO2_f31/R0OO,RMOO,R0OH,RMOH
      SAVE /DISPC_f31/,/DIATDIHO2_f31/,/RKVAL_f31/
      
      DO 10 IN=6,10,2
        CEFOO(IN)=CEF_f31(COO(IN),RK0OH(IN),RK1OH(IN),
     1            RK0OH(IN),RK1OH(IN),RMOH,RMOH,R2,R3)
        CEDOO(IN)=CEFOO(IN)-COO(IN)
        CEFOH2(IN)=CEF_f31(COH(IN),RK0OO(IN),RK1OO(IN),
     1             RK0OH(IN),RK1OH(IN),RMOO,RMOH,R1,R3)
        CEDOH2(IN)=CEFOH2(IN)-COH(IN)
        CEFOH3(IN)=CEF_f31(COH(IN),RK0OO(IN),RK1OO(IN),
     1             RK0OH(IN),RK1OH(IN),RMOO,RMOH,R1,R2)
        CEDOH3(IN)=CEFOH3(IN)-COH(IN)
   10 CONTINUE
      EXDIS_f31=DISP_f31(R1,CEDOO(6),CEDOO(8),CEDOO(10),R0OO,RMOO)
     1     +DISP_f31(R2,CEDOH2(6),CEDOH2(8),CEDOH2(10),R0OH,RMOH)
     2     +DISP_f31(R3,CEDOH3(6),CEDOH3(8),CEDOH3(10),R0OH,RMOH)
...
C     ****************************************************************
      FUNCTION CEF_f31(CAS,RK01,RK11,RK02,RK12,RE1,RE2,R1,R2)
      IMPLICIT DOUBLE PRECISION(A-H,O-Z)
      
      CEF_f31=0.5D0*CAS*((1.0D0-RK01*DEXP(-RK11*(R1-RE1)))*
     1  DTANH(RK12*R2)+
...
C     ****************************************************************
      FUNCTION ELECT_f31(R1,R2,R3)
      IMPLICIT DOUBLE PRECISION(A-H,O-Z)
      COMMON/POLAR_f31/C4,C5
      COMMON/RKVAL_f31/RK0OO(10),RK1OO(10),RK0OH(10),RK1OH(10)
      COMMON/DIATDIHO2_f31/R0OO,RMOO,R0OH,RMOH
      COMMON/DAMPC_f31/ADAMP(10),BDAMP(10)
      COMMON/WELECT_f31/C4OHR2,C5OHR2,C4OHR3,C5OHR3,C4OO,
     1 C5OO,TERM4,TERM5
      SAVE /DIATDIHO2_f31/,/RKVAL_f31/,/POLAR_f31/,/DAMPC_f31/
     ...
     2 C5OHR3/R35*(1.0D0-DEXP(-ADAMP(5)*RROH3-BDAMP(5)*RROH3**2))**5
      ELECT_f31=TERM4+TERM5

      END

      
C     ***************************************************************      
      FUNCTION DISP_f31(R,C6,C8,C10,R0,RM)
      IMPLICIT DOUBLE PRECISION(A-H,O-Z)
      COMMON/DAMPC_f31/ADAMP(10),BDAMP(10)
      SAVE /DAMPC_f31/
      ...
      DISP_f31=-C6/R6*D6-C8/R8*D8-C10/R10*D10
...
C     LA SUPERFICIE CALCULADA CON BOO=BOH=1.55
      ...
      COMMON/DAMPC_f31/ADAMP(10),BDAMP(10)
      COMMON/refgeoho2_f31/R10,R20,R30
      SAVE /coeffho2_f31/,/DISPC_f31/,/DIATDIHO2_f31/,
     1 /RKVAL_f31/,/POLAR_f31/,/DAMPC_f31/,
     1 /refgeoho2_f31/
...
c     It needs the function THREBQ_f31(Q1,Q2,Q3) and the BLOCK DATA HO2DAT
c    ********************************************************************




      SUBROUTINE DERVHO2_f31(r1j,r2j,r3j,dg1,dg2,dg3)
c    **************************************************************
...
C    **************************************************************
     ...
     F   C(49)*Q32*DTQ*(TQ1+TQ2)+C(50)*DTQ*(2.0D0*TQ1*TQ3-TQ12)
      CALL  DEREXDIS_f31(X(1),X(2),X(3),DER1,DER2,DER3)
      CALL  DERELECT_f31(X(1),X(2),X(3),DERI1,DERI2,DERI3)
      CALL  DERVSPECT_f31(X(1),X(2),X(3),DERV1,DERV2,DERV3)
      G(1)=((DPOQ1*DQ1R1+DPOQ2*DQ2R1+DPOQ3*DQ3R1)*DECAY1-POLQ*C(51)/
     1   COSH(C(51)*S1)**2)*DECAY2*DECAY3+DVOO_f31(X(1))+
     1   DER1+DERI1+DERV1
      G(2)=((DPOQ1*DQ1R2+DPOQ2*DQ2R2+DPOQ3*DQ3R2)*DECAY2-POLQ*C(52)/
     1   COSH(C(52)*S2)**2)*DECAY1*DECAY3+DVOH_f31(X(2))+
     1   DER2+DERI2+DERV2
      G(3)=((DPOQ1*DQ1R3+DPOQ2*DQ2R3+DPOQ3*DQ3R3)*DECAY3-POLQ*C(52)/
     1   COSH(C(52)*S3)**2)*DECAY1*DECAY2+DVOH_f31(X(3))+
     1   DER3+DERI3+DERV3
      ...
      SUBROUTINE DERVHO23c_f31(r1j,r2j,r3j,dg1,dg2,dg3)
c    **************************************************************
C     TO COMPUTE THE DERIVATIVE H2O SURFACE in atomic units
C    **************************************************************
      IMPLICIT DOUBLE PRECISION(A-H,O-Z)
...
c     1   COSH(C(52)*S3)**2)*DECAY1*DECAY2
      ...
      SUBROUTINE DERVSPECT_f31(R1,R2,R3,DERV1,DERV2,DERV3)
C     ****************************************************************
C
...
C     ****************************************************************
      ...
      DATA D,ASV/0.13825385D0,2.6564788D0,1.7450528D0,0.71014391D0,
     1           2.5453276D0/
      SAVE /DISPC_f31/,/DIATDIHO2_f31/,D,ASV
      ...
      POT=EXP(-ASV(4)*X)
      DVOH_f31=-ASV(4)*POT*POL+DPOL*POT+
     1   DDISP_f31(R,COH(6),COH(8),COH(10),
     1   R0OH,RMOH)
...
C     ****************************************************************
     ...
     1           3.3522498D0/
      ...
      DPOL=-D*(ASV(1)+2.0D0*ASV(2)*X+3.0D0*ASV(3)*R2)
      POT=EXP(-ASV(4)*X)
      DVOO_f31=-ASV(4)*POT*POL+DPOL*POT+
     1   DDISP_f31(R,COO(6),COO(8),COO(10),
     1   R0OO,RMOO)
...
C     ****************************************************************
      SUBROUTINE DEREXDIS_f31(R1,R2,R3,DER1,DER2,DER3)
      IMPLICIT DOUBLE PRECISION(A-H,O-Z)
      COMMON/DISPC_f31/COO(10),COH(10)
      COMMON/RKVAL_f31/RK0OO(10),RK1OO(10),RK0OH(10),RK1OH(10)
      COMMON/DISCO_f31/CEFOO(10),CEFOH2(10),
   ...
   10 CONTINUE
      ...
      CALL DCEF_f31(COO(6),RK0OH(6),RK1OH(6),RK0OH(6),RK1OH(6),RMOH,
     1     RMOH,R2,R3,DC61R2,DC61R3)
      CALL DCEF_f31(COO(8),RK0OH(8),RK1OH(8),RK0OH(8),RK1OH(8),RMOH,
     1     RMOH,R2,R3,DC81R2,DC81R3)
      CALL DCEF_f31(COO(10),RK0OH(10),RK1OH(10),RK0OH(10),
     1     RK1OH(10),RMOH,RMOH,R2,R3,D101R2,D101R3)
      CALL DCEF_f31(COH(6),RK0OO(6),RK1OO(6),RK0OH(6),RK1OH(6),RMOO,
     1     RMOH,R1,R3,DC62R1,DC62R3)
      CALL DCEF_f31(COH(8),RK0OO(8),RK1OO(8),RK0OH(8),RK1OH(8),RMOO,
     1     RMOH,R1,R3,DC82R1,DC82R3)
      CALL DCEF_f31(COH(10),RK0OO(10),RK1OO(10),RK0OH(10),
     1     RK1OH(10),RMOO, RMOH,R1,R3,D102R1,D102R3)
      CALL DCEF_f31(COH(6),RK0OO(6),RK1OO(6),RK0OH(6),RK1OH(6),RMOO,
     1     RMOH,R1,R2,DC63R1,DC63R2)
      CALL DCEF_f31(COH(8),RK0OO(8),RK1OO(8),RK0OH(8),RK1OH(8),RMOO,
     1     RMOH,R1,R2,DC83R1,DC83R2)
      CALL DCEF_f31(COH(10),RK0OO(10),RK1OO(10),RK0OH(10),
     1     RK1OH(10),RMOO,RMOH,R1,R2,D103R1,D103R2)
      DER1=DDISP_f31(R1,CEDOO(6),CEDOO(8),CEDOO(10),
     1     R0OO,RMOO)-DC62R1*
     1     T6R2-DC63R1*T6R3-DC82R1*T8R2-DC83R1*T8R3-D102R1*T10R2-
     2     D103R1*T10R3
      DER2=DDISP_f31(R2,CEDOH2(6),CEDOH2(8),CEDOH2(10),
     1     R0OH,RMOH)-DC61R2*
     1     T6R1-DC63R2*T6R3-DC81R2*T8R1-DC83R2*T8R3-D101R2*T10R1-
     2     D103R2*T10R3
      DER3=DDISP_f31(R3,CEDOH3(6),CEDOH3(8),CEDOH3(10),R0OH,
     1     RMOH)-DC61R3*
...
C     ****************************************************************
      SUBROUTINE DCEF_f31(CAS,RK01,RK11,RK02,RK12,RE1,RE2,
     1 R1,R2,DCR1,DCR2)
      IMPLICIT DOUBLE PRECISION(A-H,O-Z)
...
C     ****************************************************************
      SUBROUTINE DERELECT_f31(R1,R2,R3,DER1,DER2,DER3)
      IMPLICIT DOUBLE PRECISION(A-H,O-Z)
      COMMON/POLAR_f31/C4,C5
      COMMON/RKVAL_f31/RK0OO(10),RK1OO(10),RK0OH(10),RK1OH(10)
      COMMON/DIATDIHO2_f31/R0OO,RMOO,R0OH,RMOH
...
C     RR3D3=(R2-R1)/R3**2
     ...
     1     +DC43R3*T4R3+DC53R3*T5R3
      ...
      FUNCTION DDISP_f31(R,C6,C8,C10,R0,RM)
      IMPLICIT DOUBLE PRECISION(A-H,O-Z)
      COMMON/DAMPC_f31/ADAMP(10),BDAMP(10)
      SAVE /DAMPC_f31/
      ...
      DDISP_f31=6.0D0*C6/R6*T6**5*(T6/R+(1.0D0-T6)*
