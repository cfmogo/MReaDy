      ...
      Function vh2ot3c_10(r1,r2,r3)
c    **************************************************************
C     TO COMPUTE THE H2O SURFACE - Sx in atomic units
C    **************************************************************
      IMPLICIT DOUBLE PRECISION(A-H,O-Z)     
C    **************************************************************
      COMMON/DIATDIT_10/R0HH,RMHHS,R0OHP,RMOHP
C    **************************************************************
  
      
c      DIAT=VHHST_10(r1)+VOHPT_10(r2)+VOHPT_10(r3)
c      F=THREBR_10(r1,r2,r3)+RL_10(r1,r2,r3)+DIAT
     
      F=THREBR_10(r1,r2,r3)+RL_10(r1,r2,r3)
      
      vh2ot3c_10=F
      RETURN
      END
      
      SUBROUTINE DERVH2OT_10(r1,r2,r3,g1,g2,g3)
c    **************************************************************
...
c      endif
      ...
      F=VHHST_10(r1)+VOHPT_10(r2)+VOHPT_10(r3)+
     1  THREBR_10(r1,r2,r3)+RL_10(r1,r2,r3)
                 
      CALL DTHREBR_10(r1,r2,r3,DTDR1,DTDR2,DTDR3)

      CALL DRL_10(r1,r2,r3,DER1,DER2,DER3)
            
      G1=DTDR1+DER1+DVHHST_10(r1)	  
      G2=DTDR2+DER2+DVOHPT_10(r2)	  
      G3=DTDR3+DER3+DVOHPT_10(r3)
     
      RETURN
      END
      
       SUBROUTINE DERVH2OT3c_10(r1,r2,r3,g1,g2,g3)
c    **************************************************************
C     TO COMPUTE THE DERIVATIVE H2O SURFACE - Sx in atomic units
C    **************************************************************
      IMPLICIT DOUBLE PRECISION(A-H,O-Z)     
...
C    **************************************************************
      IMPLICIT DOUBLE PRECISION(A-H,O-Z)
c    **************************************************************
      VOHPT_10=EHFOHPT_10(R)+DISOHPT_10(R)
      RETURN
      END

      FUNCTION EHFOHPT_10(R)
c    **************************************************************
...
c    **************************************************************
      ...
      FUNCTION DISOHPT_10(R)
c    **************************************************************
C     TO COMPUTE THE DISPERSION FOR  O...H
C    **************************************************************
      IMPLICIT DOUBLE PRECISION(A-H,O-Z)
      COMMON/DISPC1T_10/CHH(16),COHP(10)
      COMMON/DIATDIT_10/R0HH,RMHHS,R0OHP,RMOHP
c    **************************************************************
      DISOHPT_10=DISPOHT_10(R,COHP(6),COHP(8),COHP(10),R0OHP,RMOHP)
      RETURN
      END

      FUNCTION DVOHPT_10(R)
c    **************************************************************
...
c     Dispersao
      ...
      DERDISP=DDISPOHT_10(R,COHP(6),COHP(8),COHP(10),R0OHP,RMOHP)
      
c     Total
         
      DVOHPT_10=DEHF+DEX+DERDISP
...
C    **************************************************************
      IMPLICIT DOUBLE PRECISION(A-H,O-Z)
c    **************************************************************
      VHHST_10=EHFHHST_10(R)+DISHHST_10(R)
      RETURN
      END

      FUNCTION EHFHHST_10(R)
c    **************************************************************
...
c    **************************************************************
      ...
      EHFHHST_10=POL*EXP(-Gama*X)
      RHO=(RMHHS+2.5D0*R0HH)/2.0d0
      RR=R/RHO
      D6=(1.0D0-EXP(-A(6)*RR-B(6)*RR**2))**6  
      EXCHHS=-AGEX*R**ALPHEX*EXP(-GAMEX*R)*D6
      EHFHHST_10=EHFHHST_10+EXCHHS
      RETURN
      END

      FUNCTION DISHHST_10(R)
c    **************************************************************
...
c    **************************************************************
      ...
      R6=R2*R2*R2
      R8=R6*R2
      ADISP=-CHH(6)*DAMPHHTTRIP_10(6,R)/R6-CHH(8)*DAMPHHTTRIP_10(8,R)/R8
      DO N=10,16
        ADISP=ADISP-CHH(N)*DAMPHHTTRIP_10(N,R)/(R8*R**(N-8.0d0))
      ENDDO
      DISHHST_10=ADISP 
      RETURN
      END
      
            FUNCTION DAMPHHTTRIP_10(N,R)
c    *************************************************************** 
...
c    ***************************************************************
      ...
      DAMPHHTTRIP_10=(1.0D0-EXP(-A(N)*RR-B(N)*RR*RR))**N
      RETURN
      END

      FUNCTION DVHHST_10(R)
C     *************************************************************
C     TO COMPUTE THE DER. OF THE HFACE FOR  singlet H...H
C     *************************************************************
      IMPLICIT DOUBLE PRECISION(A-H,O-Z)
C     *************************************************************
      DVHHST_10=DEHFHHST_10(R)+DDISHHSTT_10(R)
      RETURN
      END

      FUNCTION DEHFHHST_10(R)
C     *************************************************************
C     TO COMPUTE THE EHF FOR  singlet H...H
C     *************************************************************
      IMPLICIT DOUBLE PRECISION(A-H,O-Z)
...
c     **************************************************************
      ...
      DATA AGEX,ALPHEX,GAMEX/0.8205D0,2.5D0,2.0D0/
c     **************************************************************
c     Derivada de EHFHHST_10=POL*EXP(-Gama*X)
      X=R-RMHHS
      X2=X*X
      X3=X2*X
      ...
      DEHFHHST_10=DPOLC*EXP(-GAMA*X)-D/R*POL*DEXP
...
c     Total
      DEHFHHST_10=DEHFHHST_10+DEXCHHS
      RETURN
      END

      FUNCTION DDISHHSTT_10(R)
c    ************************************************************
      IMPLICIT DOUBLE PRECISION(A-H,O-Z)
      COMMON/DISPC1T_10/CHH(16),COHP(10)
      COMMON/DIATDIT_10/R0HH,RMHHS,R0OHP,RMOHP
...
C **************************************************************
      ...
      COMMON/COEFFT_10/C(127)
      COMMON/REFGEOT_10/R10,R20,R30
...
c      DECAY3=1.0D0-TANH(S3*C(127))
      ...
      THREBR_10=POLQ*DECAY1*DECAY2*DECAY3*0.5d0**3.0d0

      RETURN
      END

      SUBROUTINE DTHREBR_10(R1,R2,R3,DTDR1,DTDR2,DTDR3)
c **************************************************************
...
c   9grau termos extra
     ...
     5 C(125)*(DTQ2Q3*TQ12*TQ3+TQ2*2.0D0*TQ1*DTQ1Q3*TQ3+TQ2*TQ12*DTQ3Q3)
      ...
      SUBROUTINE GEOMRLT_10(R1,R2,R3)  
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
      COMMON/CONSTT_10/PI
      COMMON/DISPC1T_10/CHH(16),COHP(10)
     ...
     1  FBC,FABC,FCAB,FBAC,CONSTT,RG14,RG15,RG16,RG17,RG18,RG19,RG110,
     ...
     1  DFABR1,DFACR1,DFBCR1,DFABR2,DFACR2,DFBCR2,DFABR3,DFACR3,DFBCR3
      COMMON/CVED31T_10/C6OHHST11,C8OHHST11,C10OHHST11,C6HOHPT12,
     1    C8HOHPT12,
...
!$OMP THREADPRIVATE(/CVED_10/,/CVED31T_10/)
...
C     **********
C     CONSTTANTES ADICIONAIS USADAS NA VEOHHST, E VINDHOHPT
      cost12=cost1*cost1
      cost13=cost12*cost1
      ...
      DAMPOHHST5=DAMPOHHST_10(RG1,5,R1)/RG15
C     *******************
...
c calculado a partir das dist. de eq.(POL94:7651) RMHHS=2.8619327675d0
      ...
      C6HOHPT12=C6HOHPT_10(r2,cost2)
      C8HOHPT12=C8HOHPT_10(r2,cost2)
      C10HOHPT12=C10HOHPT_10(r2,cost2)
      
      C6HOHPT13=C6HOHPT_10(r3,cost3)
      C8HOHPT13=C8HOHPT_10(r3,cost3)
      C10HOHPT13=C10HOHPT_10(r3,cost3)
      
      
      DAMPHOHPT26=DAMPHOHPT_10(RG2,6,r2)
      DAMPHOHPT28=DAMPHOHPT_10(RG2,8,r2)
      DAMPHOHPT210=DAMPHOHPT_10(RG2,10,r2)
      
      DAMPHOHPT36=DAMPHOHPT_10(RG3,6,r3)
      DAMPHOHPT38=DAMPHOHPT_10(RG3,8,r3)
      DAMPHOHPT310=DAMPHOHPT_10(RG3,10,r3)
      
      C6OHHST11=C6OHHST_10(r1,cost1)
      C8OHHST11=C8OHHST_10(r1,cost1)
      C10OHHST11=C10OHHST_10(r1,cost1)
      ...
      DAMPOHHST16=DAMPOHHST_10(RG1,6,r1)
      DAMPOHHST18=DAMPOHHST_10(RG1,8,r1)
      DAMPOHHST110=DAMPOHHST_10(RG1,10,r1)
...
c     ******************************************************************
     ...
     8      C10HOHPT13*FBAC/rg310*DAMPHOHPT310
      ...
      VED2=(FBC-1.0D0)*DISHHST_10(R1)+(FAB-1.0D0)*DISOHPT_10(R2)+
     1                            (FAC-1.0D0)*DISOHPT_10(R3)      
      ...
      FUNCTION DVED31TR1_10(R1,R2,R3)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
      COMMON/CVED_10/COSB,COSC,RG1,RG2,RG3,COST1,COST2,COST3,FAB,FAC,
     1  FBC,FABC,FCAB,FBAC,CONSTT,RG14,RG15,RG16,RG17,RG18,RG19,RG110,
...
c     ******************************************************************
      DVED31TR1_10=-((DC6OHHSTR1_10(r1,cost1,DCOST1R1)*FABC+DFABCR1*
     1      C6OHHST11)*DAMPOHHST16/rg16+(DDAMPOHHSTR1_10
     1      (RG1,6,R1,DRG1R1)*
     1      RG16-6.0D0*DRG1R1*RG15*DAMPOHHST16)/RG112*C6OHHST11*FABC)-
     1      ((DC8OHHSTR1_10(r1,cost1,DCOST1R1)*FABC+DFABCR1*C8OHHST11)*
     1      DAMPOHHST18/rg18+(DDAMPOHHSTR1_10(RG1,8,r1,DRG1R1)*
     1      RG18-8.0D0*
     1      DRG1R1*RG17*DAMPOHHST18)/RG116*C8OHHST11*FABC)-
     1      ((DC10OHHSTR1_10(r1,cost1,DCOST1R1)*FABC+DFABCR1*
     1      C10OHHST11)*
     1      DAMPOHHST110/rg110+(DDAMPOHHSTR1_10(RG1,10,R1,DRG1R1)*
     1      RG110-
     1      10.0D0*DRG1R1*RG19*DAMPOHHST110)/RG120*C10OHHST11*FABC)-
     1      ((DC6HOHPTR1_10(r2,cost2,DCOST2R1)*FCAB+DFCABR1*
     1      C6HOHPT12)*
     1      DAMPHOHPT26/rg26+(DDAMPHOHPTR1_10(RG2,6,R2,DRG2R1)*
     1      RG26-6.0D0*
     1      DRG2R1*RG25*DAMPHOHPT26)/RG212*C6HOHPT12*FCAB)-
     1      ((DC8HOHPTR1_10(r2,cost2,DCOST2R1)*FCAB+DFCABR1*C8HOHPT12)*
     1      DAMPHOHPT28/rg28+(DDAMPHOHPTR1_10(RG2,8,R2,DRG2R1)*
     1      RG28-8.0D0*
     1      DRG2R1*RG27*DAMPHOHPT28)/RG216*C8HOHPT12*FCAB)-
     1      ((DC10HOHPTR1_10(r2,cost2,DCOST2R1)*FCAB+DFCABR1*
     1      C10HOHPT12)*
     1      DAMPHOHPT210/rg210+(DDAMPHOHPTR1_10(RG2,10,R2,DRG2R1)*RG210-
     1      10.0D0*DRG2R1*RG29*DAMPHOHPT210)/RG220*C10HOHPT12*FCAB)-
     1      ((DC6HOHPTR1_10(r3,cost3,DCOST3R1)*FBAC+DFBACR1*
     1      C6HOHPT13)*
     1      DAMPHOHPT36/rg36+(DDAMPHOHPTR1_10(RG3,6,R3,DRG3R1)*RG36-
     1      6.0D0*DRG3R1*RG35*DAMPHOHPT36)/RG312*C6HOHPT13*FBAC)-
     1      ((DC8HOHPTR1_10(r3,cost3,DCOST3R1)*FBAC+DFBACR1*C8HOHPT13)*
     1      DAMPHOHPT38/rg38+(DDAMPHOHPTR1_10(RG3,8,R3,DRG3R1)*RG38-
     1      8.0D0*DRG3R1*RG37*DAMPHOHPT38)/RG316*C8HOHPT13*FBAC)-
     1      ((DC10HOHPTR1_10(r3,cost3,DCOST3R1)*FBAC+DFBACR1*
     1      C10HOHPT13)*
     1      DAMPHOHPT310/rg310+(DDAMPHOHPTR1_10(RG3,10,R3,DRG3R1)*
     1      RG310-
     1      10.0D0*DRG3R1*RG39*DAMPHOHPT310)/RG320*C10HOHPT13*FBAC)
     
CC      VED2=(FBC-1.0D0)*DISHHST_10(R1)+(FAB-1.0D0)*DISOHPT_10(R2)+
CC     1                            (FAC-1.0D0)*DISOHPT_10(R3)

      DVED21R1=DFBCR1*DISHHST_10(R1)+(FBC-1.0D0)*DDISHHSTT_10(R1)+
     1        DFABR1*DISOHPT_10(R2)+
     2        DFACR1*DISOHPT_10(R3)
     
      DVED31TR1_10=DVED31TR1_10+DVED21R1
      
      RETURN
      END

      FUNCTION DVED31TR2_10(R1,R2,R3)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
      COMMON/CVED_10/COSB,COSC,RG1,RG2,RG3,COST1,COST2,COST3,FAB,FAC,
     1  FBC,FABC,FCAB,FBAC,CONSTT,RG14,RG15,RG16,RG17,RG18,RG19,RG110,
...
C     ******************************************************************
      DVED31TR2_10=-((DC6OHHSTR2_10(r1,cost1,DCOST1R2)*FABC+DFABCR2*
     1      C6OHHST11)*DAMPOHHST16/rg16+
     1      (DDAMPOHHSTR2_10(RG1,6,R1,DRG1R2)*
     1      RG16-6.0D0*DRG1R2*RG15*DAMPOHHST16)/RG112*C6OHHST11*FABC)-
     1      ((DC8OHHSTR2_10(r1,cost1,DCOST1R2)*FABC+DFABCR2*C8OHHST11)*
     1      DAMPOHHST18/rg18+(DDAMPOHHSTR2_10(RG1,8,R1,DRG1R2)*
     1      RG18-8.0D0*
     1      DRG1R2*RG17*DAMPOHHST18)/RG116*C8OHHST11*FABC)-
     1      ((DC10OHHSTR2_10(r1,cost1,DCOST1R2)*FABC+DFABCR2*
     1      C10OHHST11)*
     1      DAMPOHHST110/rg110+(DDAMPOHHSTR2_10(RG1,10,R1,DRG1R2)
     1      *RG110-
     1      10.0D0*DRG1R2*RG19*DAMPOHHST110)/RG120*C10OHHST11*FABC)-
     1      ((DC6HOHPTRAA_10(r2,cost2,DCOST2R2)*
     1      FCAB+DFCABR2*C6HOHPT12)*
     1      DAMPHOHPT26/rg26+(DDAMPHOHPTRAA_10(RG2,6,R2,DRG2R2)*
     1      RG26-6.0D0*DRG2R2*RG25*DAMPHOHPT26)/RG212*C6HOHPT12*FCAB)-
     1      ((DC8HOHPTRAA_10(r2,cost2,DCOST2R2)*FCAB+DFCABR2*C8HOHPT12)*
     1      DAMPHOHPT28/rg28+(DDAMPHOHPTRAA_10(RG2,8,R2,DRG2R2)*
     1      RG28-8.0D0*DRG2R2*RG27*DAMPHOHPT28)/RG216*C8HOHPT12*FCAB)-
     1      ((DC10HOHPTRAA_10(r2,cost2,DCOST2R2)*FCAB+DFCABR2*
     1      C10HOHPT12)*
     1      DAMPHOHPT210/rg210+(DDAMPHOHPTRAA_10(RG2,10,R2,DRG2R2)*
     1      RG210-
     1      10.0D0*DRG2R2*RG29*DAMPHOHPT210)/RG220*C10HOHPT12*FCAB)-
     1      ((DC6HOHPTRAB_10(r3,cost3,DCOST3R2)*
     1      FBAC+DFBACR2*C6HOHPT13)*
     1      DAMPHOHPT36/rg36+(DDAMPHOHPTRAB_10(RG3,6,R3,DRG3R2)*
     1      RG36-6.0D0*
     1      DRG3R2*RG35*DAMPHOHPT36)/RG312*C6HOHPT13*FBAC)-
     1      ((DC8HOHPTRAB_10(r3,cost3,DCOST3R2)*FBAC+DFBACR2*C8HOHPT13)*
     1      DAMPHOHPT38/rg38+(DDAMPHOHPTRAB_10(RG3,8,R3,DRG3R2)*
     1      RG38-8.0D0*
     1      DRG3R2*RG37*DAMPHOHPT38)/RG316*C8HOHPT13*FBAC)-
     1      ((DC10HOHPTRAB_10(r3,cost3,DCOST3R2)*FBAC+DFBACR2*
     1      C10HOHPT13)*
     1      DAMPHOHPT310/rg310+(DDAMPHOHPTRAB_10(RG3,10,R3,DRG3R2)*
     1      RG310-
...
CC     1                            (FAC-1.0D0)*DISOHPT_10(R3)
      ...
      DVED21R2=DFBCR2*DISHHST_10(R1)+
     1        DFABR2*DISOHPT_10(R2)+(FAB-1.0D0)*DDISPOHT_10(R2,COHP(6),
     2        COHP(8),COHP(10),R0OHP,RMOHP)+
     2        DFACR2*DISOHPT_10(R3)
     
      DVED31TR2_10=DVED31TR2_10+DVED21R2
      RETURN
      END

      FUNCTION DVED31TR3_10(R1,R2,R3)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
      COMMON/CVED_10/COSB,COSC,RG1,RG2,RG3,COST1,COST2,COST3,FAB,FAC,
     1  FBC,FABC,FCAB,FBAC,CONSTT,RG14,RG15,RG16,RG17,RG18,RG19,RG110,
...
C     ******************************************************************
      DVED31TR3_10=-((DC6OHHSTR3_10(r1,cost1,DCOST1R3)*FABC+DFABCR3*
     1      C6OHHST11)*DAMPOHHST16/rg16+
     1      (DDAMPOHHSTR3_10(RG1,6,R1,DRG1R3)*
     1      RG16-6.0D0*DRG1R3*RG15*DAMPOHHST16)/RG112*C6OHHST11*FABC)-
     1      ((DC8OHHSTR3_10(r1,cost1,DCOST1R3)*FABC+DFABCR3*C8OHHST11)*
     1      DAMPOHHST18/rg18+(DDAMPOHHSTR3_10(RG1,8,R1,DRG1R3)*
     1      RG18-8.0D0*
     1      DRG1R3*RG17*DAMPOHHST18)/RG116*C8OHHST11*FABC)-
     1      ((DC10OHHSTR3_10(r1,cost1,DCOST1R3)*FABC+DFABCR3*
     1      C10OHHST11)*DAMPOHHST110/rg110+
     1      (DDAMPOHHSTR3_10(RG1,10,R1,DRG1R3)*RG110-
     1      10.0D0*DRG1R3*RG19*DAMPOHHST110)/RG120*C10OHHST11*FABC)-
     1      ((DC6HOHPTRAB_10(r2,cost2,DCOST2R3)*
     1      FCAB+DFCABR3*C6HOHPT12)*
     1      DAMPHOHPT26/rg26+(DDAMPHOHPTRAB_10(RG2,6,R2,DRG2R3)*
     1      RG26-6.0D0*
     1      DRG2R3*RG25*DAMPHOHPT26)/RG212*C6HOHPT12*FCAB)-
     1      ((DC8HOHPTRAB_10(r2,cost2,DCOST2R3)*FCAB+DFCABR3*C8HOHPT12)*
     1      DAMPHOHPT28/rg28+(DDAMPHOHPTRAB_10(RG2,8,R2,DRG2R3)*
     1      RG28-8.0D0*
     1      DRG2R3*RG27*DAMPHOHPT28)/RG216*C8HOHPT12*FCAB)-
     1      ((DC10HOHPTRAB_10(r2,cost2,DCOST2R3)*FCAB+DFCABR3*
     1      C10HOHPT12)*
     1      DAMPHOHPT210/rg210+(DDAMPHOHPTRAB_10(RG2,10,R2,DRG2R3)*
     1      RG210-
     1      10.0D0*DRG2R3*RG29*DAMPHOHPT210)/RG220*C10HOHPT12*FCAB)-
     1      ((DC6HOHPTRAA_10(r3,cost3,DCOST3R3)*FBAC+DFBACR3*
     1      C6HOHPT13)*
     1      DAMPHOHPT36/rg36+(DDAMPHOHPTRAA_10(RG3,6,R3,DRG3R3)*
     1      RG36-6.0D0*DRG3R3*RG35*DAMPHOHPT36)/RG312*C6HOHPT13*FBAC)-
     1      ((DC8HOHPTRAA_10(r3,cost3,DCOST3R3)*FBAC+DFBACR3*C8HOHPT13)*
     1      DAMPHOHPT38/rg38+(DDAMPHOHPTRAA_10(RG3,8,R3,DRG3R3)*
     1      RG38-8.0D0*DRG3R3*RG37*DAMPHOHPT38)/RG316*C8HOHPT13*FBAC)-
     1      ((DC10HOHPTRAA_10(r3,cost3,DCOST3R3)*FBAC+DFBACR3*
     1      C10HOHPT13)*
     1      DAMPHOHPT310/rg310+(DDAMPHOHPTRAA_10(RG3,10,R3,DRG3R3)*
     1      RG310-
...
CC     1                            (FAC-1.0D0)*DISOHPT_10(R3)
      ...
      DVED21R3=DFBCR3*DISHHST_10(R1)+
     1        DFABR3*DISOHPT_10(R2)+
     2        DFACR3*DISOHPT_10(R3)+(FAC-1.0D0)*DDISPOHT_10(R3,COHP(6),
     2          COHP(8),COHP(10),R0OHP,RMOHP)
     
      DVED31TR3_10=DVED31TR3_10+DVED21R3
      RETURN
      END
      
                  
      FUNCTION DAMPHOHPT_10(R,N,X)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
C     ******************************************************************
      COMMON/ANT_10/A(20)
...
c      RMHOHP=2.216766092d0
      RMHOHP=7.70d0
c      RMHOHP=7.40d0   
      RO=0.5D0*(RMHOHP+2.5D0*R0HOHPCT_10(x))
      DAMPHOHPT_10=(1.0D0-EXP(-A(N)*R/RO-B(N)*R**2/RO**2))**N      
      RETURN
      END 
      
      FUNCTION DDAMPHOHPTR1_10(R,N,X,D)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
C     ******************************************************************
      COMMON/ANT_10/A(20)
...
c      RMHOHP=7.40d0
      ...
      RO2=RO*RO
      DROR1=0.0D0
      DDAMPHOHPTR1_10=N*(1.0D0-EXP(-A(N)*R/RO-B(N)*R**2/RO2))**(N-1)
     1 *(A(N)*(D*RO-DROR1*R)/RO2+2.0D0*B(N)*(R/RO)*(D*RO-DROR1*R)
     1          /RO2)*EXP(-A(N)*R/RO-B(N)*R**2/RO2)    
      RETURN
      END 
      
      FUNCTION DDAMPHOHPTRAA_10(R,N,X,D)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
C     ******************************************************************
      COMMON/ANT_10/A(20)
...
c      RMHOHP=7.40d0
      RO=0.5D0*(RMHOHP+2.5D0*R0HOHPCT_10(x))
      RO2=RO*RO
      DROR23=0.5D0*2.5D0*DR0HOHPCTR23_10(x)
      DDAMPHOHPTRAA_10=N*(1.0D0-EXP(-A(N)*R/RO-B(N)*R**2/RO2))**(N-1)
     1 *(A(N)*(D*RO-DROR23*R)/RO2+2.0D0*B(N)*(R/RO)*(D*RO-DROR23*R)
     1          /RO2)*EXP(-A(N)*R/RO-B(N)*R**2/RO2)    
      RETURN
      END 
      
      FUNCTION DDAMPHOHPTRAB_10(R,N,X,D)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
C     ******************************************************************
      COMMON/ANT_10/A(20)
...
c      RMHOHP=7.40d0
      ...
      RO2=RO*RO
      DROR23=0.0D0
      DDAMPHOHPTRAB_10=N*(1.0D0-EXP(-A(N)*R/RO-B(N)*R**2/RO2))**(N-1)
     1 *(A(N)*(D*RO-DROR23*R)/RO2+2.0D0*B(N)*(R/RO)*(D*RO-DROR23*R)
     1          /RO2)*EXP(-A(N)*R/RO-B(N)*R**2/RO2)    
      RETURN
      END  
                 
      FUNCTION DAMPOHHST_10(R,N,X)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
c     ******************************************************************
      COMMON/ANT_10/A(20)
...
c      RMOHHS=1.1077763d0
      RMOHHS=6.80d0
c      RMOHHS=7.40d0 
      RO=0.5D0*(RMOHHS+2.5D0*R0OHHSCT_10(X))
      DAMPOHHST_10=(1.0D0-EXP(-A(N)*R/RO-B(N)*R**2/RO**2))**N
      RETURN
      END 
      
      FUNCTION DDAMPOHHSTR1_10(R,N,X,D)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
C     ******************************************************************
      COMMON/ANT_10/A(20)
...
c      RMOHHS=7.40d0 
      RO=0.5D0*(RMOHHS+2.5D0*R0OHHSCT_10(X))
      RO2=RO*RO
      DROR1=0.5D0*2.5D0*DR0OHHSCTR1_10(X)
      DDAMPOHHSTR1_10=N*(1.0D0-EXP(-A(N)*R/RO-B(N)*R**2/RO2))**(N-1)
     1 *(A(N)*(D*RO-DROR1*R)/RO2+2.0D0*B(N)*(R/RO)*(D*RO-DROR1*R)
     1          /RO2)*EXP(-A(N)*R/RO-B(N)*R**2/RO2)    
      RETURN
      END 
      
      FUNCTION DDAMPOHHSTR2_10(R,N,X,D)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
C     ******************************************************************
      COMMON/ANT_10/A(20)
...
c      RMOHHS=7.40d0 
      ...
      RO2=RO*RO
      DROR2=0.0D0
      DDAMPOHHSTR2_10=N*(1.0D0-EXP(-A(N)*R/RO-B(N)*R**2/RO2))**(N-1)
     1 *(A(N)*(D*RO-DROR2*R)/RO2+2.0D0*B(N)*(R/RO)*(D*RO-DROR2*R)
     1          /RO2)*EXP(-A(N)*R/RO-B(N)*R**2/RO2)    
      RETURN
      END 
      
      FUNCTION DDAMPOHHSTR3_10(R,N,X,D)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
C     ******************************************************************
      COMMON/ANT_10/A(20)
...
c      RMOHHS=7.40d0 
      ...
      RO2=RO*RO
      DROR3=0.0D0
      DDAMPOHHSTR3_10=N*(1.0D0-EXP(-A(N)*R/RO-B(N)*R**2/RO2))**(N-1)
     1 *(A(N)*(D*RO-DROR3*R)/RO2+2.0D0*B(N)*(R/RO)*(D*RO-DROR3*R)
     1          /RO2)*EXP(-A(N)*R/RO-B(N)*R**2/RO2)    
      RETURN
      END 
                  
      FUNCTION C6OHHST_10(R,COST)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
      common/C6OHHSTae_10/a6s,b6s
!$OMP THREADPRIVATE(/C6OHHSTae_10/)
c     ******************************************************************
      A6s=C6OHHSTPA_10(R)
      B6s=C6OHHSTPE_10(R)
      PL=0.5D0*(3.0D0*COST**2-1.0D0)
      C6OHHST_10=(1.0D0/3.0D0)*(2.0D0*B6s+A6s)+(2.0D0/3.0D0)*
     1  (A6s-B6s)*PL
      RETURN
      END
      
      FUNCTION DC6OHHSTR1_10(R,COST,D)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
      common/C6OHHSTae_10/a6s,b6s
!$OMP THREADPRIVATE(/C6OHHSTae_10/)
...
c     ******************************************************************
      DC6PE=DC6OHHSTPER1_10(R)
      DC6PA=DC6OHHSTPAR1_10(R)
      DC6OHHSTR1_10=2.0D0/3.0D0*DC6PE+1.0D0/3.0D0*DC6PA
     1        +1.0D0/3.0D0*(DC6PA-DC6PE)*(3.0D0*
     1         COST**2-1.0D0)+6.0D0*D*COST*1.0D0/3.0D0*(A6s-B6s)
      RETURN
      END
      
      FUNCTION DC6OHHSTR2_10(R,COST,D)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
      common/C6OHHSTae_10/a6s,b6s
!$OMP THREADPRIVATE(/C6OHHSTae_10/)
      dummy=r
c     ******************************************************************
      DC6OHHSTR2_10=2.0D0*D*COST*(A6s-B6s)
      RETURN
      END      
      
      FUNCTION DC6OHHSTR3_10(R,COST,D)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
      common/C6OHHSTae_10/a6s,b6s
!$OMP THREADPRIVATE(/C6OHHSTae_10/)
      dummy=r
c     ******************************************************************
      DC6OHHSTR3_10=2.0D0*D*COST*(A6s-B6s)
      RETURN
      END      
      
      FUNCTION C8OHHST_10(R,COST)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
      common/C8OHHSTae_10/a8s,b8s
!$OMP THREADPRIVATE(/C8OHHSTae_10/)

c     ******************************************************************
      A8s=C8OHHSTPA_10(R)
      B8s=C8OHHSTPE_10(R)
      PL=0.5D0*(3.0D0*COST**2-1.0D0)
      C8OHHST_10=(1.0D0/3.0D0)*(2.0D0*B8s+A8s)+(2.0D0/3.0D0)*
     1  (A8s-B8s)*PL
      RETURN
      END
      
      FUNCTION DC8OHHSTR1_10(R,COST,D)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
      common/C8OHHSTae_10/a8s,b8s
!$OMP THREADPRIVATE(/C8OHHSTae_10/)
...
c     ******************************************************************
      DC8PE=DC8OHHSTPER1_10(R)
      DC8PA=DC8OHHSTPAR1_10(R)
      DC8OHHSTR1_10=2.0D0/3.0D0*DC8PE+1.0D0/3.0D0*DC8PA
     1        +1.0D0/3.0D0*(DC8PA-DC8PE)*(3.0D0*
     1         COST**2-1.0D0)+6.0D0*D*COST*(1.0D0/3.0D0)*(A8s-B8s)
      RETURN
      END
      
      FUNCTION DC8OHHSTR2_10(R,COST,D)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
      common/C8OHHSTae_10/a8s,b8s
!$OMP THREADPRIVATE(/C8OHHSTae_10/)
      dummy=r
c     ******************************************************************
      DC8OHHSTR2_10=2.0D0*D*COST*(A8s-B8s)
      RETURN
      END
      
      FUNCTION DC8OHHSTR3_10(R,COST,D)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
      common/C8OHHSTae_10/a8s,b8s
!$OMP THREADPRIVATE(/C8OHHSTae_10/)
      dummy=r
c     ******************************************************************
      DC8OHHSTR3_10=2.0D0*D*COST*(A8s-B8s)
      RETURN
      END
      
      FUNCTION C10OHHST_10(R,COST)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
...
c     ******************************************************************
      ...
      B1s=C10OHHSTPE_10(R)
      PL=0.5D0*(3.0D0*COST**2-1.0D0)
      C10OHHST_10=(1.0D0/3.0D0)*(2.0D0*B1s+A1s)+(2.0D0/3.0D0)*
     1  (A1s-B1s)*PL
      RETURN
      END
      
      FUNCTION DC10OHHSTR1_10(R,COST,D)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
      common/c1ohhsae_10/a1s,b1s
!$OMP THREADPRIVATE(/c1ohhsae_10/)
...
c     ******************************************************************
      DC10PE=DC10OHHSTPER1_10(R)
      DC10PA=DC10OHHSTPAR1_10(R)
      DC10OHHSTR1_10=(2.0D0/3.0D0)*DC10PE+(1.0D0/3.0D0)*
     1  DC10PA+(1.0D0/3.0D0)*(DC10PA-DC10PE)
     1   *(3.0D0*COST**2-1.0D0)+6.0D0*D*COST*(1.0D0/3.0D0)*(A1s-B1s)
      RETURN
      END    
      
      FUNCTION DC10OHHSTR2_10(R,COST,D)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
      common/c1ohhsae_10/a1s,b1s
!$OMP THREADPRIVATE(/c1ohhsae_10/)
...
c     ******************************************************************
      DC10OHHSTR2_10=2.0D0*D*COST*(A1s-B1s)
      RETURN
      END
      
      FUNCTION DC10OHHSTR3_10(R,COST,D)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
      common/c1ohhsae_10/a1s,b1s
!$OMP THREADPRIVATE(/c1ohhsae_10/)
      dummy=r
c     ******************************************************************
      DC10OHHSTR3_10=2.0D0*D*COST*(A1s-B1s)
      RETURN
      END
                  
      FUNCTION C6HOHPT_10(R,COST)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
c     ******************************************************************
      Ap=C6HOHPTPA_10(R)
      ...
      C6HOHPT_10=(1.0D0/3.0D0)*(2.0D0*Bp+Ap)+(2.0D0/3.0D0)*(Ap-Bp)*PL1
      RETURN
      END
      
      FUNCTION DC6HOHPTR1_10(R,COST,D)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
c     ******************************************************************
      Ap=C6HOHPTPA_10(R)
      Bp=C6HOHPTPE_10(R)
      DC6HOHPTR1_10=2.0D0*D*COST*(Ap-Bp)    
      RETURN
      END
      
      FUNCTION DC6HOHPTRAA_10(R,COST,D)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
c     ******************************************************************
      Ap=C6HOHPTPA_10(R)
      Bp=C6HOHPTPE_10(R)
      DC6PEA=DC6HOHPTPERAA_10(R)
      DC6PAA=DC6HOHPTPARAA_10(R)      
      DC6HOHPTRAA_10=(2.0D0/3.0D0)*DC6PEA+(1.0D0/3.0D0)*
     1   DC6PAA+(1.0D0/3.0D0)*(DC6PAA-DC6PEA
     1   )*(3.0D0*COST**2-1.0D0)+6.0D0*D*COST*(1.0D0/3.0D0)*(Ap-Bp)     
      RETURN
      END
      
      FUNCTION DC6HOHPTRAB_10(R,COST,D)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
c     ******************************************************************
      Ap=C6HOHPTPA_10(R)
      Bp=C6HOHPTPE_10(R)
      DC6HOHPTRAB_10=2.0D0*D*COST*(Ap-Bp)     
      RETURN
      END
      
      FUNCTION C8HOHPT_10(R,COST)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
c     ******************************************************************      
      Ap8=C8HOHPTPA_10(R)
      Bp8=C8HOHPTPE_10(R)
      PL1=0.5D0*(3.0D0*COST**2-1.0D0)
      C8HOHPT_10=(1.0D0/3.0D0)*(2.0D0*Bp8+Ap8)+(2.0D0/3.0D0)*
     1  (Ap8-Bp8)*PL1
      RETURN
      END
      
      FUNCTION DC8HOHPTR1_10(R,COST,D)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
c     ******************************************************************      
      Ap8=C8HOHPTPA_10(R)
      Bp8=C8HOHPTPE_10(R)
      DC8HOHPTR1_10=2.0D0*D*COST*(Ap8-Bp8)
      RETURN
      END
          
      FUNCTION DC8HOHPTRAA_10(R,COST,D)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
c     ******************************************************************      
      Ap8=C8HOHPTPA_10(R)
      Bp8=C8HOHPTPE_10(R)
      DC8PEA=DC8HOHPTPERAA_10(R)
      DC8PAA=DC8HOHPTPARAA_10(R)      
      DC8HOHPTRAA_10=(2.0D0/3.0D0)*DC8PEA+(1.0D0/3.0D0)*
     ...
     1   *(3.0D0*COST**2-1.0D0)+6.0D0*D*COST*(1.0D0/3.0D0)*(Ap8-Bp8)  
      ...
      FUNCTION DC8HOHPTRAB_10(R,COST,D)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
c     ******************************************************************      
      Ap8=C8HOHPTPA_10(R)
      Bp8=C8HOHPTPE_10(R)
      DC8HOHPTRAB_10=2.0D0*D*COST*(Ap8-Bp8)     
      RETURN
      END
           
      FUNCTION C10HOHPT_10(R,COST)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
c     ******************************************************************
      Ap10=C10HOHPTPA_10(R)
      Bp10=C10HOHPTPE_10(R)
      PL1=0.5D0*(3.0D0*COST**2-1.0D0)
      C10HOHPT_10=(1.0D0/3.0D0)*(2.0D0*Bp10+Ap10)+(2.0D0/3.0D0)*
     1         (Ap10-Bp10)*PL1
      RETURN
      END
      
      FUNCTION DC10HOHPTR1_10(R,COST,D)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
c     ******************************************************************
      A1=C10HOHPTPA_10(R)
      B1=C10HOHPTPE_10(R)
      DC10HOHPTR1_10=2.0D0*D*COST*(A1-B1)
      RETURN
      END
      
      FUNCTION DC10HOHPTRAA_10(R,COST,D)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
c     ******************************************************************      
      A1=C10HOHPTPA_10(R)
      B1=C10HOHPTPE_10(R)
      DC10PEA=DC10HOHPTPERAA_10(R)
      DC10PAA=DC10HOHPTPARaa_10(R)      
      DC10HOHPTRAA_10=(2.0D0/3.0D0)*DC10PEA+(1.0D0/3.0D0)*
     ...
     1   (A1-B1)     
      ...
      FUNCTION DC10HOHPTRAB_10(R,COST,D)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
c     ******************************************************************      
      A1=C10HOHPTPA_10(R)
      B1=C10HOHPTPE_10(R)
      DC10HOHPTRAB_10=2.0D0*D*COST*(A1-B1)     
      RETURN
      END
            
      FUNCTION C6OHHSTPA_10(R)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
...
c     ******************************************************************
      ...
      DALP=DALPHHSPATR1_10(r)      
      e=0.5d0/SQRT(ALP/RNH)*(dalp*rnh-DRNHHSTR1_10(r)*alp)/rnh**2
      d=SQRT(ALP/RNH)+SQRT(5.393d0/2.79d0)
      DC6HSPa1=(CONSTT1*dalp*d-CONSTT1*alp*e)/d**2
      DC6OHHSTPAR1_10=DC6HSPa1     
      RETURN
      END
      
      FUNCTION C8OHHSTPA_10(R)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
      COMMON/C6PA_10/C6HSPA,R0O,ALP,RNH
!$OMP THREADPRIVATE(/C6PA_10/)
      dummy=r
c     ******************************************************************
      C8OHHSTPA_10=1.0d0*C6HSPA*R0O**(1.57243d0)
      RETURN
      END
      
      FUNCTION DC8OHHSTPAR1_10(R)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
      COMMON/C6PA_10/C6HSPA,R0O,ALP,RNH
      COMMON/DC6PA1_10/DC6HSPa1
...
c     ****************************************************************** 
      DR0HSCR1=DR0OHHSCTR1_10(R)
      DC8OHHSTPAR1_10=DC6HSPA1*R0O**(1.57243D0)+1.57243D0*
     1      R0O**(0.57243D0)*DR0HSCR1*C6HSPA
      RETURN
      END
      FUNCTION C10OHHSTPA_10(R)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
      COMMON/C6PA_10/C6HSPA,R0O,ALP,RNH
!$OMP THREADPRIVATE(/C6PA_10/)
      dummy=r
c     ******************************************************************
      C10OHHSTPA_10=1.13178d0*C6HSPA*R0O**(1.57243d0*2.0d0)
      RETURN
      END 
      FUNCTION DC10OHHSTPAR1_10(R)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
      COMMON/C6PA_10/C6HSPA,R0O,ALP,RNH
      COMMON/DC6PA1_10/DC6HSPa1
...
c     ******************************************************************
      ...
      DC6OHHSTPER1_10=DC6HSPE1   
      RETURN
      END
      FUNCTION C8OHHSTPE_10(R)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
      COMMON/C6PE_10/C6HSPE,R0O,RNH,alp,DALP
!$OMP THREADPRIVATE(/C6PE_10/)
...
c     substitui 1.54 por 1.57243
      C8OHHSTPE_10=1.0d0*C6HSPE*R0O**1.57243d0
      RETURN
      END
      
      FUNCTION DC8OHHSTPER1_10(R)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
      COMMON/C6PE_10/C6HSPE,R0O,RNH,alp,DALP
      COMMON/DC6PE_10/DC6HSPE1
...
c     ******************************************************************
c     substitui 1.54 por 1.57243
      DR0HSCE1=DR0OHHSCTR1_10(R)
      DC8OHHSTPER1_10=DC6HSPE1*R0O**(1.57243D0)+1.57243D0*
     1      R0O**(1.57243D0-1.0D0)*DR0HSCE1*C6HSPE
      RETURN
      END
       
      FUNCTION C10OHHSTPE_10(R)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
      COMMON/C6PE_10/C6HSPE,R0O,RNH,alp,DALP
!$OMP THREADPRIVATE(/C6PE_10/)
...
c     ******************************************************************        
c     substitui 1.31 por 1.13178 ; 1.54 por 1.57243
      C10OHHSTPE_10=1.13178d0*C6HSPE*R0O**(1.57243d0*2.0d0)
      RETURN
      END 
      FUNCTION DC10OHHSTPER1_10(R)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
      COMMON/C6PE_10/C6HSPE,R0O,RNH,alp,DALP
      COMMON/DC6PE_10/DC6HSPE1
...
c     ******************************************************************
c     substitui 1.31 por 1.13178 ; 1.54 por 1.57243
      DC10OHHSTPER1_10=1.13178D0*DC6HSPE1*R0O**(1.57243D0*
     1    2.0D0)+(1.57243D0*2.0D0)*R0O**(1.57243D0*2.0D0-1.0D0)*
     1     DR0HSCE1*1.13178D0*C6HSPE
      RETURN
      END
      FUNCTION C6HOHPTPA_10(R)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
c     ******************************************************************
      ALP=ALPOHPPAT_10(R)
      C6HOHPTPA_10=1.5D0*4.500D0*ALP/(SQRT(ALP/RNOHPT_10(R))+2.25D0)
      RETURN
      END
      
      FUNCTION DC6HOHPTPARAA_10(R)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
c     ******************************************************************
      ...
      ALP=ALPOHPPAT_10(R)
      RN=RNOHPT_10(R)
      dalp=DALPOHPPATR23_10(r)      
      d=SQRT(ALP/RN)+2.25D0
      e=0.5d0/SQRT(ALP/RN)*(dalp*rn-DRNOHPTR23_10(r)*alp)/rn**2
      DC6HOHPTPARAA_10=(CONSTT1*dalp*d-e*CONSTT1*alp)/d**2
      RETURN
      END

      FUNCTION C8HOHPTPA_10(R)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
c     ******************************************************************
      C8HOHPTPA_10=1.0D0*C6HOHPTPA_10(R)*R0HOHPCT_10(R)**(1.57243D0)      
      RETURN
      END
      
      FUNCTION DC8HOHPTPARAA_10(R)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
c     ******************************************************************
      R0H=R0HOHPCT_10(R)      
      DC8HOHPTPARAA_10=DC6HOHPTPARAA_10(R)*R0H**1.57243D0+1.57243D0*
     1      R0H**(1.57243D0-1.0D0)*DR0HOHPCTR23_10(R)*C6HOHPTPA_10(R)
      RETURN
      END

      FUNCTION C10HOHPTPA_10(R)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
c     ******************************************************************
      C10HOHPTPA_10=1.13178D0*C6HOHPTPA_10(R)*
     1  R0HOHPCT10_10(R)**(2.0D0*1.57243D0)      
      RETURN
      END
      
      FUNCTION DC10HOHPTPARaa_10(R)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
c     ******************************************************************
      R0H=R0HOHPCT10_10(R)      
      DC10HOHPTPARaa_10=1.13178D0*DC6HOHPTPARAA_10(R)*R0H**(2.0D0*
     1  1.57243D0)+2.0D0*1.57243D0*R0H**(2.0D0*1.57243D0-
     1    1.0D0)*DR0HOHPCT10R23_10(R)*1.13178D0*C6HOHPTPA_10(R)
      RETURN
      END

      FUNCTION C6HOHPTPE_10(R)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
c     ******************************************************************
      ALP=ALPOHPPET_10(R)
      C6HOHPTPE_10=1.5D0*4.500D0*ALP/(SQRT(ALP/RNOHPT_10(R))
     1           +2.25D0)
      RETURN
      END
      
      FUNCTION DC6HOHPTPERAA_10(R)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
c     ******************************************************************
      CONSTT1=1.5D0*4.500D0
      ALP=ALPOHPPET_10(R)
      RNO=RNOHPT_10(R)
      dalp=DALPOHPPETR23_10(r)      
      d=SQRT(ALP/RNO)+2.25D0
      e=0.5d0/SQRT(ALP/RNO)*(dalp*rno-DRNOHPTR23_10(r)*alp)/rno**2
      DC6HOHPTPERAA_10=(CONSTT1*dalp*d-e*CONSTT1*alp)/d**2
      RETURN
      END
      
      FUNCTION C8HOHPTPE_10(R)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
c     ******************************************************************
      C8HOHPTPE_10=1.0D0*C6HOHPTPE_10(R)*R0HOHPCT_10(R)**(1.57243D0)      
      RETURN
      END
      
      FUNCTION DC8HOHPTPERAA_10(R)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
c     ******************************************************************
      R0H=R0HOHPCT_10(R)
      DC8HOHPTPERAA_10=DC6HOHPTPERAA_10(R)*R0H**1.57243D0+1.57243D0*
     1      R0H**(1.57243D0-1.0D0)*DR0HOHPCTR23_10(R)*C6HOHPTPE_10(R)
      RETURN
      END
      

      FUNCTION C10HOHPTPE_10(R)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
c     ******************************************************************            C10HOHPTPE_10=1.13178d0*C6HOHPTPE_10(R)*R0HOHPCT10_10(R)**(1.57243D0*2.0D0)      
      C10HOHPTPE_10=1.13178d0*C6HOHPTPE_10(R)*
     1 R0HOHPCT10_10(R)**(1.57243D0*2.0D0)      
      RETURN
      END
      
      FUNCTION DC10HOHPTPERAA_10(R)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)
c     ******************************************************************      
      R0H=R0HOHPCT10_10(R)      
      DC10HOHPTPERAA_10=1.13178D0*DC6HOHPTPERAA_10(R)*R0H**(2.0D0*
     1  1.57243D0)+2.0D0*1.57243D0*R0H**(2.0D0*1.57243D0-
     1    1.0D0)*DR0HOHPCT10R23_10(R)*1.13178D0*C6HOHPTPE_10(R)
      RETURN
      END
 
      FUNCTION RNOHPT_10(R)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)      
c     ******************************************************************      
      Ainf=3.52d0
      ...
      RNOHPT_10=ainf+(a+b*(R-re))*exp(-c*(R-re))
      RETURN
      END 
      
      FUNCTION DRNOHPTR23_10(R)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)      
c     ******************************************************************      
      Ainf=3.52d0
      ...
      b=0.584820271D0
      c=0.584820271D0/1.04D0   
      DRNOHPTR23_10=b*exp(-c*(R-re))-c*(a+b*(R-re))*exp(-c*(R-re))
      RETURN
      END 
      
      FUNCTION RNHHST_10(R)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)      
c     ******************************************************************
      Ainf=1.78d0
      ...
      a=-0.1478d0
      c=0.60634691d0          
      RNHHST_10=ainf+a*exp(-c*(R-re))
      RETURN
      END
      
      FUNCTION DRNHHSTR1_10(R)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)      
c     ******************************************************************
      Ainf=1.78d0
      ...
      a=-0.1478d0
      c=0.60634691d0          
      DRNHHSTR1_10=-a*C*exp(-c*(R-re))
      RETURN
      END 

      FUNCTION ALPHHSPAT_10(R)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)      
...
c     ******************************************************************
      ...
      rr3=rr2*r
      rr5=rr2*rr3
      ALPHHSPAT_10=Ainf1+(azero+C1*r+C2*rr2+c3*rr3)*
     1   EXP(-C4*r-C5*rr2)+(1.0D0-EXP(-C6*rr5))*C7/rr3
      RETURN
      END
      
      FUNCTION DALPHHSPATR1_10(R)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)      
      DATA AINF1,C1,C2,C3,C4,C5,C6,C7/9.0D0,6.3134223d0,-2.8677438d0,
     1 7.7770980d-1,-7.6966611d-1,2.8116781d-1,4.1567195d-3,1.5074557d2/
c     ******************************************************************
      ...
      rr4=rr3*r
      rr5=rr4*r
      DALPHHSPATR1_10=(C1+2.0D0*C2*R+3.0D0*C3*RR2)*EXP(-C4*r-C5*RR2)-
...
c     ******************************************************************
      ...
      rr3=rr2*r
      rr5=rr2*rr3
      ALPHHSPET_10=Ainf1+(azero+C1*r+C2*RR2+c3*RR3)*
     1   EXP(-C4*r-C5*RR2)+(1.0d0-EXP(-C6*RR5))*C7/RR3
      RETURN
      END
      
      FUNCTION DALPHHSPETR1_10(R)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)      
      DATA AINF1,C1,C2,C3,C4,C5,C6,C7/9.0D0,4.8750306d0,-1.8684334d0,3.8
     1 222971d-1,-5.6354499d-1,2.8106756d-1,1.7861826d-3,-2.8274363d1/    
c     ******************************************************************
      ...
      rr4=rr3*r
      rr5=rr4*r
      DALPHHSPETR1_10=(C1+2.0D0*C2*R+3.0D0*C3*RR2)*EXP(-C4*r-C5*RR2)-
     1          (C4+2.0D0*C5*R)*(azero+C1*r+C2*RR2+c3*RR3)*EXP(-C4*r
     1          -C5*RR2)-3.0D0*C7/RR4+3.0D0*C7/RR4*EXP(-C6*RR5)+
     1          5.0D0*C6*C7*R*EXP(-C6*RR5)
      RETURN
...
c     ******************************************************************
      ...
      rr3=rr2*r
      rr5=rr2*rr3
      ALPOHPPAT_10=Ainf1+(Azero+C1*r+C2*rr2+C3*rr3)*
     1  EXP(-C4*r-C5*rr2-C6*rr3)+(1.0d0-EXP(-C7*rr5))*C8/rr3
      RETURN
      END 
      
      FUNCTION DALPOHPPATR23_10(R)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)      
      DATA AINF1,C1,C2,C3,C4,C5,C6,C7,C8/9.3381D0,5.2957323d0,-1.36948
     1  90d0,1.1344069d-1,-7.3074372d-1,-2.8938141d-1,7.298064d-2,4.27
...
c     ******************************************************************
      ...
      rr4=rr3*r
      rr5=rr4*r      
      DALPOHPPATR23_10=(C1+2.0D0*C2*R+3.0D0*C3*RR2)*EXP(-C4*
     1         R-C5*RR2-C6*RR3
...
c     ******************************************************************
      ...
      ALPOHPPET_10=Ainf1-Azero*EXP(-C1*r-C2*r**2-C3*r**3)+
     1 (1.0d0-EXP(-C4*r**5))*C5/r**3

      RETURN
      END 

      FUNCTION DALPOHPPETR23_10(R)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)      
      DATA AINF1,C1,C2,C3,C4,C5/9.6061296d0,4.8648692d-1,-1.3199234d-1,
     1  4.2427009d-2,2.1725130d-4,-2.5535932d1/
...
c     ******************************************************************       
      ...
      ALPHHSM=(1.0d0/3.0d0)*ALPHHSPAT_10(r)+(2.0d0/3.0d0)*
     1 ALPHHSPET_10(r)       
      R0OHHSCT_10=2.0d0*((alphhsm**(1.0d0/3.0d0))+sqrt(2.003423d0))*
     1 FCORR
      RETURN
      END
      
      FUNCTION DR0OHHSCTR1_10(R)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)      
c     ******************************************************************       
      ...
      ALPHHSM=(1.0d0/3.0d0)*ALPHHSPAT_10(r)+(2.0d0/3.0d0)*
     1 ALPHHSPET_10(r)       
      DALPHHSMR1=(1.0d0/3.0d0)*DALPHHSPATR1_10(r)+(2.0d0/3.0d0)*
     1          DALPHHSPETR1_10(r)
      DR0OHHSCTR1_10=2.0D0*DFCORR*((alphhsm**(1.0d0/3.0d0))+
     1       sqrt(2.003423d0))+(1.0d0/3.0d0)*alphhsm**(-2.0d0/3.0d0)*
     1       DALPHHSMR1*2.0D0*FCORR
      RETURN
      END
      
      FUNCTION R0HOHPCT_10(R)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)      
c     ******************************************************************
      alpham=(1.0d0/3.0d0)*ALPOHPPAT_10(R)+(2.0d0/3.0d0)*ALPOHPPET_10(R)    
      finf=6.390259718d0/7.7028477d0
      fzero=5.950512078d0/6.4733336d0
      d=fzero-finf
      c=0.584820271D0/1.04D0         
      fcorr=finf+d*exp(-c*r)      
      R0HOHPCT_10=2.0d0*((alpham**(1.0d0/3.0d0))+(6.9282d0/4.0d0))*
     1 fcorr  
      RETURN
      END 
      
      FUNCTION DR0HOHPCTR23_10(R)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)      
c     ******************************************************************
      alpham=1.0d0/3.0d0*ALPOHPPAT_10(R)+2.0d0/3.0d0*ALPOHPPET_10(R)    
      DALPHAM=1.0d0/3.0d0*DALPOHPPATR23_10(R)+2.0d0/3.0d0*
     1 DALPOHPPETR23_10(R)
      finf=6.390259718d0/7.7028477d0
      fzero=5.950512078d0/6.4733336d0
      d=fzero-finf
      c=0.584820271D0/1.04D0         
      fcorr=finf+d*exp(-c*r)      
      DR0HOHPCTR23_10=2.0d0/3.0D0*alpham**(-2.0d0/3.0d0)*
     1    DALPHAM*fcorr-2.0D0*c*d*exp(-c*r)*
     1    (alpham**(1.0d0/3.0d0)+6.9282d0/4.0d0) 
      RETURN
      END 
    
      FUNCTION R0HOHPCT10_10(R)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)      
c     ******************************************************************     
      ALPHAM=(1.0D0/3.0D0)*ALPOHPPAT_10(R)+(2.0D0/3.0D0)*ALPOHPPET_10(R)  
      ...
      c=0.584820271D0/1.04D0   
      FCORR=finf+d*exp(-c*r)      
      R0HOHPCT10_10=2.0d0*((ALPHAM**(1.0D0/3.0D0))+(6.9282D0/4.0D0))
     1 *FCORR          
      RETURN
      END 
      
      FUNCTION DR0HOHPCT10R23_10(R)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)      
c     ******************************************************************     
      ALPHAM=(1.0D0/3.0D0)*ALPOHPPAT_10(R)+(2.0D0/3.0D0)*ALPOHPPET_10(R)  
     ...
     1  DALPOHPPETR23_10(R)
      ...
      c=0.584820271D0/1.04D0   
      FCORR=finf+d*exp(-c*r)      
      DR0HOHPCT10R23_10=2.0d0/(3.0D0*alpham**(2.0d0/3.0d0))*
     1    DALPHAM*fcorr
     1    -2.0D0*c*d*(alpham**(1.0d0/3.0d0)+(6.9282d0/4.0d0))*exp(-c*r) 
      RETURN
      END 
       
      FUNCTION FDOHPT_10(R)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)      
...
c     ******************************************************************
      ...
      rr3=rr2*r
      rr5=rr3*rr2      
      FDOHPT_10=(ANT+C1*R+C2*RR2+C3*RR3)*EXP(-c4*R-C5*RR2)+
     2   (1.0d0-EXP(-C6*RR5))*C7/RR3
      return
      end
      
      FUNCTION DFDOHPTR23_10(R)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)      
      DATA C1,C2,C3,C4,C5,C6,C7/1.1014506D+00,-9.2434425D-01,3.471174
     1     2D-01,-3.6259720D-01,3.6732452D-01,6.8313966D-03,2.392610
...
c     ******************************************************************
      ...
      rr4=rr3*r
      rr5=rr4*r      
      DFDOHPTR23_10=(C1+2.0D0*C2*R+3.0D0*C3*RR2)*EXP(-C4*R-C5*RR2)-(C4+
     1         2.0D0*C5*R)*(ANT+C1*R+C2*RR2+C3*RR3)*EXP(-c4*R-C5*RR2)
     1         -3.0D0*C7/RR4+5.0D0*C6*C7*R*EXP(-C6*RR5)+3.0D0*
     1         C7/RR4*EXP(-C6*RR5)
      return
      end
     
      FUNCTION VINDHOHPT_10(r1,r2,r3)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)      
      COMMON/ANT_10/A(20)
      COMMON/BNT_10/B(20)
...
c     ******************************************************************               
      VINDHOHPT_10=-FDOHPT_10(R2)**2*4.5D0*(3.0D0*COST2**2+1.0D0)*
     1          DAMPHOHPT26/(2.0D0*rG26)
     1         -FDOHPT_10(R3)**2*4.5D0*(3.0D0*COST3**2+1.0D0)*
     1          DAMPHOHPT36/(2.0D0*rG36)
      return
      end
      
      FUNCTION DVINDHOHPTR1_10(r1,r2,r3)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)      
      COMMON/ANT_10/A(20)
      COMMON/BNT_10/B(20)
...
c     ******************************************************************
      ...
      FDOHPTR2=FDOHPT_10(R2)
      FDOHPTR3=FDOHPT_10(R3)
      TA1=-4.5D0*FDOHPTR2**2
      TA2=-4.5D0*FDOHPTR3**2
      xa=TA1*TA  
      xa1=TA2*TB  
      DVINDHOHPTR1_10=xb*(-4.5d0*2.0d0*FDOHPTR2*DFDOHPTR1*
     1 Ta+dTar1*TA1)+xa*(DDAMPHOHPTR1_10(Rg2,6,r2,DRG2R1)*2.0D0*RG26
     1 -12.0D0*RG25*DRG2R1*DAMPHOHPT26)/(4.0D0*RG212)
     1         +xb1*(-4.5d0*2.0d0*FDOHPTR3*DFDOHPTR1*TB+dTBr1*TA2)
     1 +Xa1*(DDAMPHOHPTR1_10(Rg3,6,r3,DRG3R1)*2.0D0*RG36
     1 -12.0D0*RG35*DRG3R1*DAMPHOHPT36)/(4.0D0*RG312) 
      return
      end
      
      FUNCTION DVINDHOHPTR2_10(r1,r2,r3)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)      
      COMMON/ANT_10/A(20)
      COMMON/BNT_10/B(20)
...
c     ******************************************************************
      ...
      xa1=TA2*TB  
      DFDOHPTR23R3=0.0D0
      DVINDHOHPTR2_10=xb*(-4.5d0*2.0d0*FDOHPTR2*DFDOHPTR23_10(R2)*
     1 Ta+dTar2*TA1)+xa*(DDAMPHOHPTRAA_10(Rg2,6,r2,DRG2R2)*2.0D0*
     1 RG26-12.0D0*RG25*DRG2R2*DAMPHOHPT26)/(4.0D0*RG212)
     1      +xb1*(-4.5d0*2.0d0*FDOHPTR3*DFDOHPTR23R3*TB+dTBr2*TA2)
     1 +Xa1*(DDAMPHOHPTRAB_10(Rg3,6,r3,DRG3R2)*2.0D0*RG36
     1 -12.0D0*RG35*DRG3R2*DAMPHOHPT36)/(4.0D0*RG312)
      return
      end      
      
      FUNCTION DVINDHOHPTR3_10(r1,r2,r3)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)      
      COMMON/ANT_10/A(20)
      COMMON/BNT_10/B(20)
...
c     ******************************************************************
      ...
      xa1=TA2*TB  
      DFDOHPTR23R2=0.0D0      
      DVINDHOHPTR3_10=xb*(-4.5d0*2.0d0*FDOHPTR2*DFDOHPTR23R2*Ta+dTar3
     1 *TA1)+xa*(DDAMPHOHPTRAB_10(Rg2,6,r2,DRG2R3)*2.0D0*RG26
     1 -12.0D0*RG25*DRG2R3*DAMPHOHPT26)/(4.0D0*RG212)
     1    +xb1*(-4.5d0*2.0d0*FDOHPTR3*DFDOHPTR23_10(R3)*TB+dTBr3*TA2)
     1 +Xa1*(DDAMPHOHPTRAA_10(Rg3,6,r3,DRG3R3)*2.0D0*RG36
     1 -12.0D0*RG35*DRG3R3*DAMPHOHPT36)/(4.0D0*RG312)
      return
      end
    
      FUNCTION FQHHST_10(R)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)      
...
c     ******************************************************************
      ...
      RR3=RR2*R
      RR5=RR3*RR2
      FQHHST_10=(C1*R+C2*RR2+C3*RR3)*EXP(-C4*R
     1      -C5*RR2-C6*RR3)+(1.0d0-EXP(-C7*RR5))*C8/RR3      
      return
      end
      
      FUNCTION DFQHHSTR1_10(R)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)      
      DATA C1,C2,C3,C4,C5,C6,C7,C8/9.2292863d-02,-1.0187873d-02,1.03075
     1     21d-02,-1.0635640d0,2.8476217d-01,1.1961650d-08,1.3473360
...
c     ******************************************************************
      ...
      RR4=RR3*R
      RR5=RR3*RR2
      DFQHHSTR1_10=(C1+2.0D0*C2*R+3.0D0*C3*RR2)*EXP(-C4*R-C5*RR2-C6*
     1        RR3)-(C4+2.0D0*C5*R+3.0D0*C6*RR2)*(C1*R+C2*RR2+C3*RR3)*
     1        EXP(-C4*R-C5*RR2-C6*RR3)-3.0D0*C8/RR4+3.0D0*C8/RR4*EXP(
     1        -C7*RR5)+5.0D0*C7*C8*R*EXP(-C7*RR5)
      return
      end
      
      FUNCTION VEOHHST_10(r1,r2,r3)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)      
      COMMON/ANT_10/A(20)
      COMMON/BNT_10/B(20)
...
c     correspondendo ao do O(3p)
      ...
      VEOHHST_10=0.75d0*FQHHST_10(R1)*(-0.992148212d0)*at*DAMPOHHST5
      return
      end
      
      FUNCTION DVEOHHSTR1_10(r1,r2,r3)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)      
      COMMON/ANT_10/A(20)
      COMMON/BNT_10/B(20)
     ...
     1  cos2t1,cos4t1,cos6t1,dcos2t,dcos4t,dcos6t,DAMPOHHST5,
     1  DFABR1,DFACR1,DFBCR1,DFABR2,DFACR2,DFBCR2,DFABR3,DFACR3,DFBCR3
      COMMON/DVEOHP_10/AT,DAT,FQHHSTR1


!$OMP THREADPRIVATE(/CVED_10/,/DVEOHP_10/)
...
c     ******************************************************************
      ...
      FQHHSTR1=FQHHST_10(R1)
      DVEOHHSTR1_10=(DFQHHSTR1_10(R1)*AT+DATR1*FQHHSTR1)*CONSTTV*
     1     DAMPOHHST5+(DDAMPOHHSTR1_10(Rg1,5,r1,drg1r1)*rg15-5.0D0*
     1     DRG1R1*RG14*DAMPOHHST5*RG15)/(rg110)*at*CONSTTV*FQHHSTR1
      return
      end
      
      FUNCTION DVEOHHSTR2_10(r1,r2,r3)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)      
      COMMON/ANT_10/A(20)
      COMMON/BNT_10/B(20)
...
c     o valor do quadrupolo do O(1D)=1.233793Buckingham=0.917288208au
      DATR2=DAT*dcost1r2
      CONSTTV=0.75d0*(-0.992148212d0)
      DVEOHHSTR2_10=(DATR2*FQHHSTR1)*CONSTTV*DAMPOHHST5+
     1        (DDAMPOHHSTR2_10(Rg1,5,r1,DRG1R2)*rg15-5.0D0*DRG1R2*
     1        RG14*DAMPOHHST5*Rg15)/(rg110)*at*CONSTTV*FQHHSTR1
      return
      end
      
      FUNCTION DVEOHHSTR3_10(r1,r2,r3)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)      
      COMMON/ANT_10/A(20)
      COMMON/BNT_10/B(20)
...
c     o valor do quadrupolo do O(1D)=1.233793Buckingham=0.917288208au
      DATR3=DAT*dcost1r3
      CONSTTV=0.75d0*(-0.992148212d0)
      DVEOHHSTR3_10=(DATR3*FQHHSTR1)*CONSTTV*DAMPOHHST5+
     1    (DDAMPOHHSTR3_10(Rg1,5,r1,DRG1R3)*rg15-5.0D0*DRG1R3*
     1    RG14*DAMPOHHST5*RG15)/(rg110)*at*CONSTTV*FQHHSTR1
      return
      end
      
      FUNCTION RL_10(r1E,r2E,r3E)
c     ******************************************************************
      IMPLICIT DOUBLE PRECISION (A-H,O-Z)      
c     ******************************************************************
      R1=R1E+1.0D-8
      R2=R2E+1.0D-8
      R3=R3E+1.0D-8
      call GEOMRLT_10(r1,r2,r3)
      RL_10=VED31T_10(r1,r2,r3)+VEOHHST_10(r1,r2,r3)+
     1  VINDHOHPT_10(r1,r2,r3)
      return
      end

!      FUNCTION RLCAS_10(r1E,r2E,r3E)
c     ******************************************************************
!      IMPLICIT DOUBLE PRECISION (A-H,O-Z)      
c     ******************************************************************
!      R1=R1E+1.0D-8
...
!      R3=R3E+1.0D-8
!      call GEOMRLT_10(r1,r2,r3)
!      RLCAS_10=VEOHHST_10(r1,r2,r3)
!      return
!      end
      
      SUBROUTINE DRL_10(R1E,R2E,R3E,DER1,DER2,DER3)
c     ******************************************************************
...
c     ******************************************************************
      ...
      DER1=DVED31TR1_10(r1,r2,r3)+DVEOHHSTR1_10(r1,r2,r3)+
     1      DVINDHOHPTR1_10(r1,r2,r3)

      DER2=DVED31TR2_10(r1,r2,r3)+DVEOHHSTR2_10(r1,r2,r3)+
     1      DVINDHOHPTR2_10(r1,r2,r3)

      DER3=DVED31TR3_10(r1,r2,r3)+DVEOHHSTR3_10(r1,r2,r3)+
     1      DVINDHOHPTR3_10(r1,r2,r3)
      RETURN
      END
     

!      SUBROUTINE CODISPT(R0,C6,C8,C10)
c    **************************************************************
...
!      END
      ...
      FUNCTION DISPOHT_10(R,C6,C8,C10,R0,RM)
c    **************************************************************
      IMPLICIT DOUBLE PRECISION(A-H,O-Z)
      COMMON/ANT_10/A(20)
      COMMON/BNT_10/B(20)
c    **************************************************************
      ...
      DISPOHT_10=-C6/R6*D6-C8/R8*D8-C10/R10*D10
      RETURN
      END

      FUNCTION DDISPOHT_10(R,C6,C8,C10,R0,RM)
c    **************************************************************
      IMPLICIT DOUBLE PRECISION(A-H,O-Z)
      COMMON/ANT_10/A(20)
      COMMON/BNT_10/B(20)
c    **************************************************************
      ...
      DDISPOHT_10=6.0D0*C6/R6*T6**5*(T6/R+(1.0D0-T6)*(-A(6)-
     1  2.0D0*B(6)*RR)*DRR)+
     ...
     5      B(10)*RR)*DRR)
      ...
      BLOCK DATA H2OSTDAT_10
C     *************************************************************      
      IMPLICIT DOUBLE PRECISION(A-H,O-Z)
      COMMON/CONSTT_10/PI
      COMMON/ANT_10/A(20)
      COMMON/BNT_10/B(20)
      COMMON/EMIT_10/EMITN
      COMMON/DISPC1T_10/CHH(16),COHP(10)
      COMMON/REFGEOT_10/R10,R20,R30
