subroutine generate_Ar(igen,xgat,ygat,zgat,vxgat,vygat,vzgat)
use variables
use constants
use phys_parameters
implicit none
...
!---------------------------------------------------------
        ...
        select case (temp_distribution)
            ...
            case (1)
                ...
                call velocity_dist_Ar(temp,vel)
                modvelocity = vel !for Ar
...
!###############################
!      print*,'altered generate_Ar'       
!      vxgat=modvelocity
!      vygat=0.0D0
!      vzgat=0.0D0
!###############################

end subroutine generate_Ar 


subroutine velocity_dist_Ar(temperature,v)
use constants
implicit none
...
end subroutine velocity_dist_Ar
