subroutine generate_H3O(iatomo,xg,yg,zg,vxg,vyg,vzg)
use variables
use constants
use phys_parameters
implicit none
...
1       call random_number(xrand)
        ...
        xg(2)=xg(1)+0.4041213D-11
        yg(2)=yg(1)+0.1286289D-09
        zg(2)=zg(1)+0.5488519D-10
        xg(3)=xg(1)+0.1575347D-10
        yg(3)=yg(1)+0.2561955D-10
        zg(3)=zg(1)+0.4797337D-10
        xg(4)=xg(1)+0.2486039D-09
        yg(4)=yg(1)+0.6597274D-10
        zg(4)=zg(1)+0.3735538D-10
