subroutine generate_O(igen,xgat,ygat,zgat,vxgat,vygat,vzgat)
use variables
use constants
use phys_parameters
implicit none
...
!---------------------------------------------------------
        ...
        select case (temp_distribution)
              ...
              call velocity_dist_O(temp,vel)

              modvelocity = vel !for O
              case default
...
!      print*,'altered generate_O'       
!      vxgat=modvelocity
!      vygat=0.0D0
!      vzgat=0.0D0
      
end subroutine generate_O 

subroutine velocity_dist_O(temperature,v)
use constants
implicit none
...
end subroutine velocity_dist_O
