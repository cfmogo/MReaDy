subroutine generate_H3(iatomo,xg,yg,zg,vxg,vyg,vzg)
use variables
use constants
use phys_parameters
implicit none
...
1       call random_number(xrand)
        ...
        yg(2)=yg(1)+0.3234955D-09
        zg(2)=zg(1)+0.6867141D-10
        xg(3)=xg(1)+0.0000000D+00
        yg(3)=yg(1)+0.7405592D-10
        zg(3)=zg(1)+0.3628327D-11

        xg(2)=xg(1)+7.4145D-11
        yg(2)=yg(1)-0.0D-10
        zg(2)=zg(1)+0.0D-10
        xg(3)=xg(1)+2.4D-10
        yg(3)=yg(1)+0.0D-10
